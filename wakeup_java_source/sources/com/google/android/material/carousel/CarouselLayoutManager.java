...
public class CarouselLayoutManager extends RecyclerView.LayoutManager implements Carousel, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public /* synthetic */ void lambda$new$0(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        ...
        view.post(new Runnable() { // from class: com.google.android.material.carousel.OooO00o
            @Override // java.lang.Runnable
            public final void run() {
                this.f4948OooO0o0.refreshKeylineState();
            }
        });
    }
    ...
    private void logChildrenIfDebugging() {
        if (this.isDebuggingEnabled && Log.isLoggable(TAG, 3)) {
            for (int i = 0; i < getChildCount(); i++) {
                ...
                sb.append(", center:");
                sb.append(decoratedCenterWithMargins);
    ...
    int getOffsetToScrollToPosition(int i, @NonNull KeylineState keylineState) {
    ...
    public CarouselLayoutManager(@NonNull CarouselStrategy carouselStrategy, int i) {
        ...
        this.currentFillStartPosition = 0;
        this.recyclerViewSizeChangeListener = new View.OnLayoutChangeListener() { // from class: com.google.android.material.carousel.OooO0O0
            @Override // android.view.View.OnLayoutChangeListener
            public final void onLayoutChange(View view, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
                this.f4949OooO00o.lambda$new$0(view, i2, i3, i4, i5, i6, i7, i8, i9);
            }
        };
    ...
    public CarouselLayoutManager(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.recyclerViewSizeChangeListener = new View.OnLayoutChangeListener() { // from class: com.google.android.material.carousel.OooO0O0
            ...
            public final void onLayoutChange(View view, int i22, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
                this.f4949OooO00o.lambda$new$0(view, i22, i3, i4, i5, i6, i7, i8, i9);
            }
        };
        this.currentEstimatedPosition = -1;
        this.carouselAlignment = 0;
