...
public class OutLineScanView extends AppCompatImageView {
    ...
    class OooO00o extends OooOOO0 {
        ...
        final /* synthetic */ int[] f12711OooO0o;

        /* renamed from: OooO0o0, reason: collision with root package name */
        final /* synthetic */ int[] f12712OooO0o0;

        /* renamed from: OooO0oO, reason: collision with root package name */
        final /* synthetic */ int f12713OooO0oO;

        /* renamed from: OooO0oo, reason: collision with root package name */
        final /* synthetic */ int f12714OooO0oo;

        OooO00o(int[] iArr, int[] iArr2, int i, int i2) {
            this.f12712OooO0o0 = iArr;
            this.f12711OooO0o = iArr2;
            this.f12713OooO0oO = i;
            this.f12714OooO0oo = i2;
        }

        @Override // OoooO0.OooOOO0
        public void work() {
            try {
                SobelRecognition.recognitionReturn(this.f12712OooO0o0, this.f12711OooO0o, this.f12713OooO0oO, this.f12714OooO0oo, 0.8d, 0.1d, 0.05d, 200);
            } catch (Throwable th) {
                th.printStackTrace();
            }
        }
    ...
    class OooO0O0 extends OooOOO0 {
        ...
        /* renamed from: OooO0o, reason: collision with root package name */
        final /* synthetic */ int f12715OooO0o;

        /* renamed from: OooO0o0, reason: collision with root package name */
        final /* synthetic */ int f12716OooO0o0;

        /* renamed from: OooO0oO, reason: collision with root package name */
        final /* synthetic */ int[] f12717OooO0oO;

        OooO0O0(int i, int i2, int[] iArr) {
            this.f12716OooO0o0 = i;
            this.f12715OooO0o = i2;
            this.f12717OooO0oO = iArr;
        }

        @Override // OoooO0.OooOOO0
        public void work() {
            try {
                if (OutLineScanView.this.bitmap != null && this.f12716OooO0o0 <= OutLineScanView.this.bitmap.getHeight() && this.f12715OooO0o <= OutLineScanView.this.bitmap.getWidth() && !OutLineScanView.this.bitmap.isRecycled()) {
                    Bitmap bitmap = OutLineScanView.this.bitmap;
                    int[] iArr = this.f12717OooO0oO;
                    int i = this.f12715OooO0o;
                    bitmap.setPixels(iArr, 0, i, 0, 0, i, this.f12716OooO0o0);
                }
            } catch (Throwable th) {
                th.printStackTrace();
            }
