...
public class ZeusTransformUtils {
        ...
        if (Build.VERSION.SDK_INT <= 23) {
            try {
                ...
                for (String str : new HashSet(sConstructorMap.keySet())) {
                    if (!str.startsWith("android.view.") && !str.startsWith("android.widget.") && !str.startsWith("android.webkit.") && str.contains(Consts.DOT)) {
    ...
    public static int mapRes(int i, String str, String str2) {
        ...
        if (identifier == 0) {
            identifier = Zeus.getAppApplication().getResources().getIdentifier(str2.replace(PluginHandle.UNDERLINE, Consts.DOT), str, Zeus.getAppApplication().getPackageName());
        }
        if (identifier == 0) {
    ...
    public static Object preCheckCast(Object obj, Class cls, String str) {
        ...
        boolean zIsInstance = cls.isInstance(obj);
        ...
        if ((obj instanceof PluginContext) && !zIsInstance) {
            return ((PluginContext) obj).mOriginContext;
        }
        if (!(obj instanceof PluginFragmentActivityWrapper) || zIsInstance) {
            return (!(obj instanceof PluginActivityWrapper) || zIsInstance) ? (!(obj instanceof PluginApplicationWrapper) || zIsInstance) ? (!(obj instanceof GenerateProxyActivity) || zIsInstance) ? obj : ((GenerateProxyActivity) obj).mTargetActivity : ((PluginApplicationWrapper) obj).mOriginApplication : ((PluginActivityWrapper) obj).mOriginActivity;
        }
        try {
            try {
    ...
    public static void requestPermissions(Object obj, String[] strArr, int i, String str) throws NoSuchFieldException, SecurityException {
        Object field;
    ...
    public static TypedArray obtainStyledAttributes(Object obj, int i, int[] iArr, String str) throws Resources.NotFoundException {
        if (obj instanceof Context) {
            int[] iArrHandleAttrBefore = handleAttrBefore(iArr);
