...
public class FileDownloadOutOfSpaceException extends IOException {
    ...
    public FileDownloadOutOfSpaceException(long j, long j2, long j3, Throwable th) {
        super(f.c("The file is too large to store, breakpoint in bytes:  %d, required space in bytes: %d, but free space in bytes: %d", Long.valueOf(j3), Long.valueOf(j2), Long.valueOf(j)), th);
        init(j, j2, j3);
    }
    ...
    public FileDownloadOutOfSpaceException(long j, long j2, long j3) {
        super(f.c("The file is too large to store, breakpoint in bytes:  %d, required space in bytes: %d, but free space in bytes: %d", Long.valueOf(j3), Long.valueOf(j2), Long.valueOf(j)));
        init(j, j2, j3);
    }
}
