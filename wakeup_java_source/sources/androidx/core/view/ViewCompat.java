...
public class ViewCompat {
    ...
    private static final OnReceiveContentViewBehavior NO_OP_ON_RECEIVE_CONTENT_VIEW_BEHAVIOR = new OnReceiveContentViewBehavior() { // from class: androidx.core.view.o00000OO
    ...
    static class AccessibilityPaneVisibilityManager implements ViewTreeObserver.OnGlobalLayoutListener, View.OnAttachStateChangeListener {
        ...
        public void onGlobalLayout() {
            if (Build.VERSION.SDK_INT < 28) {
                Iterator<Map.Entry<View, Boolean>> it2 = this.mPanesToVisible.entrySet().iterator();
                while (it2.hasNext()) {
                    checkPaneVisibility(it2.next());
                }
            }
        }
    ...
    static class Api28Impl {
        ...
        static void addOnUnhandledKeyEventListener(View view, final OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
            ...
            View.OnUnhandledKeyEventListener onUnhandledKeyEventListener = new View.OnUnhandledKeyEventListener() { // from class: androidx.core.view.o0000Ooo
    ...
    @Deprecated
    public static void setAlpha(View view, @FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = Contrast.RATIO_MIN) float f) {
        view.setAlpha(f);
    }
    ...
    public static void setPointerIcon(View view, PointerIconCompat pointerIconCompat) {
        if (Build.VERSION.SDK_INT >= 24) {
            Api24Impl.setPointerIcon(view, o00000O.OooO00o(pointerIconCompat != null ? pointerIconCompat.getPointerIcon() : null));
        }
    }
