...
public final class PlatformType {
    ...
    public static final PlatformType APPLE = new PlatformType("APPLE", 4);
    public static final PlatformType LINUX = new PlatformType("LINUX", 5);
    public static final PlatformType JS = new PlatformType("JS", 6);
    public static final PlatformType MAC = new PlatformType("MAC", 7);
    public static final PlatformType WINDOWS = new PlatformType("WINDOWS", 8);
    public static final PlatformType WASM = new PlatformType("WASM", 9);

    private static final /* synthetic */ PlatformType[] $values() {
        return new PlatformType[]{ANDROID, ANDROID_NATIVE, JVM, IOS, APPLE, LINUX, JS, MAC, WINDOWS, WASM};
    }
