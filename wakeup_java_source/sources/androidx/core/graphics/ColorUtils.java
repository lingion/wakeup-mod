...
public final class ColorUtils {
    ...
    @ColorInt
    public static int LABToColor(@FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = XYZ_WHITE_REFERENCE_Y) double d, @FloatRange(from = -128.0d, to = 127.0d) double d2, @FloatRange(from = -128.0d, to = 127.0d) double d3) {
        double[] tempDouble3Array = getTempDouble3Array();
        LABToXYZ(d, d2, d3, tempDouble3Array);
        return XYZToColor(tempDouble3Array[0], tempDouble3Array[1], tempDouble3Array[2]);
    }

    public static void LABToXYZ(@FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = XYZ_WHITE_REFERENCE_Y) double d, @FloatRange(from = -128.0d, to = 127.0d) double d2, @FloatRange(from = -128.0d, to = 127.0d) double d3, double[] dArr) {
    ...
    @ColorInt
    public static int M3HCTToColor(@FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = 360.0d, toInclusive = false) float f, @FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = Double.POSITIVE_INFINITY, toInclusive = false) float f2, @FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = XYZ_WHITE_REFERENCE_Y) float f3) {
        return CamColor.toColor(f, f2, f3);
    }

    public static void RGBToHSL(@IntRange(from = 0, to = ScatterMapKt.Sentinel) int i, @IntRange(from = 0, to = ScatterMapKt.Sentinel) int i2, @IntRange(from = 0, to = ScatterMapKt.Sentinel) int i3, float[] fArr) {
        float f;
        float fAbs;
        float f2 = i / 255.0f;
        float f3 = i2 / 255.0f;
    ...
    public static void RGBToLAB(@IntRange(from = 0, to = ScatterMapKt.Sentinel) int i, @IntRange(from = 0, to = ScatterMapKt.Sentinel) int i2, @IntRange(from = 0, to = ScatterMapKt.Sentinel) int i3, double[] dArr) {
        RGBToXYZ(i, i2, i3, dArr);
        XYZToLAB(dArr[0], dArr[1], dArr[2], dArr);
    }

    public static void RGBToXYZ(@IntRange(from = 0, to = ScatterMapKt.Sentinel) int i, @IntRange(from = 0, to = ScatterMapKt.Sentinel) int i2, @IntRange(from = 0, to = ScatterMapKt.Sentinel) int i3, double[] dArr) {
        if (dArr.length != 3) {
    ...
    @ColorInt
    public static int XYZToColor(@FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = XYZ_WHITE_REFERENCE_X) double d, @FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = XYZ_WHITE_REFERENCE_Y) double d2, @FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = XYZ_WHITE_REFERENCE_Z) double d3) {
    ...
    public static void XYZToLAB(@FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = XYZ_WHITE_REFERENCE_X) double d, @FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = XYZ_WHITE_REFERENCE_Y) double d2, @FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = XYZ_WHITE_REFERENCE_Z) double d3, double[] dArr) {
        if (dArr.length != 3) {
        ...
        dArr[0] = Math.max(IDataEditor.DEFAULT_NUMBER_VALUE, (116.0d * dPivotXyzComponent2) - 16.0d);
        dArr[1] = (dPivotXyzComponent - dPivotXyzComponent2) * 500.0d;
        dArr[2] = (dPivotXyzComponent2 - dPivotXyzComponent3) * 200.0d;
    }

    @ColorInt
    public static int blendARGB(@ColorInt int i, @ColorInt int i2, @FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = Contrast.RATIO_MIN) float f) {
        float f2 = 1.0f - f;
        return Color.argb((int) ((Color.alpha(i) * f2) + (Color.alpha(i2) * f)), (int) ((Color.red(i) * f2) + (Color.red(i2) * f)), (int) ((Color.green(i) * f2) + (Color.green(i2) * f)), (int) ((Color.blue(i) * f2) + (Color.blue(i2) * f)));
    }

    public static void blendHSL(float[] fArr, float[] fArr2, @FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = Contrast.RATIO_MIN) float f, float[] fArr3) {
        if (fArr3.length != 3) {
    ...
    public static void blendLAB(double[] dArr, double[] dArr2, @FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = Contrast.RATIO_MIN) double d, double[] dArr3) {
        if (dArr3.length != 3) {
    ...
    public static void colorToM3HCT(@ColorInt int i, @Size(MediaDescriptionCompat.BT_FOLDER_TYPE_ARTISTS) float[] fArr) {
    ...
    @ColorInt
    public static int setAlphaComponent(@ColorInt int i, @IntRange(from = 0, to = ScatterMapKt.Sentinel) int i2) {
        if (i2 < 0 || i2 > 255) {
