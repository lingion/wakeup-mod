...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    */
    ...
    public boolean onGenericMotionEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 8 && !this.mIsBeingDragged) {
            ...
            if (axisValue != 0.0f) {
                scrollBy(-((int) (axisValue * getVerticalScrollFactorCompat())), i, motionEvent, width, 1, MotionEventCompat.isFromSource(motionEvent, 8194));
                if (i == 0) {
                    return true;
                }
            ...
            if (actionMasked == 1) {
                ...
                if (iFindPointerIndex == -1) {
                    ...
                    if (this.mIsBeingDragged) {
                        int iScrollBy = scrollBy(i3, 1, motionEvent, (int) motionEvent.getX(iFindPointerIndex), 0, false);
    ...
    */
    ...
    @VisibleForTesting
    int scrollBy(int i, int i2, MotionEvent motionEvent, int i3, int i4, boolean z) {
        int i5;
        int i6;
