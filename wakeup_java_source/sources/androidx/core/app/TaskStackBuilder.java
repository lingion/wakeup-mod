...
public final class TaskStackBuilder implements Iterable<Intent> {
    ...
    public PendingIntent getPendingIntent(int i, int i2, boolean z) {
        return getPendingIntent(i, PendingIntentCompat.addMutabilityFlags(z, i2));
    }
    ...
    public PendingIntent getPendingIntent(int i, int i2, Bundle bundle, boolean z) {
        return getPendingIntent(i, PendingIntentCompat.addMutabilityFlags(z, i2), bundle);
    }
}
