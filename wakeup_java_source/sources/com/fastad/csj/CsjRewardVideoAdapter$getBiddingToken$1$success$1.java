...
@OooO0o(c = "com.fastad.csj.CsjRewardVideoAdapter$getBiddingToken$1$success$1", f = "CsjRewardVideoAdapter.kt", l = {156, 156, 156}, m = "invokeSuspend")
/* loaded from: classes3.dex */
final class CsjRewardVideoAdapter$getBiddingToken$1$success$1 extends SuspendLambda implements Function2<o000OO, OooO<? super o0OOO0o>, Object> {
    final /* synthetic */ o00Ooo $callback;
    final /* synthetic */ CodePos $codePos;
    final /* synthetic */ Ref$ObjectRef<String> $token;
    Object L$0;
    int label;
    final /* synthetic */ CsjRewardVideoAdapter this$0;

    @OooO0o(c = "com.fastad.csj.CsjRewardVideoAdapter$getBiddingToken$1$success$1$1", f = "CsjRewardVideoAdapter.kt", l = {}, m = "invokeSuspend")
    /* renamed from: com.fastad.csj.CsjRewardVideoAdapter$getBiddingToken$1$success$1$1, reason: invalid class name */
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    CsjRewardVideoAdapter$getBiddingToken$1$success$1(Ref$ObjectRef<String> ref$ObjectRef, CsjRewardVideoAdapter csjRewardVideoAdapter, CodePos codePos, o00Ooo o00ooo2, OooO<? super CsjRewardVideoAdapter$getBiddingToken$1$success$1> oooO) {
        super(2, oooO);
        this.$token = ref$ObjectRef;
        this.this$0 = csjRewardVideoAdapter;
    ...
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final OooO<o0OOO0o> create(Object obj, OooO<?> oooO) {
        return new CsjRewardVideoAdapter$getBiddingToken$1$success$1(this.$token, this.this$0, this.$codePos, this.$callback, oooO);
    }
        ...
        if (i == 0) {
            ...
            try {
                try {
                    ...
                    ref$ObjectRef.element = aDManger == null ? 0 : aDManger.getBiddingToken(this.this$0.getAdSlot(this.$codePos, null), true, 7);
    ...
    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(o000OO o000oo2, OooO<? super o0OOO0o> oooO) {
        return ((CsjRewardVideoAdapter$getBiddingToken$1$success$1) create(o000oo2, oooO)).invokeSuspend(o0OOO0o.f13233OooO00o);
    }
}
