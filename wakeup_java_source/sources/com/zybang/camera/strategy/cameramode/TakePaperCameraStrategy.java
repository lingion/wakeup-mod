...
public final class TakePaperCameraStrategy extends SearchBaseCameraStrategy {
    ...
    @OooO0o(c = "com.zybang.camera.strategy.cameramode.TakePaperCameraStrategy$onPictureTakenBeforeCrop$1", f = "TakePaperCameraStrategy.kt", l = {45, 52}, m = "invokeSuspend")
    /* renamed from: com.zybang.camera.strategy.cameramode.TakePaperCameraStrategy$onPictureTakenBeforeCrop$1, reason: invalid class name */
    static final class AnonymousClass1 extends SuspendLambda implements Function2<o000OO, OooO<? super o0OOO0o>, Object> {
        ...
        @OooO0o(c = "com.zybang.camera.strategy.cameramode.TakePaperCameraStrategy$onPictureTakenBeforeCrop$1$1", f = "TakePaperCameraStrategy.kt", l = {}, m = "invokeSuspend")
        /* renamed from: com.zybang.camera.strategy.cameramode.TakePaperCameraStrategy$onPictureTakenBeforeCrop$1$1, reason: invalid class name and collision with other inner class name */
        static final class C05601 extends SuspendLambda implements Function2<o000OO, OooO<? super Object>, Object> {
            final /* synthetic */ o00O0O $transferEntity;
            int label;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C05601(o00O0O o00o0o2, OooO<? super C05601> oooO) {
                super(2, oooO);
            ...
            public final OooO<o0OOO0o> create(Object obj, OooO<?> oooO) {
                return new C05601(this.$transferEntity, oooO);
            }
            ...
            public final Object invoke2(o000OO o000oo2, OooO<Object> oooO) {
                return ((C05601) create(o000oo2, oooO)).invokeSuspend(o0OOO0o.f13233OooO00o);
            }
        }

        @OooO0o(c = "com.zybang.camera.strategy.cameramode.TakePaperCameraStrategy$onPictureTakenBeforeCrop$1$2", f = "TakePaperCameraStrategy.kt", l = {}, m = "invokeSuspend")
        /* renamed from: com.zybang.camera.strategy.cameramode.TakePaperCameraStrategy$onPictureTakenBeforeCrop$1$2, reason: invalid class name */
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                C05601 c05601 = new C05601(this.$transferEntity, null);
                this.label = 1;
                if (OooOOO0.OooO0oO(o0000VarOooO0O0, c05601, this) == objOooO0oO) {
                    return objOooO0oO;
                }
            } else {
                if (i != 1) {
    ...
    public TakePaperCameraStrategy() {
        this.modeItem = new TakePaperModeItem(null, 1, null);
    }
    ...
    public void onPictureTakenBeforeCrop(Activity thisActivity, o00O0O transferEntity, o0OO0O0 callBack) {
        ...
        OooOOOO.OooO0Oo(o00O0.f13748OooO0o0, null, null, new AnonymousClass1(transferEntity, callBack, null), 3, null);
    }
