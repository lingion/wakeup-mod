...
public final class dk implements com.kwad.sdk.core.d<com.kwad.components.core.webview.tachikoma.c.h> {
    ...
    private static void a(com.kwad.components.core.webview.tachikoma.c.h hVar, JSONObject jSONObject) {
        ...
        hVar.akV = jSONObject.optInt("hasDeepReward");
    }
    ...
    private static JSONObject b(com.kwad.components.core.webview.tachikoma.c.h hVar, JSONObject jSONObject) {
        ...
        int i = hVar.akV;
        if (i != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "hasDeepReward", i);
        }
        return jSONObject;
    }
}
