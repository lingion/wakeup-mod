...
public class Oooo0 extends OooOO0O {

    /* renamed from: OooO0O0, reason: collision with root package name */
    private static final byte[] f3164OooO0O0 = "com.bumptech.glide.load.resource.bitmap.CircleCrop.1".getBytes(o00OO.f870OooO00o);

    @Override // OoooOoO.o00OO
    public void OooO0O0(MessageDigest messageDigest) {
        messageDigest.update(f3164OooO0O0);
    }
    ...
    protected Bitmap OooO0OO(com.bumptech.glide.load.engine.bitmap_recycle.OooO0o oooO0o, Bitmap bitmap, int i, int i2) {
        return o00000O.OooO0Oo(oooO0o, bitmap, i, i2);
    }

    @Override // OoooOoO.o00OO
    public boolean equals(Object obj) {
        return obj instanceof Oooo0;
    }
