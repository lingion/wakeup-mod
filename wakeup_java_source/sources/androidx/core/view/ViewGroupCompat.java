...
public final class ViewGroupCompat {
    ...
    static WindowInsets dispatchApplyWindowInsets(View view, WindowInsets windowInsets) {
        ...
        view.setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener() { // from class: androidx.core.view.o0000oo
    ...
    public static void installCompatInsetsDispatch(View view) {
        ...
        View.OnApplyWindowInsetsListener onApplyWindowInsetsListener = new View.OnApplyWindowInsetsListener() { // from class: androidx.core.view.o0000O0
            @Override // android.view.View.OnApplyWindowInsetsListener
