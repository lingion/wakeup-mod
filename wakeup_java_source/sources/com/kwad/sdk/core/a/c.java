...
public final class c {
    ...
    public static class b {
        ...
        static final b aIz = new b(false, null, -1, true);
        static final b aIA = new b(true, null, -1, false);
    ...
    public static String decodeKsSdk(String str) {
        return TextUtils.isEmpty(str) ? "" : str.startsWith("sDAkk/dS") ? new String(IZ().decode(str.substring(8)), com.kwad.sdk.crash.utils.a.UTF_8) : str;
    }
    ...
    public static String encodeKsSdk(String str) {
        ...
        return "sDAkk/dS" + new String(IX().encode(str.getBytes()), com.kwad.sdk.crash.utils.a.UTF_8);
    }
    ...
    public static class a {
        ...
        private final boolean isURL;
        static final a aIw = new a(false, false);
        static final a aIx = new a(true, false);
        static final a aIy = new a(false, true);
        ...
        */
        private int decode0(byte[] r12, int r13, int r14, byte[] r15) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.kwad.sdk.core.a.c.a.decode0(byte[], int, int, byte[]):int");
        }
