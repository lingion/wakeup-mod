...
class MediaSessionManagerImplBase implements MediaSessionManager.MediaSessionManagerImpl {
    ...
    boolean isEnabledNotificationListener(@NonNull MediaSessionManager.RemoteUserInfoImpl remoteUserInfoImpl) {
        String strOooO00o = com.zybang.privacy.OooO0OO.OooO00o(this.mContentResolver, ENABLED_NOTIFICATION_LISTENERS);
        if (strOooO00o != null) {
            for (String str : strOooO00o.split(ServerSentEventKt.COLON)) {
