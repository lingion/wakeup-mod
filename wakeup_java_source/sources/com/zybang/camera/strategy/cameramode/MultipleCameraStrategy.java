...
public final class MultipleCameraStrategy extends SearchBaseCameraStrategy {
    ...
    @OooO0o(c = "com.zybang.camera.strategy.cameramode.MultipleCameraStrategy$onPictureTakenBeforeCrop$1", f = "MultipleCameraStrategy.kt", l = {43, 50}, m = "invokeSuspend")
    /* renamed from: com.zybang.camera.strategy.cameramode.MultipleCameraStrategy$onPictureTakenBeforeCrop$1, reason: invalid class name */
    static final class AnonymousClass1 extends SuspendLambda implements Function2<o000OO, OooO<? super o0OOO0o>, Object> {
        ...
        @OooO0o(c = "com.zybang.camera.strategy.cameramode.MultipleCameraStrategy$onPictureTakenBeforeCrop$1$1", f = "MultipleCameraStrategy.kt", l = {}, m = "invokeSuspend")
        /* renamed from: com.zybang.camera.strategy.cameramode.MultipleCameraStrategy$onPictureTakenBeforeCrop$1$1, reason: invalid class name and collision with other inner class name */
        static final class C05591 extends SuspendLambda implements Function2<o000OO, OooO<? super Object>, Object> {
            final /* synthetic */ o00O0O $transferEntity;
            int label;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C05591(o00O0O o00o0o2, OooO<? super C05591> oooO) {
                super(2, oooO);
            ...
            public final OooO<o0OOO0o> create(Object obj, OooO<?> oooO) {
                return new C05591(this.$transferEntity, oooO);
            }
            ...
            public final Object invoke2(o000OO o000oo2, OooO<Object> oooO) {
                return ((C05591) create(o000oo2, oooO)).invokeSuspend(o0OOO0o.f13233OooO00o);
            }
        }

        @OooO0o(c = "com.zybang.camera.strategy.cameramode.MultipleCameraStrategy$onPictureTakenBeforeCrop$1$2", f = "MultipleCameraStrategy.kt", l = {}, m = "invokeSuspend")
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                C05591 c05591 = new C05591(this.$transferEntity, null);
                this.label = 1;
                if (OooOOO0.OooO0oO(o0000VarOooO0O0, c05591, this) == objOooO0oO) {
                    return objOooO0oO;
                }
            } else {
                if (i != 1) {
    ...
    public MultipleCameraStrategy() {
        this.modeItem = new MultipleModeItem(null, 1, null);
    }
