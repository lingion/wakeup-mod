...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> implements MaterialBackHandler {
    ...
    */
    ...
    public void setHalfExpandedRatio(@FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, fromInclusive = false, to = Contrast.RATIO_MIN, toInclusive = false) float f) {
        if (f <= 0.0f || f >= 1.0f) {
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    public boolean shouldExpandOnUpwardDrag(long j, @FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = 100.0d) float f) {
        return false;
    }
    ...
    public BottomSheetBehavior(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        this.dragCallback = new ViewDragHelper.Callback() { // from class: com.google.android.material.bottomsheet.BottomSheetBehavior.5
            ...
            @Override // androidx.customview.widget.ViewDragHelper.Callback
            public void onViewReleased(@NonNull View v, float v2, float v3) {
                /*
                    Method dump skipped, instructions count: 309
                    To view this dump add '--comments-level debug' option
                */
