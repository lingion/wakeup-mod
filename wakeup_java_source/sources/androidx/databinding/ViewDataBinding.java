...
public abstract class ViewDataBinding extends BaseObservable implements ViewBinding {
    ...
    protected void registerTo(int i, Object obj, CreateWeakListener createWeakListener) {
        ...
        if (weakListenerCreate == null) {
            weakListenerCreate = createWeakListener.create(this, i, sReferenceQueue);
    ...
    */
    ...
    protected static double safeUnbox(Double d) {
        return d == null ? IDataEditor.DEFAULT_NUMBER_VALUE : d.doubleValue();
    }
    ...
    protected static double getFromArray(double[] dArr, int i) {
        return (dArr == null || i < 0 || i >= dArr.length) ? IDataEditor.DEFAULT_NUMBER_VALUE : dArr[i];
    }
