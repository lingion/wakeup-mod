...
public class RewardMonitorInfo extends com.kwad.sdk.commercial.c.a implements Serializable {
    ...
    public boolean enableRewardLayoutOptimise = com.kwad.components.ad.reward.a.b.hO();
    public boolean enableFullscreenLayoutOptimise = com.kwad.components.ad.reward.a.b.hP();
    ...
    public void afterToJson(JSONObject jSONObject) {
        ...
        if (i != -1) {
            aa.putValue(jSONObject, "reward_type", i);
        } else {
            jSONObject.remove("reward_type");
        }
        int i2 = this.taskType;
        if (i2 != -1) {
            aa.putValue(jSONObject, "task_type", i2);
        } else {
            jSONObject.remove("task_type");
        }
        int i3 = this.taskStep;
        if (i3 != -1) {
            aa.putValue(jSONObject, "task_step", i3);
        } else {
    ...
    public RewardMonitorInfo setFraudVerifyCode(int i) {
        this.fraudVerifyCode = i;
        return this;
    }

    public RewardMonitorInfo setFraudVerifyType(int i) {
        this.fraudVerifyType = i;
        return this;
    }
    ...
    public RewardMonitorInfo setAdTemplate(AdTemplate adTemplate) {
        ...
        rewardMonitorInfo.setOperationType(com.kwad.sdk.core.response.b.a.aR(adInfoEr));
        rewardMonitorInfo.setMaterialRenderType(com.kwad.components.ad.reward.model.d.m(adInfoEr));
        rewardMonitorInfo.setTKRenderType(com.kwad.sdk.core.response.b.b.a(iEl == 2, adInfoEr));
