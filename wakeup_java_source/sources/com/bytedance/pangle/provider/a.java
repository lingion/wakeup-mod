...
import com.bytedance.pangle.util.rb;
import java.io.File;
...
public class a {
    ...
    private static Uri a(String str, Uri uri, String str2) {
        ...
        String strH = rb.h(h.h(pluginProcessNameByAuthority, str, uri));
        return Uri.parse("content://" + ContentProviderManager.getInstance().getSystemProviderInfoMap().get(pluginProcessNameByAuthority).bj + File.separator + "proxy?provider_params=" + strH);
    }
    ...
    public static Bundle a(ContentResolver contentResolver, String str, String str2, String str3, Bundle bundle, String str4) {
        ...
        String str5 = ContentProviderManager.getInstance().getSystemProviderInfoMap().get(ContentProviderManager.getInstance().getPluginProcessNameByAuthority(str)).bj;
        if (bundle == null) {
            bundle = new Bundle();
        }
