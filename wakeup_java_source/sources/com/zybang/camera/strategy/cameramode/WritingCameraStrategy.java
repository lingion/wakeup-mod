...
public final class WritingCameraStrategy extends SearchBaseCameraStrategy {
    ...
    @OooO0o(c = "com.zybang.camera.strategy.cameramode.WritingCameraStrategy$onPictureTakenBeforeCrop$1", f = "WritingCameraStrategy.kt", l = {}, m = "invokeSuspend")
    /* renamed from: com.zybang.camera.strategy.cameramode.WritingCameraStrategy$onPictureTakenBeforeCrop$1, reason: invalid class name */
    static final class AnonymousClass1 extends SuspendLambda implements Function2<o000OO, OooO<? super o0OOO0o>, Object> {
        ...
        int label;
        final /* synthetic */ WritingCameraStrategy this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass1(Ref$ObjectRef<byte[]> ref$ObjectRef, Activity activity, o00O0O o00o0o2, WritingCameraStrategy writingCameraStrategy, OooO<? super AnonymousClass1> oooO) {
            super(2, oooO);
            this.$imageData = ref$ObjectRef;
            this.$thisActivity = activity;
            this.$transferEntity = o00o0o2;
            this.this$0 = writingCameraStrategy;
        }
    ...
    public WritingCameraStrategy() {
        this.modeItem = new WritingModeItem("");
    }
    ...
    public void onPictureTakenBeforeCrop(Activity thisActivity, o00O0O transferEntity, o0OO0O0 callBack) {
        ...
        o00OO0OO.f17718OooO0O0.OooO00o().OooO0Oo().OooOOOO(thisActivity, (byte[]) ref$ObjectRef.element, transferEntity);
        thisActivity.finish();
    }
}
