...
public class bs extends File {
    ...
    private void d() {
        ...
        for (int i = 0; fileArrListFiles != null && i < fileArrListFiles.length; i++) {
            if (fileArrListFiles[i].getAbsolutePath().contains("__xadsdk__remote__final__")) {
                this.g.a(a, "clearDexCacheFiles-->" + i + "--" + fileArrListFiles[i].getAbsolutePath());
    ...
    protected void a() throws Throwable {
        ...
        throw new bz.a("doCheckApkIntegrity failed, md5sum: " + strA + ", checksum in json info: " + strB);
    }
    ...
    protected double c() {
        bx bxVar = this.c;
        return bxVar == null ? IDataEditor.DEFAULT_NUMBER_VALUE : bxVar.b();
    }
    ...
    private String b(String str) throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException {
        if (this.f == null) {
            return null;
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:48:0x009d A[Catch: Exception -> 0x0099, TRY_LEAVE, TryCatch #6 {Exception -> 0x0099, blocks: (B:44:0x0095, B:48:0x009d), top: B:58:0x0095 }] */
    ...
    */
    private java.lang.String a(java.io.File r9) throws java.lang.Throwable {
        ...
        L5a:
            r9 = move-exception
            com.baidu.mobads.sdk.internal.bt r1 = r8.g
        ...
        L6f:
            ...
            r4 = r2
        L71:
            com.baidu.mobads.sdk.internal.bt r3 = r8.g     // Catch: java.lang.Throwable -> L92
        ...
        L82:
            ...
            goto L91
        L88:
            com.baidu.mobads.sdk.internal.bt r2 = r8.g
            java.lang.String r9 = r9.getMessage()
            r2.a(r0, r9)
        L91:
            return r1
    ...
    private Class<?> b(File file) {
        Class<?> cls;
        this.g.a(a, "Android version:" + bm.a(this.e).c());
        Class<?> cls2 = null;
        try {
