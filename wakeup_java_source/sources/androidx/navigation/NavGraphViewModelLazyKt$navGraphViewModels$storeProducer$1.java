...
public final class NavGraphViewModelLazyKt$navGraphViewModels$storeProducer$1 implements Function0<ViewModelStore> {
    ...
    public NavGraphViewModelLazyKt$navGraphViewModels$storeProducer$1(kotlin.OooOOO0 oooOOO0) {
    ...
    public final ViewModelStore invoke() {
        return NavGraphViewModelLazyKt.m44navGraphViewModels$lambda0(this.$backStackEntry$delegate).getViewModelStore();
    }
}
