...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    public Snackbar setAction(@Nullable CharSequence charSequence, @Nullable final View.OnClickListener onClickListener) {
        ...
        if (TextUtils.isEmpty(charSequence) || onClickListener == null) {
            ...
            actionView.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.snackbar.OooO0OO
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f5056OooO0o0.lambda$setAction$0(onClickListener, view);
                }
            });
        }
        return this;
