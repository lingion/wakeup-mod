...
public final class CollapsingTextHelper {
    ...
    @ColorInt
    private static int blendARGB(@ColorInt int i, @ColorInt int i2, @FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = Contrast.RATIO_MIN) float f) {
        float f2 = 1.0f - f;
        return Color.argb(Math.round((Color.alpha(i) * f2) + (Color.alpha(i2) * f)), Math.round((Color.red(i) * f2) + (Color.red(i2) * f)), Math.round((Color.green(i) * f2) + (Color.green(i2) * f)), Math.round((Color.blue(i) * f2) + (Color.blue(i2) * f)));
    }

    private void calculateBaseOffsets(boolean z) throws NoSuchMethodException, SecurityException {
    ...
    private float calculateFadeModeTextAlpha(@FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = Contrast.RATIO_MIN) float f) {
    ...
    private StaticLayout createStaticLayout(int i, float f, boolean z) throws NoSuchMethodException, SecurityException {
    ...
    @RequiresApi(23)
    public void setLineSpacingMultiplier(@FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE) float f) {
    ...
    @RequiresApi(23)
    public void setStaticLayoutBuilderConfigurer(@Nullable StaticLayoutBuilderConfigurer staticLayoutBuilderConfigurer) throws NoSuchMethodException, SecurityException {
    ...
    private void calculateUsingTextSize(float f, boolean z) throws NoSuchMethodException, SecurityException {
        float f2;
        float f3;
        Typeface typeface;
        if (this.text == null) {
    ...
    public void recalculate(boolean z) throws NoSuchMethodException, SecurityException {
