...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    private static CharSequence getFirstLineBySeparator(@Nullable CharSequence charSequence) {
        ...
        String[] strArrSplit = TextUtils.split(String.valueOf(charSequence), a.c);
    ...
    private void initHeaderToggle(Context context) {
        ...
        this.headerToggleButton.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.datepicker.OooOO0O
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f5002OooO0o0.lambda$initHeaderToggle$0(view);
            }
        });
    }
    ...
    static boolean readMaterialCalendarStyleBoolean(@NonNull Context context, int i) throws Resources.NotFoundException {
    ...
    public final Dialog onCreateDialog(@Nullable Bundle bundle) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(null, com.google.android.material.R.styleable.MaterialCalendar, i, i2);
