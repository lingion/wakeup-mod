...
class TooltipCompatHandler implements View.OnLongClickListener, View.OnHoverListener, View.OnAttachStateChangeListener {
    ...
    private final Runnable mShowRunnable = new Runnable() { // from class: androidx.appcompat.widget.o000O00
        @Override // java.lang.Runnable
        public final void run() throws Resources.NotFoundException {
            this.f1138OooO0o0.lambda$new$0();
        }
    };
    private final Runnable mHideRunnable = new Runnable() { // from class: androidx.appcompat.widget.o000O00O
        @Override // java.lang.Runnable
        public final void run() {
            this.f1140OooO0o0.hide();
        }
    };
    ...
    void show(boolean z) throws Resources.NotFoundException {
