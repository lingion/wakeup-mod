...
public final class ft implements com.kwad.sdk.core.d<HybridLoadMsg> {
    ...
    private static JSONObject b(HybridLoadMsg hybridLoadMsg, JSONObject jSONObject) {
        ...
        if (i2 != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "state", i2);
        }
        String str3 = hybridLoadMsg.interval;
        if (str3 != null && !str3.equals("")) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "interval", hybridLoadMsg.interval);
        }
        int i3 = hybridLoadMsg.failState;
        if (i3 != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "fail_state", i3);
        }
