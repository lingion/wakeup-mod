...
public class MultipleModeItem extends ModeItem implements Parcelable {
    ...
    public MultipleModeItem(String modeName) {
        super(modeName);
        ...
        Oooo0oo(4);
        OooooOo("4");
        Oooo(R$drawable.sdk_camera_middle_new_icon_multiple);
        Oooo0o(true);
        String string = OooOO0.OooO0Oo().getString(R$string.camera_base_multiple_middle_toast_text);
    ...
    public /* synthetic */ MultipleModeItem(String str, int i, OooOOO oooOOO) {
        this((i & 1) != 0 ? OooOO0.OooO0Oo().getResources().getString(R$string.camera_base_multiple_tab_name) : str);
    }
}
