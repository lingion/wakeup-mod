...
public final class FlowExpressTemplateV4 extends BaseFlowExpressTemplate {
    ...
    public FlowExpressTemplateV4(ApiAdModel apiAdModel, AdSlot apiAdSlot) {
    ...
    private final void dealAdView() {
        ...
        this.totalHeight = getApiAdSlot().getHeight() == 0 ? OooOo00.OooO00o(80.0f) : OooOo00.OooO00o(getApiAdSlot().getHeight());
        ...
        if (layoutParams == null) {
            ...
            itemView2.setLayoutParams(new ViewGroup.LayoutParams(this.totalWidth, this.totalHeight));
            return;
        }
    ...
    public final void generated() {
        ...
        mAdExposurePost.startPostExposure(new Function0<o0OOO0o>() { // from class: com.fastad.api.express.FlowExpressTemplateV4$generated$1$1
            {
                super(0);
            }
    ...
    private final void showImageOrVideo() {
        ...
        View itemView = getItemView();
        final ImageView imageView = itemView == null ? null : (ImageView) itemView.findViewById(R.id.id_ad_image);
        View itemView2 = getItemView();
        final VideoPlayLayout videoPlayLayout = itemView2 == null ? null : (VideoPlayLayout) itemView2.findViewById(R.id.id_ad_video);
        View itemView3 = getItemView();
        final ImageView imageView2 = itemView3 == null ? null : (ImageView) itemView3.findViewById(R.id.id_ad_blur);
        if (((AdMaterials.FileMaterials) ref$ObjectRef.element).fileType == 1) {
            ...
            OooO0OO.OooOo00(getActivity()).OooO0O0().o0000(((AdMaterials.FileMaterials) ref$ObjectRef.element).url).o000000O(new o00O0O() { // from class: com.fastad.api.express.FlowExpressTemplateV4$showImageOrVideo$3$1
        ...
        videoPlayLayout.setVideoPlayListener(new OnVideoPlayListener() { // from class: com.fastad.api.express.FlowExpressTemplateV4$showImageOrVideo$4$1
    ...
    private final void showInteract() {
        ...
        if (z && z2 && z2) {
            ...
            if (imageView != null) {
                ...
                layoutParams.height = ((i - 10) / 8) * 3;
                layoutParams.width = ((i - 10) / 8) * 3;
                ...
                Function1<o0OOOO0o, o0OOO0o> function1 = new Function1<o0OOOO0o, o0OOO0o>() { // from class: com.fastad.api.express.FlowExpressTemplateV4$showInteract$2$onShake$1
                    {
                        super(1);
                    }
                ...
                Function0<o0OOO0o> function0 = new Function0<o0OOO0o>() { // from class: com.fastad.api.express.FlowExpressTemplateV4$showInteract$2$destroyShake$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(0);
                    }
    ...
    private final void showRightInfo() {
        ...
        View itemView;
        View itemView2 = getItemView();
        TextView textView = itemView2 == null ? null : (TextView) itemView2.findViewById(R.id.id_ad_description);
        View itemView3 = getItemView();
        ...
        if (!this.allAreaClick || (itemView = getItemView()) == null) {
            return;
        }
        Oooo0.f5417OooO00o.OooO0OO(itemView, new Function1<o0OOo000, o0OOO0o>() { // from class: com.fastad.api.express.FlowExpressTemplateV4$showRightInfo$2$1
            {
                super(1);
            }
    ...
    public void formatCloseTemplate() {
        FlowExpressAdActionListener adActionListener;
        View itemView = getItemView();
        if ((itemView == null ? null : itemView.getParent()) == null || (adActionListener = getAdActionListener()) == null) {
            return;
        }
    ...
    public void generateAdView(Activity activity, FlowExpressAdActionListener flowExpressAdActionListener) {
        ...
        setItemView(LayoutInflater.from(activity).inflate(R.layout.flow_express_v4_layout, (ViewGroup) null));
        dealAdView();
        showImageOrVideo();
    }
