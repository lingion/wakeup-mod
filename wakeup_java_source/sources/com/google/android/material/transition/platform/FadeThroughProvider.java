...
public final class FadeThroughProvider implements VisibilityAnimatorProvider {
    ...
    private static Animator createFadeThroughAnimator(final View view, final float f, final float f2, @FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = Contrast.RATIO_MIN) final float f3, @FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = Contrast.RATIO_MIN) final float f4, final float f5) {
    ...
    public void setProgressThreshold(@FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = Contrast.RATIO_MIN) float f) {
