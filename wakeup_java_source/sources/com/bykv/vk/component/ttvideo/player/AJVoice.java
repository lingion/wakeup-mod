...
public class AJVoice implements AudioTrack.OnPlaybackPositionUpdateListener {
    ...
    private int reconfigure() {
        ...
        if (minBufferSize <= 0) {
            l.a(TAG, "getMinBufferSize failed, trace: sampleRate = " + this.mSampleRate + ", mChannelsLayout = " + this.mChannelsLayout + ", mAudioFormat = " + this.mAudioFormat);
            ...
            try {
                ...
                if (audioTrack.getState() != 1) {
                    ...
                    try {
                        ...
                        l.a(TAG, "create audiotrack but failed to initialize");
                        return -3;
                ...
                l.a(TAG, "create audio track failed ,detail = ".concat(String.valueOf(th)));
                return -1;
            }
        } catch (OutOfMemoryError unused3) {
            l.a(TAG, "out of memory error when new audio buffer for audiotrack");
            return -10;
        }
    }
            ...
            try {
                AVThreadPool.addTask(new Runnable() { // from class: com.bykv.vk.component.ttvideo.player.AJVoice.1
                    ...
                    public void run() throws InterruptedException {
                        l.h(AJVoice.TAG, "start release task");
                        AJVoice.this.releaseTrack(audioTrack);
                    }
                });
            } catch (Throwable th) {
                l.bj(TAG, "create close thread fail = ".concat(String.valueOf(th)));
        ...
        if (this.getLatencyMethod != null) {
            ...
            if (jNanoTime - this.mLastGetLatencyMs > 500) {
                try {
                    ...
                    if (iMax > 5000) {
                        l.bj(TAG, "Ignoring impossibly large audio latency: " + this.mLatencyMs);
                        this.mLatencyMs = 0;
                    }
                } catch (Exception unused) {
    ...
    public int getMaxVolume() {
        l.h("ttmn", "getMaxVolume:" + this.mMaxVolume);
    ...
    public void releaseTrack(AudioTrack audioTrack) throws InterruptedException {
        if (audioTrack == null) {
            return;
        }
        try {
        ...
        try {
            ...
            l.bj(TAG, "release in invalid state = ".concat(String.valueOf(e)));
        }
    }
    ...
    public int start() {
        if (this.mAudioTrack == null) {
            l.a(TAG, "audiotrack start before created");
            return -2;
        }
        this.mStoped = false;
        try {
            ...
            l.a(TAG, "audioTrack start failed = ".concat(String.valueOf(th)));
            return -3;
        }
    }
    ...
    public int write(byte[] bArr, int i, int i2, int i3) {
        ...
        try {
            ...
            l.a(TAG, "write failed : ret: " + iWrite + ", size = " + i2);
            return iWrite;
        } catch (Exception e) {
            l.h(e);
            return -1;
    ...
    @CalledByNative
    public int write(byte[] bArr, int i, int i2, int i3, long j) throws IllegalStateException {
        if (bArr != null && bArr.length != 0) {
            int iStart = 0;
            if (this.mStoped) {
                return 0;
            ...
            if (i4 == -1) {
                ...
                if (Math.abs(writtenDurationMs - j) > FORCE_RESET_WORKAROUND_TIMEOUT_MS) {
                    l.a(TAG, "Discontinuity detected [expected " + writtenDurationMs + ", got " + j + "]");
