...
public final class R$styleable {
    ...
    public static final int WCountDownLoadingView_w_loading_border_width = 0;
    public static final int WDotsIndicator_w_colorAlphaSwitch = 0;
    public static final int WDotsIndicator_w_dotsColor = 1;
    public static final int WDotsIndicator_w_dotsCornerRadius = 2;
    public static final int WDotsIndicator_w_dotsSize = 3;
    public static final int WDotsIndicator_w_dotsSpacing = 4;
    public static final int WDotsIndicator_w_dotsWidthFactor = 5;
    public static final int WDotsIndicator_w_progressMode = 6;
    public static final int WDotsIndicator_w_selectedDotColor = 7;
    ...
    public static final int[] WCountDownLoadingView = {R.attr.w_loading_border_width};
    public static final int[] WDotsIndicator = {R.attr.w_colorAlphaSwitch, R.attr.w_dotsColor, R.attr.w_dotsCornerRadius, R.attr.w_dotsSize, R.attr.w_dotsSpacing, R.attr.w_dotsWidthFactor, R.attr.w_progressMode, R.attr.w_selectedDotColor};
