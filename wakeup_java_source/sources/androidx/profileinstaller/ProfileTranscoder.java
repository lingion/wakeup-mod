...
class ProfileTranscoder {
    ...
    private static int computeMethodFlags(@NonNull DexProfileData dexProfileData) {
        Iterator<Map.Entry<Integer, Integer>> it2 = dexProfileData.methods.entrySet().iterator();
        int iIntValue = 0;
        while (it2.hasNext()) {
    ...
    private static String enforceSeparator(@NonNull String str, @NonNull String str2) {
        return "!".equals(str2) ? str.replace(ServerSentEventKt.COLON, "!") : ServerSentEventKt.COLON.equals(str2) ? str.replace("!", ServerSentEventKt.COLON) : str;
    }
    ...
    private static void writeProfileForN(@NonNull OutputStream outputStream, @NonNull DexProfileData[] dexProfileDataArr) throws IOException {
        ...
        for (DexProfileData dexProfileData : dexProfileDataArr) {
            ...
            Iterator<Integer> it2 = dexProfileData.methods.keySet().iterator();
            while (it2.hasNext()) {
