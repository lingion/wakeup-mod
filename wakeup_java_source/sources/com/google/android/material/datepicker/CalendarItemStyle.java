...
final class CalendarItemStyle {
    ...
    @NonNull
    static CalendarItemStyle create(@NonNull Context context, @StyleRes int i) throws Resources.NotFoundException {
    ...
    void styleItem(@NonNull TextView textView) {
        styleItem(textView, null, null);
    }

    void styleItem(@NonNull TextView textView, @Nullable ColorStateList colorStateList, @Nullable ColorStateList colorStateList2) {
