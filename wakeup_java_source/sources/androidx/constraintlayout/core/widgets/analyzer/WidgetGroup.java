...
public class WidgetGroup {
    ...
    private String getOrientationString() {
        ...
        return i == 0 ? "Horizontal" : i == 1 ? "Vertical" : i == 2 ? "Both" : BuglyAppVersionMode.UNKNOWN;
    }
    ...
    public void moveTo(int i, WidgetGroup widgetGroup) {
        Iterator<ConstraintWidget> it2 = this.mWidgets.iterator();
        while (it2.hasNext()) {
    ...
    public String toString() {
        ...
        Iterator<ConstraintWidget> it2 = this.mWidgets.iterator();
        while (it2.hasNext()) {
            str = str + ServerSentEventKt.SPACE + it2.next().getDebugName();
        }
        return str + " >";
    }
