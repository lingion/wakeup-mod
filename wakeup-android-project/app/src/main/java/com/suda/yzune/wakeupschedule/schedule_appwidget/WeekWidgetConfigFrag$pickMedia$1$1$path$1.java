...
@kotlin.coroutines.jvm.internal.OooO0o(c = "com.suda.yzune.wakeupschedule.schedule_appwidget.WeekWidgetConfigFrag$pickMedia$1$1$path$1", f = "WeekWidgetConfigFrag.kt", l = {}, m = "invokeSuspend")
/* loaded from: classes4.dex */
final class WeekWidgetConfigFrag$pickMedia$1$1$path$1 extends SuspendLambda implements Function2<o000OO, kotlin.coroutines.OooO<? super String>, Object> {
    ...
    WeekWidgetConfigFrag$pickMedia$1$1$path$1(WeekWidgetConfigFrag weekWidgetConfigFrag, Uri uri, Ref$ObjectRef<BufferedSource> ref$ObjectRef, Ref$ObjectRef<BufferedSink> ref$ObjectRef2, kotlin.coroutines.OooO<? super WeekWidgetConfigFrag$pickMedia$1$1$path$1> oooO) {
        super(2, oooO);
    ...
    public final kotlin.coroutines.OooO<kotlin.o0OOO0o> create(Object obj, kotlin.coroutines.OooO<?> oooO) {
        return new WeekWidgetConfigFrag$pickMedia$1$1$path$1(this.this$0, this.$uri, this.$bufferedSource, this.$bufferedSink, oooO);
    }
    ...
    public final Object invokeSuspend(Object obj) throws FileNotFoundException {
        ...
        try {
            ...
            File file = new File(this.this$0.requireContext().getFilesDir(), "widget" + this.this$0.OoooO00().OooOO0O() + "_bg_" + System.currentTimeMillis());
    ...
    public final Object invoke(o000OO o000oo2, kotlin.coroutines.OooO<? super String> oooO) {
        return ((WeekWidgetConfigFrag$pickMedia$1$1$path$1) create(o000oo2, oooO)).invokeSuspend(kotlin.o0OOO0o.f13233OooO00o);
    }
}
