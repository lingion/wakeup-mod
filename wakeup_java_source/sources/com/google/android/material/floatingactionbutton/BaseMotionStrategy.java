...
abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    @NonNull
    AnimatorSet createAnimator(@NonNull MotionSpec motionSpec) {
        ArrayList arrayList = new ArrayList();
        if (motionSpec.hasPropertyValues("opacity")) {
            arrayList.add(motionSpec.getAnimator("opacity", this.fab, View.ALPHA));
        }
        if (motionSpec.hasPropertyValues(j.c)) {
            arrayList.add(motionSpec.getAnimator(j.c, this.fab, View.SCALE_Y));
            arrayList.add(motionSpec.getAnimator(j.c, this.fab, View.SCALE_X));
        }
