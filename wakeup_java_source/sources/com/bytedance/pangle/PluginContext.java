...
public class PluginContext extends yv {
    ...
    public static Context getContextWithoutTheme(Context context) {
        return context instanceof ContextThemeWrapper ? getContextWithoutTheme(((ContextThemeWrapper) context).getBaseContext()) : context instanceof androidx.appcompat.view.ContextThemeWrapper ? getContextWithoutTheme(((androidx.appcompat.view.ContextThemeWrapper) context).getBaseContext()) : context;
    }
    ...
    public Context createConfigurationContext(Configuration configuration) {
        ...
        try {
            ...
            com.bytedance.pangle.bj.bj.h.h(contextCreateConfigurationContext.getClass(), "mResources").set(contextCreateConfigurationContext, this.mPlugin.mResources);
        }
    ...
    @Override // com.bytedance.pangle.yv
    ...
    public Object getSystemService(String str) {
        ...
        if (this.mInflater == null) {
            ...
            com.bytedance.pangle.res.bj.h(layoutInflaterCloneInContext);
        }
