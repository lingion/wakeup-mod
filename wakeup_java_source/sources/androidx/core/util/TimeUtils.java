...
public final class TimeUtils {
    ...
    private static int formatDurationLocked(long j, int i) {
        ...
        int i10 = i6 + 1;
        boolean z = i != 0;
        int iPrintField = printField(cArr, i2, GMTDateParser.DAY_OF_MONTH, i10, false, 0);
        int iPrintField2 = printField(cArr, i3, GMTDateParser.HOURS, iPrintField, iPrintField != i10, z ? 2 : 0);
        int iPrintField3 = printField(cArr, i5, GMTDateParser.MINUTES, iPrintField2, iPrintField2 != i10, z ? 2 : 0);
        int iPrintField4 = printField(cArr, i4, GMTDateParser.SECONDS, iPrintField3, iPrintField3 != i10, z ? 2 : 0);
        int iPrintField5 = printField(cArr, i8, GMTDateParser.MINUTES, iPrintField4, true, (!z || iPrintField4 == i10) ? 0 : 3);
        cArr[iPrintField5] = GMTDateParser.SECONDS;
