...
public class ContentProviderProxy extends ContentProvider {
    ...
    private PluginContentProvider obtainPluginProvider(Uri uri, String str, String str2) {
        ...
        if (!TextUtils.isEmpty(queryParameter)) {
            queryParameter = rb.bj(queryParameter);
        }
        ...
        PluginContentProvider pluginProvider = this.mPluginProviderManager.getPluginProvider(new ContentProviderManager.bj(strOptString2, strOptString, str2));
