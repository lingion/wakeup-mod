...
final class a extends SQLiteOpenHelper implements c {
    private static final String[] aQu = {"_id", "url", "length", "mime"};
    ...
    @Override // com.kwad.sdk.core.videocache.d.c
    public final n fi(String str) throws Throwable {
        Throwable th;
        Cursor cursorQuery;
        ax.hy(str);
        n nVarH = null;
        try {
            cursorQuery = getReadableDatabase().query("SourceInfo", aQu, "url=?", new String[]{str}, null, null, null);
            if (cursorQuery != null) {
                try {
    ...
    private static ContentValues a(n nVar) {
        ...
        contentValues.put("length", Long.valueOf(nVar.aQo));
        contentValues.put("mime", nVar.aQp);
