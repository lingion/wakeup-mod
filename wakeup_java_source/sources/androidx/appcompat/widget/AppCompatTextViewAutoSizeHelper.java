...
class AppCompatTextViewAutoSizeHelper {
    ...
    @NonNull
    @VisibleForTesting
    StaticLayout createLayout(@NonNull CharSequence charSequence, @NonNull Layout.Alignment alignment, int i, int i2) {
    ...
    void loadFromAttributes(@Nullable AttributeSet attributeSet, int i) throws Resources.NotFoundException {
        int resourceId;
