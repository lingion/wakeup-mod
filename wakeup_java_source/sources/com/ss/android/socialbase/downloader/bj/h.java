...
public class h extends SQLiteOpenHelper {
    ...
    private h() {
        super(new com.bytedance.sdk.openadsdk.api.plugin.h(com.ss.android.socialbase.downloader.downloader.cg.lh()), "downloader.db", (SQLiteDatabase.CursorFactory) null, 15);
        this.bj = false;
    }
    ...
    public SQLiteDatabase getReadableDatabase() throws SQLException {
        ...
        if (this.bj || contextLh == null) {
            return super.getReadableDatabase();
        }
        try {
            File file = new File("/data/data/" + contextLh.getPackageName() + "/database/main/");
            if (!file.exists()) {
                file.mkdir();
            }
    ...
    public void onConfigure(SQLiteDatabase sQLiteDatabase) {
        ...
        if (com.ss.android.socialbase.downloader.u.h.cg().bj("disable_sqlite_wal") <= 0 || Build.VERSION.SDK_INT != 28) {
            return;
        }
    ...
    public void onDowngrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        if (com.ss.android.socialbase.downloader.cg.h.h()) {
            com.ss.android.socialbase.downloader.cg.h.h("onDowngrade");
        }
    }
