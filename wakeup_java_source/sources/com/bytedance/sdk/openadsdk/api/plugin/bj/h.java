...
public final class h implements HostnameVerifier {
    ...
    private static final Pattern bj = Pattern.compile("([0-9a-fA-F]*:[0-9a-fA-F:.]*)|([\\d.]+)");
    ...
    private boolean cg(String str, X509Certificate x509Certificate) throws CertificateParsingException {
        ...
        if (z || (strH = new bj(x509Certificate.getSubjectX500Principal()).h("cn")) == null) {
            return false;
        }
    ...
    private boolean h(String str, X509Certificate x509Certificate) {
        return h(str) ? bj(str, x509Certificate) : cg(str, x509Certificate);
    }
