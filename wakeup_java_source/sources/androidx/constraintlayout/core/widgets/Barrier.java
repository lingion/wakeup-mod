    ...
    public void addToSolver(LinearSystem linearSystem, boolean z) {
        ...
        for (int i9 = 0; i9 < this.mWidgetsCount; i9++) {
            ...
            if (this.mAllowsGoneWidget || constraintWidget2.allowedInBarrier()) {
                ...
                if (i10 == 0 || i10 == 2) {
                    linearSystem.addLowerBarrier(constraintAnchor2.mSolverVariable, solverVariableCreateObjectVariable, this.mMargin - i11, z2);
                } else {
                    linearSystem.addGreaterBarrier(constraintAnchor2.mSolverVariable, solverVariableCreateObjectVariable, this.mMargin + i11, z2);
                }
                linearSystem.addEquality(constraintAnchor2.mSolverVariable, solverVariableCreateObjectVariable, this.mMargin + i11, i8);
            }
        }
