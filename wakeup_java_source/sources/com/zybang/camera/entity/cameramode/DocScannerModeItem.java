...
public class DocScannerModeItem extends ModeItem implements Parcelable {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DocScannerModeItem(String modeName) {
        super(modeName);
        o0OoOo0.OooO0oO(modeName, "modeName");
        String name = DocScannerStrategy.class.getName();
        o0OoOo0.OooO0o(name, "getName(...)");
        Oooooo0(name);
        Oooo0oo(16);
        OooooOo("16");
        OoooOOo(true);
        String string = OooOO0.OooO0Oo().getString(R$string.camera_base_cam_scanner_middle_toast_text);
    ...
    public /* synthetic */ DocScannerModeItem(String str, int i, OooOOO oooOOO) {
        this((i & 1) != 0 ? OooOO0.OooO0Oo().getResources().getString(R$string.camera_base_doc_scanner_tab_name) : str);
    }
}
