...
public class AVMDLDataLoader implements Handler.Callback {
            ...
            synchronized (AVMDLDataLoader.class) {
                if (mInstance == null) {
                    try {
                        ...
                        l.h(e);
                        l.a("ttmdl", "create native exception".concat(String.valueOf(e)));
                        mInstance = null;
                    }
                }
            }
        ...
        try {
            ...
            if (!z) {
                try {
                    ...
                    l.a("ttmn", "Can't load avmdl library: ".concat(String.valueOf(e)));
                } catch (Throwable th) {
                    l.a("ttmn", "other exception when loading avmdl library: ".concat(String.valueOf(th)));
                }
    ...
    private void initLogThread(final Handler.Callback callback) {
        if (this.mMsgThread == null) {
            cg cgVar = new cg() { // from class: com.bykv.vk.component.ttvideo.mediakit.medialoader.AVMDLDataLoader.1
            ...
            this.mMsgThread = cgVar;
            cgVar.setName("mdl_log_handler");
    ...
    private void setConfigureInternal(AVMDLDataLoaderConfigure aVMDLDataLoaderConfigure) {
        ...
        if (i > 0) {
            _setIntValue(this.mHandle, 104, i);
        }
        ...
        if (i2 > 0) {
            _setIntValue(this.mHandle, KeyIsSocketSendBufferKB, i2);
        }
        int i3 = aVMDLDataLoaderConfigure.mRingBufferSizeKB;
        if (i3 > 0) {
            _setIntValue(this.mHandle, KeyIsRingBufferSizeKB, i3);
        }
    ...
    private double testFileIO(String str, int i, RandomAccessFile randomAccessFile) throws InterruptedException, IOException {
        if (TextUtils.isEmpty(str)) {
            return -1.0d;
        }
    ...
    private int testFileIOSpeed() {
        ...
        String str2 = str.charAt(str.length() - 1) == '/' ? String.format("%siospeed", this.mConfigure.mCacheDir) : String.format("%s/iospeed", this.mConfigure.mCacheDir);
        ...
        try {
            ...
            for (int i = 0; i < 30; i++) {
                try {
                    ...
                    e = e;
                    dTestFileIO = IDataEditor.DEFAULT_NUMBER_VALUE;
                }
                try {
                    String.format("num:%d result:%f", Integer.valueOf(i), Double.valueOf(dTestFileIO));
                } catch (Exception e2) {
                    e = e2;
                    l.h(e);
                    if (dTestFileIO <= IDataEditor.DEFAULT_NUMBER_VALUE) {
                    }
                }
                if (dTestFileIO <= IDataEditor.DEFAULT_NUMBER_VALUE && i >= 20) {
                    try {
                        d2 += dTestFileIO;
                        d += 1.0d;
            ...
            try {
                switch (i) {
                    ...
                    default:
                        ...
                        if (j2 != 0) {
                            j_getLongValue = _getLongValue(j2, i);
                            break;
                        }
                        break;
                }
    ...
    public boolean handleMessage(Message message) {
        int i = message.what;
        return (i == 12 || i == 9) ? postMessage(this.mLiveListener, message) : (i == 71 || i == 72 || i == 73 || i == 74) ? postMessage(this.mEventListener, message) : postMessage(this.mVodListener, message);
    }
    ...
    public void onEventInfo(Object obj) {
        ...
        try {
            ...
            if (map.containsKey("off")) {
                loaderEventInfo.off = ((Long) map.get("off")).longValue();
            }
            ...
            if (strValueOf != "") {
                for (String str : strValueOf.split(ServerSentEventKt.END_OF_LINE)) {
    ...
    public int start() {
        ...
        initNativeHandle();
        new cg(new Runnable() { // from class: com.bykv.vk.component.ttvideo.mediakit.medialoader.AVMDLDataLoader.2
    ...
    public static synchronized int init(boolean z, boolean z2) {
        try {
            ...
            if (!z) {
                ...
                if (z2) {
                    l.a("ttmn", "try to load pcdn lib");
                    try {
                        je.h("avmdlp2p");
                    } catch (UnsatisfiedLinkError e2) {
                        l.a("ttmn", "Can't load avmdlp2p library: ".concat(String.valueOf(e2)));
                    } catch (Throwable th2) {
                        l.a("ttmn", "other exception when loading avmdl library: ".concat(String.valueOf(th2)));
                    }
                }
                tryLoadTTNetLoaderPlugin();
            }
    ...
    /* JADX WARN: Removed duplicated region for block: B:68:0x0111 A[ADDED_TO_REGION, REMOVE, RETURN] */
    /*
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:40:0x0090 A[Catch: all -> 0x0019, TRY_LEAVE, TryCatch #2 {, blocks: (B:4:0x0003, B:9:0x000a, B:13:0x0011, B:19:0x002c, B:30:0x005d, B:37:0x006e, B:38:0x007e, B:39:0x008d, B:27:0x003c, B:28:0x004c, B:18:0x001d, B:40:0x0090, B:31:0x0064, B:21:0x0030), top: B:49:0x0003, inners: #3, #4, #5, #6 }] */
    /* JADX WARN: Removed duplicated region for block: B:42:0x0094 A[DONT_GENERATE] */
    /* JADX WARN: Removed duplicated region for block: B:45:0x0097 A[DONT_GENERATE] */
    ...
    */
    public static synchronized int init(boolean r4, boolean r5, boolean r6) {
        /*
            ...
            monitor-enter(r0)
            boolean r1 = com.bykv.vk.component.ttvideo.mediakit.medialoader.AVMDLDataLoader.mIsLibraryLoaded     // Catch: java.lang.Throwable -> L19
            r2 = 0
            if (r1 == 0) goto La
            monitor-exit(r0)
            return r2
        La:
            com.bykv.vk.component.ttvideo.mediakit.medialoader.AVMDLDataLoader.mIsLibraryLoaded = r4     // Catch: java.lang.Throwable -> L19
            if (r4 != 0) goto L90
            r4 = 1
            if (r6 == 0) goto L2c
            java.lang.String r6 = "avmdlv2"
            com.bytedance.sdk.openadsdk.pw.je.h(r6)     // Catch: java.lang.Throwable -> L19 java.lang.UnsatisfiedLinkError -> L1c
            com.bykv.vk.component.ttvideo.mediakit.medialoader.AVMDLDataLoader.mIsLibraryLoaded = r4     // Catch: java.lang.Throwable -> L19 java.lang.UnsatisfiedLinkError -> L1c
            goto L2c
        L19:
            r4 = move-exception
            goto L99
        L1c:
            ...
            java.lang.String r6 = r3.concat(r6)     // Catch: java.lang.Throwable -> L19
            com.bytedance.sdk.component.utils.l.a(r1, r6)     // Catch: java.lang.Throwable -> L19
        L2c:
            boolean r6 = com.bykv.vk.component.ttvideo.mediakit.medialoader.AVMDLDataLoader.mIsLibraryLoaded     // Catch: java.lang.Throwable -> L19
            if (r6 != 0) goto L90
            java.lang.String r6 = "avmdl_lite"
            com.bytedance.sdk.openadsdk.pw.je.h(r6)     // Catch: java.lang.Throwable -> L38 java.lang.UnsatisfiedLinkError -> L3a
            com.bykv.vk.component.ttvideo.mediakit.medialoader.AVMDLDataLoader.mIsLibraryLoaded = r4     // Catch: java.lang.Throwable -> L38 java.lang.UnsatisfiedLinkError -> L3a
            goto L5b
        L38:
            r4 = move-exception
            goto L3c
        ...
        L3c:
            ...
            java.lang.String r4 = java.lang.String.valueOf(r4)     // Catch: java.lang.Throwable -> L19
            java.lang.String r4 = r1.concat(r4)     // Catch: java.lang.Throwable -> L19
            com.bytedance.sdk.component.utils.l.a(r6, r4)     // Catch: java.lang.Throwable -> L19
            goto L5b
        L4c:
            java.lang.String r6 = "ttmn"
        ...
        L5b:
            ...
            com.bytedance.sdk.component.utils.l.a(r4, r5)     // Catch: java.lang.Throwable -> L19
            java.lang.String r4 = "avmdlp2p"
            com.bytedance.sdk.openadsdk.pw.je.h(r4)     // Catch: java.lang.Throwable -> L6a java.lang.UnsatisfiedLinkError -> L6c
            goto L8d
        L6a:
            r4 = move-exception
            goto L6e
        ...
        L6e:
            ...
            java.lang.String r4 = java.lang.String.valueOf(r4)     // Catch: java.lang.Throwable -> L19
            java.lang.String r4 = r6.concat(r4)     // Catch: java.lang.Throwable -> L19
            com.bytedance.sdk.component.utils.l.a(r5, r4)     // Catch: java.lang.Throwable -> L19
            goto L8d
        L7e:
            java.lang.String r5 = "ttmn"
            ...
            com.bytedance.sdk.component.utils.l.a(r5, r4)     // Catch: java.lang.Throwable -> L19
        L8d:
            tryLoadTTNetLoaderPlugin()     // Catch: java.lang.Throwable -> L19
        L90:
            boolean r4 = com.bykv.vk.component.ttvideo.mediakit.medialoader.AVMDLDataLoader.mIsLibraryLoaded     // Catch: java.lang.Throwable -> L19
            if (r4 != 0) goto L97
            monitor-exit(r0)
            r4 = -1
            return r4
