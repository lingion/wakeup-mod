...
public final class MinguoChronology extends OooO implements Serializable {
    ...
    static /* synthetic */ class OooO00o {
        ...
        static final /* synthetic */ int[] f20489OooO00o;
        ...
        static {
            ...
            try {
                f20489OooO00o[ChronoField.YEAR_OF_ERA.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f20489OooO00o[ChronoField.YEAR.ordinal()] = 3;
    ...
    public int prolepticYear(OooOO0 oooOO02, int i) {
        if (oooOO02 instanceof MinguoEra) {
            return oooOO02 == MinguoEra.ROC ? i : 1 - i;
        }
    ...
    public ValueRange range(ChronoField chronoField) {
        int i = OooO00o.f20489OooO00o[chronoField.ordinal()];
        if (i == 1) {
    ...
    public /* bridge */ /* synthetic */ org.threeten.bp.chrono.OooO00o m591resolveDate(Map map, ResolverStyle resolverStyle) {
    ...
    public MinguoDate resolveDate(Map<org.threeten.bp.temporal.OooOO0, Long> map, ResolverStyle resolverStyle) {
        ...
        if (map.containsKey(chronoField7)) {
            ...
            if (map.containsKey(chronoField9)) {
                ...
                if (map.containsKey(chronoField10)) {
                    ...
                    MinguoDate minguoDatePlus = date(iCheckValidIntValue4, iCheckValidIntValue5, 1).plus(((chronoField9.checkValidIntValue(map.remove(chronoField9).longValue()) - 1) * 7) + (chronoField10.checkValidIntValue(map.remove(chronoField10).longValue()) - 1), (org.threeten.bp.temporal.OooOOO) ChronoUnit.DAYS);
                ...
                if (map.containsKey(chronoField11)) {
                    ...
                    MinguoDate minguoDateWith = date(iCheckValidIntValue6, iCheckValidIntValue7, 1).plus(chronoField9.checkValidIntValue(map.remove(chronoField9).longValue()) - 1, (org.threeten.bp.temporal.OooOOO) ChronoUnit.WEEKS).with(org.threeten.bp.temporal.OooO0o.OooO00o(DayOfWeek.of(chronoField11.checkValidIntValue(map.remove(chronoField11).longValue()))));
        ...
        if (map.containsKey(chronoField14)) {
            ...
            MinguoDate minguoDatePlusDays = date(iCheckValidIntValue9, 1, 1).plusDays(((chronoField13.checkValidIntValue(map.remove(chronoField13).longValue()) - 1) * 7) + (chronoField14.checkValidIntValue(map.remove(chronoField14).longValue()) - 1));
    ...
    @Override // org.threeten.bp.chrono.OooO
    public MinguoDate dateYearDay(OooOO0 oooOO02, int i, int i2) {
        return (MinguoDate) super.dateYearDay(oooOO02, i, i2);
    }

    @Override // org.threeten.bp.chrono.OooO
    public MinguoDate date(OooOO0 oooOO02, int i, int i2, int i3) {
        return (MinguoDate) super.date(oooOO02, i, i2, i3);
    }
    ...
    @Override // org.threeten.bp.chrono.OooO
    public MinguoDate date(org.threeten.bp.temporal.OooO0O0 oooO0O0) {
        if (oooO0O0 instanceof MinguoDate) {
            return (MinguoDate) oooO0O0;
        }
        return new MinguoDate(LocalDate.from(oooO0O0));
    }
