...
public class u {
    ...
    public static void h(InputStream inputStream, OutputStream outputStream) throws IOException {
        h(inputStream, outputStream, 4096);
    }

    private static void h(InputStream inputStream, OutputStream outputStream, int i) throws IOException {
        ...
        h(readableByteChannelNewChannel, writableByteChannelNewChannel, i);
    ...
    public static boolean h(String str, File file, StringBuilder sb) throws IOException {
        try {
    ...
    private static void h(ReadableByteChannel readableByteChannel, WritableByteChannel writableByteChannel, int i) throws IOException {
