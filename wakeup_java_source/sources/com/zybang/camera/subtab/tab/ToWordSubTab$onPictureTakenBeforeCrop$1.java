...
@OooO0o(c = "com.zybang.camera.subtab.tab.ToWordSubTab$onPictureTakenBeforeCrop$1", f = "ToWordSubTab.kt", l = {85}, m = "invokeSuspend")
/* loaded from: classes5.dex */
final class ToWordSubTab$onPictureTakenBeforeCrop$1 extends SuspendLambda implements Function2<o000OO, OooO<? super o0OOO0o>, Object> {
    final /* synthetic */ o0OO0O0 $callBack;
    final /* synthetic */ Activity $thisActivity;
    final /* synthetic */ o00O0O $transferEntity;
    int label;

    @OooO0o(c = "com.zybang.camera.subtab.tab.ToWordSubTab$onPictureTakenBeforeCrop$1$1", f = "ToWordSubTab.kt", l = {}, m = "invokeSuspend")
    /* renamed from: com.zybang.camera.subtab.tab.ToWordSubTab$onPictureTakenBeforeCrop$1$1, reason: invalid class name */
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    ToWordSubTab$onPictureTakenBeforeCrop$1(o00O0O o00o0o2, o0OO0O0 o0oo0o0, Activity activity, OooO<? super ToWordSubTab$onPictureTakenBeforeCrop$1> oooO) {
        super(2, oooO);
        this.$transferEntity = o00o0o2;
        this.$callBack = o0oo0o0;
        this.$thisActivity = activity;
    ...
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final OooO<o0OOO0o> create(Object obj, OooO<?> oooO) {
        return new ToWordSubTab$onPictureTakenBeforeCrop$1(this.$transferEntity, this.$callBack, this.$thisActivity, oooO);
    }
    ...
    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(o000OO o000oo2, OooO<? super o0OOO0o> oooO) {
        return ((ToWordSubTab$onPictureTakenBeforeCrop$1) create(o000oo2, oooO)).invokeSuspend(o0OOO0o.f13233OooO00o);
    }
}
