...
public abstract class AbstractResolvableFuture<V> implements ListenableFuture<V> {
    ...
    private static final class SafeAtomicHelper extends AtomicHelper {
        ...
        boolean casListeners(AbstractResolvableFuture<?> abstractResolvableFuture, Listener listener, Listener listener2) {
            return OooO00o.OooO00o(this.listenersUpdater, abstractResolvableFuture, listener, listener2);
        }

        @Override // androidx.concurrent.futures.AbstractResolvableFuture.AtomicHelper
        boolean casValue(AbstractResolvableFuture<?> abstractResolvableFuture, Object obj, Object obj2) {
            return OooO00o.OooO00o(this.valueUpdater, abstractResolvableFuture, obj, obj2);
        }

        @Override // androidx.concurrent.futures.AbstractResolvableFuture.AtomicHelper
        boolean casWaiters(AbstractResolvableFuture<?> abstractResolvableFuture, Waiter waiter, Waiter waiter2) {
            return OooO00o.OooO00o(this.waitersUpdater, abstractResolvableFuture, waiter, waiter2);
        }
    ...
    static {
        ...
        try {
            synchronizedHelper = new SafeAtomicHelper(AtomicReferenceFieldUpdater.newUpdater(Waiter.class, Thread.class, "thread"), AtomicReferenceFieldUpdater.newUpdater(Waiter.class, Waiter.class, LinkHeader.Rel.Next), AtomicReferenceFieldUpdater.newUpdater(AbstractResolvableFuture.class, Waiter.class, "waiters"), AtomicReferenceFieldUpdater.newUpdater(AbstractResolvableFuture.class, Listener.class, "listeners"), AtomicReferenceFieldUpdater.newUpdater(AbstractResolvableFuture.class, Object.class, "value"));
            th = null;
        } catch (Throwable th) {
            th = th;
    ...
    public final V get(long j, TimeUnit timeUnit) throws InterruptedException, TimeoutException {
        ...
        String str = "Waited " + j + ServerSentEventKt.SPACE + timeUnit.toString().toLowerCase(locale);
        if (nanos + SPIN_THRESHOLD_NANOS < 0) {
            ...
            if (jConvert > 0) {
                String str3 = str2 + jConvert + ServerSentEventKt.SPACE + lowerCase;
                if (z) {
                    str3 = str3 + ",";
                }
