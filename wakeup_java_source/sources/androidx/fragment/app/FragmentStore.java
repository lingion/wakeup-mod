...
class FragmentStore {
    ...
    @Nullable
    Fragment findFragmentById(@IdRes int i) {
    ...
    @Nullable
    Bundle getSavedState(@NonNull String str) {
        ...
        if (list != null) {
            for (String str : list) {
                ...
                if (FragmentManager.isLoggingEnabled(2)) {
                    ...
                    sb.append(str);
                    sb.append("): ");
                    sb.append(fragmentFindActiveFragment);
                }
    ...
    void restoreSaveState(@NonNull HashMap<String, Bundle> map) {
    ...
    @Nullable
    Bundle setSavedState(@NonNull String str, @Nullable Bundle bundle) {
