...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    static class Api33Impl {
        ...
        static OnBackInvokedCallback registerOnBackPressedCallback(Object obj, final AppCompatDelegateImpl appCompatDelegateImpl) {
            ...
            OnBackInvokedCallback onBackInvokedCallback = new OnBackInvokedCallback() { // from class: androidx.appcompat.app.o00O0O
                @Override // android.window.OnBackInvokedCallback
                public final void onBackInvoked() {
                    appCompatDelegateImpl.onBackPressed();
                }
            };
            Oooo000.OooO00o(obj).registerOnBackInvokedCallback(1000000, onBackInvokedCallback);
            return onBackInvokedCallback;
        }

        @DoNotInline
        static void unregisterOnBackInvokedCallback(Object obj, Object obj2) {
            Oooo000.OooO00o(obj).unregisterOnBackInvokedCallback(OooOo.OooO00o(obj2));
        }
    }
    ...
    private static Configuration generateConfigDelta(@NonNull Configuration configuration, @Nullable Configuration configuration2) {
        ...
        if (configuration2 != null && configuration.diff(configuration2) != 0) {
            ...
            int i20 = configuration.screenLayout & MediaPlayer.MEDIA_PLAYER_OPTION_SET_KSY_FRAME_WAIT;
            int i21 = configuration2.screenLayout;
            if (i20 != (i21 & MediaPlayer.MEDIA_PLAYER_OPTION_SET_KSY_FRAME_WAIT)) {
                configuration3.screenLayout |= i21 & MediaPlayer.MEDIA_PLAYER_OPTION_SET_KSY_FRAME_WAIT;
            }
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private boolean updateAppConfiguration(int r10, @androidx.annotation.Nullable androidx.core.os.LocaleListCompat r11, boolean r12) throws java.lang.IllegalAccessException, java.lang.NoSuchFieldException, android.content.pm.PackageManager.NameNotFoundException, java.lang.SecurityException, java.lang.IllegalArgumentException {
        /*
            r9 = this;
    ...
    private void updateResourcesConfiguration(int i, @Nullable LocaleListCompat localeListCompat, boolean z, @Nullable Configuration configuration) throws IllegalAccessException, NoSuchFieldException, SecurityException, IllegalArgumentException {
    ...
    LocaleListCompat calculateApplicationLocales(@NonNull Context context) {
        ...
        LocaleListCompat localeListCompatCombineLocalesIfOverlayExists = i >= 24 ? LocaleOverlayHelper.combineLocalesIfOverlayExists(requestedAppLocales, configurationLocales) : requestedAppLocales.isEmpty() ? LocaleListCompat.getEmptyLocaleList() : LocaleListCompat.forLanguageTags(Api21Impl.toLanguageTag(requestedAppLocales.get(0)));
    ...
    */
    ...
    ActionMode startSupportActionModeFromWindow(@NonNull ActionMode.Callback callback) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
    ...
    final int updateStatusGuard(@Nullable WindowInsetsCompat windowInsetsCompat, @Nullable Rect rect) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        boolean z;
        boolean z2;
