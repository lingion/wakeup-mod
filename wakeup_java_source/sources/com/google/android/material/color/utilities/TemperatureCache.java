...
public final class TemperatureCache {
    ...
    private List<Hct> getHctsByHue() {
        ...
        for (double d = IDataEditor.DEFAULT_NUMBER_VALUE; d <= 360.0d; d += 1.0d) {
    ...
    private List<Hct> getHctsByTemp() {
        ...
        Collections.sort(arrayList, Comparator.comparing(new Function() { // from class: com.google.android.material.color.utilities.oO0OOo0o
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                return this.f4988OooO0o0.lambda$getHctsByTemp$0((Hct) obj);
            }
        }, new Comparator() { // from class: com.google.android.material.color.utilities.oO000Oo0
    ...
    public double getRelativeTemperature(Hct hct) {
        ...
        if (dDoubleValue == IDataEditor.DEFAULT_NUMBER_VALUE) {
            return 0.5d;
        }
    ...
    public List<Hct> getAnalogousColors(int i, int i2) {
        ...
        ArrayList arrayList = new ArrayList();
        arrayList.add(hct);
        double dAbs = IDataEditor.DEFAULT_NUMBER_VALUE;
        double dAbs2 = 0.0d;
        int i3 = 0;
        while (i3 < 360) {
