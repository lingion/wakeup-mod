...
public final class SparseLongArrayKt {
    ...
    public static final void forEach(SparseLongArray sparseLongArray, Function2<? super Integer, ? super Long, o0OOO0o> function2) {
    ...
    public static final o0000 keyIterator(final SparseLongArray sparseLongArray) {
        return new o0000() { // from class: androidx.core.util.SparseLongArrayKt.keyIterator.1
            private int index;
    ...
    public static final o0000O00 valueIterator(final SparseLongArray sparseLongArray) {
        return new o0000O00() { // from class: androidx.core.util.SparseLongArrayKt.valueIterator.1
            private int index;
