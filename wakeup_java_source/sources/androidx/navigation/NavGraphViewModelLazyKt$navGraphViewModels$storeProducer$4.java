...
public final class NavGraphViewModelLazyKt$navGraphViewModels$storeProducer$4 implements Function0<ViewModelStore> {
    ...
    public NavGraphViewModelLazyKt$navGraphViewModels$storeProducer$4(kotlin.OooOOO0 oooOOO0) {
    ...
    public final ViewModelStore invoke() {
        return NavGraphViewModelLazyKt.m47navGraphViewModels$lambda3(this.$backStackEntry$delegate).getViewModelStore();
    }
}
