...
public class ImageLoadImpl implements IImageLoader {
    ...
    public void checkInit() {
        ...
        builder.taskExecutor(GlobalThreadPools.Le());
        builder.taskExecutorForCachedImages(GlobalThreadPools.Lf());
        builder.setTaskDistributor(GlobalThreadPools.Lg());
        builder.denyCacheImageMultipleSizesInMemory();
        builder.diskCacheFileNameGenerator(new Md5FileNameGenerator());
        builder.diskCacheSize(20971520);
        builder.tasksProcessingOrder(QueueProcessingType.LIFO);
        builder.cacheParentDir(be.dP(context).getPath());
        ...
        builder.imageDownloader(new BaseImageDownloader(context) { // from class: com.kwad.sdk.core.imageloader.ImageLoadImpl.1
            ...
            public HttpURLConnection createConnection(String str, Object obj) throws NoSuchAlgorithmException, KeyManagementException {
