...
class RequestExecutor {
    ...
    static ThreadPoolExecutor createDefaultExecutor(String str, int i, @IntRange(from = 0) int i2) {
    ...
    static <T> T submit(ExecutorService executorService, Callable<T> callable, @IntRange(from = 0) int i) throws InterruptedException {
        try {
