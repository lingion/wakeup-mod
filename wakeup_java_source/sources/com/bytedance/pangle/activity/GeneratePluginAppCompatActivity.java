...
public abstract class GeneratePluginAppCompatActivity extends AppCompatActivity implements IPluginActivity {
    ...
    public void attachBaseContext(Context context) {
        ...
        com.bytedance.pangle.util.h.h(this, this.mProxyActivity);
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        com.bytedance.pangle.res.bj.h(getLayoutInflater());
    }
    ...
    public void setContentView(int i) {
        ...
        ZeusTransformUtils.clearConstructorCache();
        cg.h(this, findViewById(R.id.content));
    }
    ...
    @Override // com.bytedance.pangle.activity.IPluginActivity
    public void setPluginProxyActivity(bj bjVar, Plugin plugin) {
        this.mProxyActivity = (GenerateProxyAppCompatActivity) bjVar;
        this.mPlugin = plugin;
    }
