...
public final class JsonAdapterAnnotationTypeAdapterFactory implements TypeAdapterFactory {
    ...
    TypeAdapter<?> getTypeAdapter(ConstructorConstructor constructorConstructor, Gson gson, TypeToken<?> typeToken, JsonAdapter jsonAdapter, boolean z) {
        ...
        if (objCreateAdapter instanceof TypeAdapter) {
            ...
            treeTypeAdapter = new TreeTypeAdapter<>(z2 ? (JsonSerializer) objCreateAdapter : null, objCreateAdapter instanceof JsonDeserializer ? (JsonDeserializer) objCreateAdapter : null, gson, typeToken, z ? TREE_TYPE_CLASS_DUMMY_FACTORY : TREE_TYPE_FIELD_DUMMY_FACTORY, zNullSafe);
            zNullSafe = false;
        }
