...
class ClockHandView extends View {
    ...
    public interface OnActionUpListener {
        void onActionUp(@FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = 360.0d) float f, boolean z);
    }

    public interface OnRotateListener {
        void onRotate(@FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = 360.0d) float f, boolean z);
    }
    ...
    private int getDegreesFromXY(float f, float f2) {
        ...
        int i = degrees + 90;
        return i < 0 ? degrees + MediaPlayer.MEDIA_PLAYER_OPTION_CMAF_MPD_SOCKET_CONNECT_TIME : i;
    }
    ...
    private void setHandRotationInternal(@FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = 360.0d) float f, boolean z) {
        float f2 = f % 360.0f;
        this.originalDeg = f2;
    ...
    public void setHandRotation(@FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = 360.0d) float f) {
    ...
    public void setHandRotation(@FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = 360.0d) float f, boolean z) {
        ...
        this.rotationAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.timepicker.OooO0O0
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                this.f5072OooO0o0.lambda$setHandRotation$0(valueAnimator2);
            }
        });
