...
public abstract class OfflineCompoRequest implements IOfflineCompoRequest {
    ...
    public void putBody(String str, double d) throws JSONException {
        JsonHelper.putValue(this.mBodyParams, str, d);
    }

    public void putBody(String str, int i) throws JSONException {
        JsonHelper.putValue(this.mBodyParams, str, i);
    }

    public void putBody(String str, float f) throws JSONException {
        JsonHelper.putValue(this.mBodyParams, str, f);
    }

    public void putBody(String str, byte b) throws JSONException {
        JsonHelper.putValue(this.mBodyParams, str, b);
    }

    public void putBody(String str, long j) throws JSONException {
        JsonHelper.putValue(this.mBodyParams, str, j);
    }

    public void putBody(String str, boolean z) throws JSONException {
        JsonHelper.putValue(this.mBodyParams, str, z);
    }

    public void putBody(String str, JSONObject jSONObject) throws JSONException {
        JsonHelper.putValue(this.mBodyParams, str, jSONObject);
    }

    public void putBody(String str, JSONArray jSONArray) throws JSONException {
        JsonHelper.putValue(this.mBodyParams, str, jSONArray);
    }

    public void putBody(String str, IOfflineCompoJsonParse iOfflineCompoJsonParse) throws JSONException {
        JsonHelper.putValue(this.mBodyParams, str, iOfflineCompoJsonParse);
    }

    public void putBody(String str, List<? extends IOfflineCompoJsonParse> list) throws JSONException {
