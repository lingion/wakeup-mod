...
public final class OooO0OO extends Parser {
    ...
    private static final void OooOO0(Ref$IntRef ref$IntRef, List list, ArrayList arrayList, Ref$IntRef ref$IntRef2) throws NumberFormatException {
        int i;
        int i2;
        ...
        String string = oo000o.o000O0Oo(OooOo.OooO0Oo(oooOo, (String) list.get(0), null, 2, null).o0000o()).toString();
        ...
        List listO0000O0O = oo000o.o0000O0O(oo000o.o000O0Oo(OooOo.OooO0Oo(oooOo, (String) list.get(ref$IntRef.element), null, 2, null).o0000o()).toString(), new String[]{"周["}, false, 0, 6, null);
        for (String str : oo000o.o0000O0((CharSequence) listO0000O0O.get(0), new char[]{','}, false, 0, 6, null)) {
            int i3 = oo000o.OooooO0(str, '-', false, 2, null) ? Integer.parseInt((String) oo000o.o0000O0(str, new char[]{'-'}, false, 0, 6, null).get(0)) : Integer.parseInt(str);
            if (oo000o.OooooO0(str, '-', false, 2, null)) {
                str = (String) oo000o.o0000O0(str, new char[]{'-'}, false, 0, 6, null).get(1);
            }
            int i4 = Integer.parseInt(str);
            if (oo000o.OooooO0((CharSequence) listO0000O0O.get(1), '-', false, 2, null)) {
                i = Integer.parseInt((String) oo000o.o0000O0((CharSequence) listO0000O0O.get(1), new char[]{'-'}, false, 0, 6, null).get(0));
                i2 = Integer.parseInt(oo000o.o000O0o((String) oo000o.o0000O0((CharSequence) listO0000O0O.get(1), new char[]{'-'}, false, 0, 6, null).get(1), (char) 33410, null, 2, null));
            } else {
                String strSubstring = ((String) listO0000O0O.get(1)).substring(0, 2);
                o0OoOo0.OooO0o(strSubstring, "substring(...)");
                i = Integer.parseInt(strSubstring);
                String strSubstring2 = ((String) listO0000O0O.get(1)).substring(2, 4);
                o0OoOo0.OooO0o(strSubstring2, "substring(...)");
                i2 = Integer.parseInt(strSubstring2);
            }
            arrayList.add(new Course(string, ref$IntRef2.element, string2, string3, i, i2, i3, i4, 0, 0.0f, (String) null, (String) null, (String) null, 7680, (OooOOO) null));
        }
    }

    @Override // com.suda.yzune.wakeupschedule.schedule_parser.parser.base.OooOO0O
    public Object OooO0o0(OooO oooO) throws NumberFormatException {
                        ...
                        while (it4.hasNext()) {
                            ...
                            if (!oo000o.o00oO0O(oooOO0O2.o0000o()) && OooOO0.f9245OooO00o.OooOo0().containsMatchIn(oooOO0O2.o0000o())) {
                                ...
                                for (int i = 0; i < size; i++) {
                                    if (oo000o.OooooO0((CharSequence) listO0000O0O.get(i), '[', false, 2, null) && oo000o.OooooO0((CharSequence) listO0000O0O.get(i), ']', false, 2, null) && oo000o.OooooO0((CharSequence) listO0000O0O.get(i), (char) 33410, false, 2, null) && oo000o.OooooO0((CharSequence) listO0000O0O.get(i), (char) 21608, false, 2, null)) {
                                        if (ref$IntRef2.element != -1) {
                                            OooOO0(ref$IntRef2, listO0000O0O, arrayList, ref$IntRef);
                                        }
