...
public final class LocationCompat {
    ...
    static int getHasBearingAccuracyMask() throws NoSuchFieldException, SecurityException {
    ...
    @SuppressLint({"SoonBlockedPrivateApi"})
    static int getHasSpeedAccuracyMask() throws NoSuchFieldException, SecurityException {
    ...
    @SuppressLint({"SoonBlockedPrivateApi"})
    static int getHasVerticalAccuracyMask() throws NoSuchFieldException, SecurityException {
    ...
    public static void setMslAltitudeAccuracyMeters(Location location, @FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE) float f) {
        if (Build.VERSION.SDK_INT >= 34) {
