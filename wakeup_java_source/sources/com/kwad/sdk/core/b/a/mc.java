...
public final class mc implements com.kwad.sdk.core.d<com.kwad.components.core.webview.tachikoma.c.w> {
    ...
    private static void a(com.kwad.components.core.webview.tachikoma.c.w wVar, JSONObject jSONObject) {
        ...
        wVar.alh = jSONObject.optInt("rewardTaskState");
    }
    ...
    private static JSONObject b(com.kwad.components.core.webview.tachikoma.c.w wVar, JSONObject jSONObject) {
        ...
        int i = wVar.alh;
        if (i != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "rewardTaskState", i);
        }
        return jSONObject;
    }
}
