...
public final class NavGraphViewModelLazyKt$navGraphViewModels$storeProducer$2 implements Function0<ViewModelStore> {
    ...
    public NavGraphViewModelLazyKt$navGraphViewModels$storeProducer$2(kotlin.OooOOO0 oooOOO0) {
    ...
    public final ViewModelStore invoke() {
        return NavGraphViewModelLazyKt.m45navGraphViewModels$lambda1(this.$backStackEntry$delegate).getViewModelStore();
    }
}
