...
@OooO0o(c = "androidx.collection.MutableScatterMap$MutableMapWrapper$keys$1$iterator$1$iterator$1", f = "ScatterMap.kt", l = {1431}, m = "invokeSuspend")
/* loaded from: classes.dex */
final class MutableScatterMap$MutableMapWrapper$keys$1$iterator$1$iterator$1 extends RestrictedSuspendLambda implements Function2<OooOo00, OooO<? super o0OOO0o>, Object> {
    int I$0;
    int I$1;
    int I$2;
    int I$3;
    ...
    MutableScatterMap$MutableMapWrapper$keys$1$iterator$1$iterator$1(MutableScatterMap<K, V> mutableScatterMap, OooO<? super MutableScatterMap$MutableMapWrapper$keys$1$iterator$1$iterator$1> oooO) {
        super(2, oooO);
    ...
    public final OooO<o0OOO0o> create(Object obj, OooO<?> oooO) {
        MutableScatterMap$MutableMapWrapper$keys$1$iterator$1$iterator$1 mutableScatterMap$MutableMapWrapper$keys$1$iterator$1$iterator$1 = new MutableScatterMap$MutableMapWrapper$keys$1$iterator$1$iterator$1(this.this$0, oooO);
    ...
    */
    ...
    public final Object invoke(OooOo00 oooOo00, OooO<? super o0OOO0o> oooO) {
        return ((MutableScatterMap$MutableMapWrapper$keys$1$iterator$1$iterator$1) create(oooOo00, oooO)).invokeSuspend(o0OOO0o.f13233OooO00o);
    }
}
