...
public class MaterialAutoCompleteTextView extends AppCompatAutoCompleteTextView {
    ...
    private class MaterialArrayAdapter<T> extends ArrayAdapter<String> {
        ...
        MaterialArrayAdapter(@NonNull Context context, int i, @NonNull String[] strArr) {
    ...
    public MaterialAutoCompleteTextView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, com.google.android.material.R.styleable.MaterialAutoCompleteTextView, i, com.google.android.material.R.style.Widget_AppCompat_AutoCompleteTextView, new int[0]);
