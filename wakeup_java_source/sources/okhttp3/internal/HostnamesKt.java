...
public final class HostnamesKt {
    private static final boolean containsInvalidHostnameAsciiCodes(String str) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (o0OoOo0.OooO(cCharAt, 31) <= 0 || o0OoOo0.OooO(cCharAt, 127) >= 0 || oo000o.o00o0O(" #%/:?@[\\]", cCharAt, 0, false, 6, null) != -1) {
                return true;
            }
        }
        return false;
    ...
    private static final boolean decodeIpv4Suffix(String str, int i, int i2, byte[] bArr, int i3) {
        ...
        while (i < i2) {
            ...
            while (i5 < i2) {
                ...
                if (o0OoOo0.OooO(cCharAt, 48) < 0 || o0OoOo0.OooO(cCharAt, 57) > 0) {
                    break;
                }
    ...
    */
    private static final java.net.InetAddress decodeIpv6(java.lang.String r18, int r19, int r20) {
        ...
        L15:
            ...
            r10 = r5
            r5 = r17
            boolean r0 = kotlin.text.oo000o.OoooOOO(r0, r1, r2, r3, r4, r5)
            if (r0 == 0) goto L38
            if (r14 == r11) goto L2e
            return r16
        L2e:
    ...
    public static final String toCanonicalHost(String str) {
        ...
        if (!oo000o.OooooOO(str, ServerSentEventKt.COLON, false, 2, null)) {
            try {
                String ascii = IDN.toASCII(str);
                o0OoOo0.OooO0o(ascii, "toASCII(host)");
                Locale US = Locale.US;
        ...
        InetAddress inetAddressDecodeIpv6 = (oo000o.OoooOOo(str, "[", false, 2, null) && oo000o.Oooo0O0(str, "]", false, 2, null)) ? decodeIpv6(str, 1, str.length() - 1) : decodeIpv6(str, 0, str.length());
        if (inetAddressDecodeIpv6 == null) {
            return null;
        }
        byte[] address = inetAddressDecodeIpv6.getAddress();
        if (address.length == 16) {
            o0OoOo0.OooO0o(address, "address");
