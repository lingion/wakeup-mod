...
final class l implements IOfflineCompoLogcat {
    l() {
    }
    ...
    public final boolean isLoggable() {
        return com.kwad.sdk.core.d.c.aIL;
    }
    ...
    public final void v(String str, String str2, boolean z) {
        if (z) {
            com.kwad.sdk.core.d.c.U(str, str2);
        } else {
            com.kwad.sdk.core.d.c.v(str, str2);
        }
    }
    ...
    public final void w(String str, String str2, boolean z) {
        if (z || com.kwad.components.core.a.oy.booleanValue()) {
            com.kwad.sdk.core.d.c.w(str, str2);
        }
    }
}
