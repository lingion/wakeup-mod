...
public class cg extends com.bytedance.sdk.component.h.ta<JSONObject, JSONObject> {
    ...
    public cg(SSWebView sSWebView, String str) {
        this.h = sSWebView;
        this.bj = str;
    }
    ...
    public JSONObject cg() {
        ...
        try {
            if (com.bytedance.sdk.openadsdk.core.u.vq().h(com.bytedance.sdk.openadsdk.core.uj.getContext()) && this.h != null) {
                ...
                this.h.h(1, com.bytedance.sdk.openadsdk.core.u.vq().ta());
                return jSONObject;
            }
    ...
    public static void h(com.bytedance.sdk.component.h.r rVar, SSWebView sSWebView, String str) {
        rVar.h("start_wobble_observer", (com.bytedance.sdk.component.h.ta<?, ?>) new cg(sSWebView, str));
    }
