...
@OooO0o(c = "com.fastad.csj.CsjHalfRewardVideoAdapter$getBiddingToken$1$success$1", f = "CsjHalfRewardVideoAdapter.kt", l = {103, 103, 103}, m = "invokeSuspend")
/* loaded from: classes3.dex */
final class CsjHalfRewardVideoAdapter$getBiddingToken$1$success$1 extends SuspendLambda implements Function2<o000OO, OooO<? super o0OOO0o>, Object> {
    final /* synthetic */ o00Ooo $callback;
    final /* synthetic */ CodePos $codePos;
    final /* synthetic */ Ref$ObjectRef<String> $token;
    Object L$0;
    int label;
    final /* synthetic */ CsjHalfRewardVideoAdapter this$0;

    @OooO0o(c = "com.fastad.csj.CsjHalfRewardVideoAdapter$getBiddingToken$1$success$1$1", f = "CsjHalfRewardVideoAdapter.kt", l = {}, m = "invokeSuspend")
    /* renamed from: com.fastad.csj.CsjHalfRewardVideoAdapter$getBiddingToken$1$success$1$1, reason: invalid class name */
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    CsjHalfRewardVideoAdapter$getBiddingToken$1$success$1(Ref$ObjectRef<String> ref$ObjectRef, CsjHalfRewardVideoAdapter csjHalfRewardVideoAdapter, CodePos codePos, o00Ooo o00ooo2, OooO<? super CsjHalfRewardVideoAdapter$getBiddingToken$1$success$1> oooO) {
        super(2, oooO);
        this.$token = ref$ObjectRef;
        this.this$0 = csjHalfRewardVideoAdapter;
    ...
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final OooO<o0OOO0o> create(Object obj, OooO<?> oooO) {
        return new CsjHalfRewardVideoAdapter$getBiddingToken$1$success$1(this.$token, this.this$0, this.$codePos, this.$callback, oooO);
    }
    ...
    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(o000OO o000oo2, OooO<? super o0OOO0o> oooO) {
        return ((CsjHalfRewardVideoAdapter$getBiddingToken$1$success$1) create(o000oo2, oooO)).invokeSuspend(o0OOO0o.f13233OooO00o);
    }
}
