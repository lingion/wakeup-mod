...
public class ActivityCompat extends ContextCompat {
    ...
    static class SharedElementCallback21Impl extends android.app.SharedElementCallback {
        ...
        public void onSharedElementsArrived(List<String> list, List<View> list2, final SharedElementCallback.OnSharedElementsReadyListener onSharedElementsReadyListener) {
            this.mCallback.onSharedElementsArrived(list, list2, new SharedElementCallback.OnSharedElementsReadyListener() { // from class: androidx.core.app.OooO0O0
    ...
    public static void recreate(final Activity activity) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            new Handler(activity.getMainLooper()).post(new Runnable() { // from class: androidx.core.app.OooO00o
    ...
    public static void requestPermissions(final Activity activity, String[] strArr, @IntRange(from = 0) final int i) {
