...
abstract class DrawableWithAnimatedVisibilityChange extends Drawable implements Animatable2Compat {
    ...
    void setGrowFraction(@FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = Contrast.RATIO_MIN) float f) {
    ...
    @VisibleForTesting
    void setMockHideAnimationRunning(boolean z, @FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = Contrast.RATIO_MIN) float f) {
        this.mockHideAnimationRunning = z;
        this.mockGrowFraction = f;
    }

    @VisibleForTesting
    void setMockShowAnimationRunning(boolean z, @FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = Contrast.RATIO_MIN) float f) {
