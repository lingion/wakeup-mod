...
public final class ExchangeFinder {
    ...
    */
    ...
    public final ExchangeCodec find(OkHttpClient client, RealInterceptorChain chain) {
        ...
        try {
            return findHealthyConnection(chain.getConnectTimeoutMillis$okhttp(), chain.getReadTimeoutMillis$okhttp(), chain.getWriteTimeoutMillis$okhttp(), client.pingIntervalMillis(), client.retryOnConnectionFailure(), !o0OoOo0.OooO0O0(chain.getRequest$okhttp().method(), "GET")).newCodec$okhttp(client, chain);
        } catch (IOException e) {
            trackFailure(e);
    ...
    public final boolean sameHostAndPort(HttpUrl url) {
        ...
        return url.port() == httpUrlUrl.port() && o0OoOo0.OooO0O0(url.host(), httpUrlUrl.host());
    }
