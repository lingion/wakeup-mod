...
public class bn {
    ...
    public String c(String str, String str2) {
        ...
        if (Engine.loadSuccess) {
            bArrA = Engine.getInstance(this.a).ac(Engine.getInstance(this.a).ar(bArrA2, str2.getBytes()), str2.substring(0, 16).getBytes());
        } else {
            try {
    ...
    public String b(String str, String str2) {
        ...
        try {
            ...
            if (Engine.loadSuccess) {
                bArrA = Engine.getInstance(this.a).dr(Engine.getInstance(this.a).dc(bArrA2, str2.substring(0, 16).getBytes()), str2.getBytes());
            } else {
