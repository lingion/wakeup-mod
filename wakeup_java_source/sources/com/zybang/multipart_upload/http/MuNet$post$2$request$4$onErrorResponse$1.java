...
@kotlin.coroutines.jvm.internal.OooO0o(c = "com.zybang.multipart_upload.http.MuNet$post$2$request$4$onErrorResponse$1", f = "MuNet.kt", l = {79}, m = "invokeSuspend")
/* loaded from: classes5.dex */
final class MuNet$post$2$request$4$onErrorResponse$1 extends SuspendLambda implements Function2<o000OO, kotlin.coroutines.OooO<? super o0OOO0o>, Object> {
    ...
    MuNet$post$2$request$4$onErrorResponse$1(OooO0OO oooO0OO, InputBase inputBase, NetError netError, Oooo000 oooo000, String str, o000OO o000oo2, kotlin.coroutines.OooO oooO) {
        super(2, oooO);
    ...
    public final kotlin.coroutines.OooO<o0OOO0o> create(Object obj, kotlin.coroutines.OooO<?> oooO) {
        return new MuNet$post$2$request$4$onErrorResponse$1(this.$retryStrategy, this.$originInput, this.$e, this.$continuation, this.$tag, this.$scope, oooO);
    }
    ...
    public final Object invoke(o000OO o000oo2, kotlin.coroutines.OooO<? super o0OOO0o> oooO) {
        return ((MuNet$post$2$request$4$onErrorResponse$1) create(o000oo2, oooO)).invokeSuspend(o0OOO0o.f13233OooO00o);
    }
}
