...
final class AndroidSQLiteDriverPooledConnection implements Transactor, RawConnectionAccessor {
    ...
    private final class AndroidSQLiteDriverTransactor<T> implements TransactionScope<T>, RawConnectionAccessor {
        ...
        public <R> Object usePrepared(String str, Function1<? super SQLiteStatement, ? extends R> function1, OooO<? super R> oooO) {
            return AndroidSQLiteDriverPooledConnection.this.usePrepared(str, function1, oooO);
        }
        ...
        public <R> Object withNestedTransaction(Function2<? super TransactionScope<R>, ? super OooO<? super R>, ? extends Object> function2, OooO<? super R> oooO) {
            ...
            if (sQLiteTransactionType != null) {
                return androidSQLiteDriverPooledConnection.transaction(sQLiteTransactionType, function2, oooO);
            }
    ...
    @kotlin.coroutines.jvm.internal.OooO0o(c = "androidx.room.coroutines.AndroidSQLiteDriverPooledConnection", f = "AndroidSQLiteDriverConnectionPool.android.kt", l = {87}, m = "transaction")
    ...
    */
    public final <R> java.lang.Object transaction(androidx.room.Transactor.SQLiteTransactionType r7, kotlin.jvm.functions.Function2<? super androidx.room.TransactionScope<R>, ? super kotlin.coroutines.OooO<? super R>, ? extends java.lang.Object> r8, kotlin.coroutines.OooO<? super R> r9) throws java.lang.Throwable {
        /*
            r6 = this;
            boolean r0 = r9 instanceof androidx.room.coroutines.AndroidSQLiteDriverPooledConnection.AnonymousClass1
            if (r0 == 0) goto L13
            r0 = r9
        ...
        L40:
            ...
            androidx.sqlite.driver.AndroidSQLiteConnection r9 = r6.delegate
        ...
        L6f:
            r9.beginTransactionNonExclusive()
        L72:
            androidx.room.coroutines.AndroidSQLiteDriverPooledConnection$AndroidSQLiteDriverTransactor r7 = new androidx.room.coroutines.AndroidSQLiteDriverPooledConnection$AndroidSQLiteDriverTransactor     // Catch: java.lang.Throwable -> L97 androidx.room.coroutines.ConnectionPool.RollbackException -> L9d
        ...
        Lbd:
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.room.coroutines.AndroidSQLiteDriverPooledConnection.transaction(androidx.room.Transactor$SQLiteTransactionType, kotlin.jvm.functions.Function2, kotlin.coroutines.OooO):java.lang.Object");
    }
    ...
    public Object inTransaction(OooO<? super Boolean> oooO) {
        return kotlin.coroutines.jvm.internal.OooO00o.OooO00o(this.delegate.getDb().inTransaction());
    }
