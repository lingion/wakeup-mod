...
public final class InterstitialTemplateV3 extends BaseInterstitialTemplate {
    private VideoPlayLayout adVideo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public InterstitialTemplateV3(ApiAdModel apiAdModel, AdSlot apiAdSlot) {
        ...
        if (getActivity() != null) {
            ...
            if (!activity.isFinishing()) {
                ...
                if (!activity2.isDestroyed()) {
                    ...
                    setShakeAnim(activity4, imageView2, textView, R.drawable.anim_intertitial_white_shake);
    ...
    public void showAd(Activity activity, InterstitialAdActionListener interstitialAdActionListener) {
        ...
        setParentView(LayoutInflater.from(activity).inflate(R.layout.interstitial_v3_layout, (ViewGroup) null));
        if (getParentView() == null) {
            return;
        }
        View parentView = getParentView();
        ImageView imageView = parentView == null ? null : (ImageView) parentView.findViewById(R.id.id_ad_image);
        View parentView2 = getParentView();
        this.adVideo = parentView2 == null ? null : (VideoPlayLayout) parentView2.findViewById(R.id.id_ad_video);
        View parentView3 = getParentView();
        FrameLayout frameLayout = parentView3 == null ? null : (FrameLayout) parentView3.findViewById(R.id.id_content_layout);
        ...
        if (fileMaterials != null && fileMaterials.fileType == 1) {
        ...
        setFileMaterials(imageView, this.adVideo, "10005");
    }
}
