...
final class CsvWriter$writeAllAsync$4 extends Lambda implements Function1<OooO0o, o0OOO0o> {
    final /* synthetic */ List<List<Object>> $rows;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    CsvWriter$writeAllAsync$4(List<? extends List<? extends Object>> list) {
        super(1);
        this.$rows = list;
    }
