...
public class MediationConstant {
    ...
    public static final String ADN_BYTEUNION = "byteunion";
    ...
    public static final String ADN_XIAOMI = "xiaomi";
    ...
    public static final String BIDDING_IS_OPEN_ECPM = "bidding_is_open_ecpm";
    public static final String BIDDING_LOSE_REASON = "bidding_lose_reason";
    public static final String BIDDING_LOSE_REASON_DEX_ADAPTER = "bidding_lose_reason_dex_adapter";
    public static final String BIDDING_REQUEST_ID_MAP = "bidding_request_id_map";
    public static final String BIDDING_WIN_ADN = "bidding_win_adn";
    public static final String BIDDING_WIN_ADN_ID = "bidding_win_adn_id";
    public static final String BIDDING_WIN_PRICE = "bidding_win_price";
    public static final String BYTEUNION_ADN_CLASS_NAME = "com.bytedance.msdk.adapter.byteunion.ByteunionAdapterConfiguration";
    public static final String CUSTOM_DATA_KEY_GROMORE_EXTRA = "gromoreExtra";
    public static final String EXTRA_ADID = "ad_id";
    public static final String EXTRA_ADN_NAME = "adn_name";
    public static final String EXTRA_CID = "c_id";
    public static final String EXTRA_DURATION = "duration";
    public static final String EXTRA_LOG_EXTRA = "log_extra";
    public static final String EXTRA_SUPPORT_RENDER = "support_render";
    public static final int FULL_WIDTH = -1;
    public static final String GDT_ADN_CLASS_NAME = "com.bytedance.msdk.adapter.gdt.GdtAdapterConfiguration";
    public static final String GM_EXTRA_KEY_CLOSE_SHAKE = "GM_CLOSE_SHAKE";
    public static final String GM_EXTRA_KEY_KS_ENABLE_ROTATE = "ksEnableRotate";
    public static final String GM_EXTRA_KEY_KS_GET_ROTATE_VIEW = "ksRotateView";
    public static final String GM_EXTRA_KEY_PRIME_RIT_LIST = "primeRitList";
    ...
    public static final String KEY_GM_POLICY = "gm_policy";
    public static final String KEY_GM_PRIME_RIT = "prime_rit";
    ...
    public static final String KEY_USE_POLICY_AD_GAP = "adGap";
    public static final String KEY_USE_POLICY_AD_LOAD = "adLoad";
    public static final String KEY_USE_POLICY_OBJ_CUSTOM = "custom";
    public static final String KEY_USE_POLICY_PAGE_ID = "pageId";
    public static final String KEY_USE_POLICY_SECTION_ID = "sectionId";
    ...
    public static final String RIT_TYPE_BANNER = "banner";
    public static final String RIT_TYPE_DRAW = "draw";
    public static final String RIT_TYPE_FEED = "feed";
    public static final String RIT_TYPE_FULL_VIDEO = "fullVideo";
    public static final String RIT_TYPE_INTERSTITIAL = "interstitial";
    public static final String RIT_TYPE_INTERSTITIAL_FULL = "interstitialFull";
    public static final String RIT_TYPE_REWARD_VIDEO = "rewardVideo";
    public static final String RIT_TYPE_SPLASH = "splash";
    ...
    public static final String VIDEO_COVER_IMG_DURATION = "video_img_duration";
    public static final String VIDEO_COVER_IMG_HEIGHT = "video_img_height";
    public static final String VIDEO_COVER_IMG_URL = "video_img_url";
    public static final String VIDEO_COVER_IMG_VALID = "video_img_valid";
    public static final String VIDEO_COVER_IMG_WIDTH = "video_img_width";
    public static final String XIAOMI_ADN_CLASS_NAME = "com.bytedance.msdk.adapter.xiaomi.XiaomiAdapterConfiguration";
    ...
    public static class ErrorCode {
        public static final int ADN_AD_CONTEXT = 80006;
