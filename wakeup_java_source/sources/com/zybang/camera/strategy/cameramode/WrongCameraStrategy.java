...
public final class WrongCameraStrategy extends SearchBaseCameraStrategy {

    @OooO0o(c = "com.zybang.camera.strategy.cameramode.WrongCameraStrategy$onPictureTakenBeforeCrop$1", f = "WrongCameraStrategy.kt", l = {}, m = "invokeSuspend")
    /* renamed from: com.zybang.camera.strategy.cameramode.WrongCameraStrategy$onPictureTakenBeforeCrop$1, reason: invalid class name */
    static final class AnonymousClass1 extends SuspendLambda implements Function2<o000OO, OooO<? super o0OOO0o>, Object> {
        ...
        int label;
        final /* synthetic */ WrongCameraStrategy this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass1(Ref$ObjectRef<byte[]> ref$ObjectRef, Activity activity, o00O0O o00o0o2, WrongCameraStrategy wrongCameraStrategy, OooO<? super AnonymousClass1> oooO) {
            super(2, oooO);
            this.$imageData = ref$ObjectRef;
            this.$thisActivity = activity;
            this.$transferEntity = o00o0o2;
            this.this$0 = wrongCameraStrategy;
        }
    ...
    public WrongCameraStrategy() {
        this.modeItem = new WrongModeItem(null, 1, null);
    }
