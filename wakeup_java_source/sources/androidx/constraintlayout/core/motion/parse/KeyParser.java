...
public class KeyParser {
    ...
    public static TypedBundle parseAttributes(String str) {
        return parse(str, new Ids() { // from class: androidx.constraintlayout.core.motion.parse.OooO00o
            @Override // androidx.constraintlayout.core.motion.parse.KeyParser.Ids
            public final int get(String str2) {
                return androidx.constraintlayout.core.motion.utils.OooO00o.OooO00o(str2);
            }
        }, new DataType() { // from class: androidx.constraintlayout.core.motion.parse.OooO0O0
            @Override // androidx.constraintlayout.core.motion.parse.KeyParser.DataType
            public final int get(int i) {
                return androidx.constraintlayout.core.motion.utils.OooO00o.OooO0O0(i);
            }
        });
    }
}
