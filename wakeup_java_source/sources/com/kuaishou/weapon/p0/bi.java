...
public class bi {
    ...
    public static final String u = "OTUzc3E1N0w5NTIzMW80OUQxMGo3R1dFa0ZiandHT0w=";
    public static int v = -1;
    public static final int w = 1;
    public static final int x = 0;
    public static final String y = "su";
    public static final String[] z = {"/data/local/", "/data/local/bin/", "/data/local/xbin/", "/sbin/", "/su/bin/", "/system/bin/", "/system/bin/failsafe/", "/system/xbin/"};
}
