    ...
    private static void encodeUtf8Buffer(CharSequence charSequence, ByteBuffer byteBuffer) {
        ...
        while (i2 < length) {
            ...
            if (cCharAt2 < 128) {
                ...
                int i3 = iPosition + 1;
                try {
                    byteBuffer.put(iPosition, (byte) ((cCharAt2 >>> 6) | MediaPlayer.MEDIA_PLAYER_OPTION_SET_KSY_FRAME_WAIT));
                    ...
                    if (i4 != length) {
                        try {
                            ...
                            if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                                ...
                                int i5 = iPosition + 1;
                                try {
                                    byteBuffer.put(iPosition, (byte) ((codePoint >>> 18) | MediaPlayer.MEDIA_PLAYER_OPTION_GET_PLAY_WASTE_DATA));
                                    i = iPosition + 2;
