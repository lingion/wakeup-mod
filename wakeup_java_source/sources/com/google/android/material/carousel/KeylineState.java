...
final class KeylineState {
    ...
    static final class Builder {
        ...
        @NonNull
        Builder addAnchorKeyline(float f, @FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = Contrast.RATIO_MIN) float f2, float f3) {
            return addKeyline(f, f2, f3, false, true);
        }

        @NonNull
        Builder addKeyline(float f, @FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = Contrast.RATIO_MIN) float f2, float f3, boolean z) {
            return addKeyline(f, f2, f3, z, false);
        }

        @NonNull
        Builder addKeylineRange(float f, @FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = Contrast.RATIO_MIN) float f2, float f3, int i) {
        ...
        @NonNull
        Builder addKeyline(float f, @FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = Contrast.RATIO_MIN) float f2, float f3) {
            return addKeyline(f, f2, f3, false);
        }

        @NonNull
        Builder addKeylineRange(float f, @FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = Contrast.RATIO_MIN) float f2, float f3, int i, boolean z) {
            if (i > 0 && f3 > 0.0f) {
        ...
        @NonNull
        Builder addKeyline(float f, @FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = Contrast.RATIO_MIN) float f2, float f3, boolean z, boolean z2, float f4, float f5, float f6) {
            if (f3 <= 0.0f) {
                return this;
            }
            if (z2) {
        ...
        @NonNull
        Builder addKeyline(float f, @FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = Contrast.RATIO_MIN) float f2, float f3, boolean z, boolean z2, float f4) {
            return addKeyline(f, f2, f3, z, z2, f4, 0.0f, 0.0f);
        }

        @NonNull
        Builder addKeyline(float f, @FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = Contrast.RATIO_MIN) float f2, float f3, boolean z, boolean z2) {
            float f4;
            float fAbs;
            float f5 = f3 / 2.0f;
            float f6 = f - f5;
            ...
            if (f7 > f8) {
                fAbs = Math.abs(f7 - Math.max(f7 - f3, f8));
            } else if (f6 < 0.0f) {
                fAbs = Math.abs(f6 - Math.min(f6 + f3, 0.0f));
            } else {
                f4 = 0.0f;
    ...
    static final class Keyline {
        ...
        static Keyline lerp(Keyline keyline, Keyline keyline2, @FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = Contrast.RATIO_MIN) float f) {
