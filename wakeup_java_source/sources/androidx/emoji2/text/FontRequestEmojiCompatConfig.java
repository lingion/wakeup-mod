            ...
            synchronized (this.mLock) {
                try {
                    ...
                    if (this.mMainHandlerLoadCallback == null) {
                        this.mMainHandlerLoadCallback = new Runnable() { // from class: androidx.emoji2.text.OooOO0
                            @Override // java.lang.Runnable
                            public final void run() {
                                this.f1255OooO0o0.loadInternal();
                            }
                        };
                    }
        ...
        void loadInternal() {
            synchronized (this.mLock) {
                try {
                    ...
                    this.mExecutor.execute(new Runnable() { // from class: androidx.emoji2.text.OooO
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f1249OooO0o0.createMetadata();
                        }
                    });
                } catch (Throwable th) {
                    throw th;
