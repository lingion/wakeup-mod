...
public class SearchBar extends Toolbar {
    ...
    public void startOnLoadAnimation() {
        post(new Runnable() { // from class: com.google.android.material.search.OooO0O0
            @Override // java.lang.Runnable
            public final void run() {
                this.f5012OooO0o0.lambda$startOnLoadAnimation$1();
            }
        });
    }
    ...
    public SearchBar(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.menuResId = -1;
        this.touchExplorationStateChangeListener = new AccessibilityManagerCompat.TouchExplorationStateChangeListener() { // from class: com.google.android.material.search.OooO0OO
            @Override // androidx.core.view.accessibility.AccessibilityManagerCompat.TouchExplorationStateChangeListener
            public final void onTouchExplorationStateChanged(boolean z) {
                this.f5013OooO00o.lambda$new$0(z);
            }
        };
