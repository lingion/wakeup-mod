...
class ViewUtilsLollipop {
    ...
    static void setDefaultAppBarLayoutStateListAnimator(@NonNull View view, float f) {
    ...
    static void setStateListAnimatorFromAttrs(@NonNull View view, AttributeSet attributeSet, int i, int i2) {
