...
public class PtrClassicDefaultHeader extends FrameLayout implements OooO0OO {
    ...
    private class OooO0O0 implements Runnable {
        ...
        private boolean f12759OooO0o0;

        private OooO0O0() {
            this.f12759OooO0o0 = false;
        }
    ...
    protected void initViews(AttributeSet attributeSet) {
        ...
        buildAnimation();
        View viewInflate = LayoutInflater.from(getContext()).inflate(R$layout.cube_ptr_classic_default_header, this);
