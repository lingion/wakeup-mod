...
public final class kq implements com.kwad.sdk.core.d<AdMatrixInfo.SplashInfo> {
    ...
    private static JSONObject b(AdMatrixInfo.SplashInfo splashInfo, JSONObject jSONObject) {
        ...
        com.kwad.sdk.utils.aa.a(jSONObject, "interactionInfo", splashInfo.interactionInfo);
        return jSONObject;
    }
}
