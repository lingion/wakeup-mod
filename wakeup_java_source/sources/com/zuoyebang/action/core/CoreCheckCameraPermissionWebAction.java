...
@FeAction(name = "core_checkCameraPermission")
/* loaded from: classes3.dex */
public class CoreCheckCameraPermissionWebAction extends AbsCheckPermissionWebAction {
    ...
    public void onAction(Activity activity, JSONObject jSONObject, HybridWebView.OooOo oooOo) throws JSONException {
        ...
        returnCheckCallback(iPermissionCheckService != null ? iPermissionCheckService.OooOoO("android.permission.CAMERA") : false);
    }
}
