...
class SystemBarStateMonitor {
    ...
    SystemBarStateMonitor(final ViewGroup viewGroup) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(view, new OnApplyWindowInsetsListener() { // from class: androidx.core.view.insets.OooO0o
            @Override // androidx.core.view.OnApplyWindowInsetsListener
            public final WindowInsetsCompat onApplyWindowInsets(View view2, WindowInsetsCompat windowInsetsCompat) {
                return this.f1225OooO00o.lambda$new$0(view2, windowInsetsCompat);
            }
        });
    ...
    void detachFromWindow() {
        this.mDetector.post(new Runnable() { // from class: androidx.core.view.insets.OooO
            @Override // java.lang.Runnable
            public final void run() {
                this.f1222OooO0o0.lambda$detachFromWindow$1();
            }
        });
    }
