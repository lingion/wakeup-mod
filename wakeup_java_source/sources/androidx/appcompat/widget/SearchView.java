...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<SearchView> {
        ...
        public void mapProperties(@NonNull PropertyMapper propertyMapper) {
            ...
            this.mMaxWidthId = propertyMapper.mapInt(CoreFetchImgAction.INPUT_MAX_WIDTH, R.attr.maxWidth);
    ...
    private static class PreQAutoCompleteTextViewReflector {
        ...
        void ensureImeVisible(AutoCompleteTextView autoCompleteTextView) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            preApi29Check();
    ...
    protected void onQueryRefine(@Nullable CharSequence charSequence) {
