...
public final class MutableScatterMap$MutableMapWrapper$values$1<V> implements Collection<V>, o0oO0Ooo.OooO0O0 {
    ...
    public boolean containsAll(Collection<? extends Object> elements) {
        ...
        while (it2.hasNext()) {
            if (!mutableScatterMap.containsValue(it2.next())) {
                return false;
            }
        }
        return true;
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            if (o0OoOo0.OooO0O0(mutableScatterMap.values[i4], obj)) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            if (o00Ooo.OooooO0(elements, mutableScatterMap.values[i4])) {
                                mutableScatterMap.removeValueAt(i4);
                                z2 = true;
                            }
                        }
