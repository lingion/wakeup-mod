...
public class MotionController {
    ...
    private void insertKey(MotionPaths motionPaths) {
        if (Collections.binarySearch(this.mMotionPaths, motionPaths) == 0) {
            ...
            sb.append(motionPaths.mPosition);
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (motionPathsArr[i8].mAttributes.containsKey(str6) && (constraintAttribute = motionPathsArr[i8].mAttributes.get(str6)) != null) {
        ...
        for (int i15 = 0; i15 < i5; i15++) {
            ...
            dArr3[i15] = motionPathsArr[i15].mTime;
        }
        int i16 = 0;
        while (true) {
            ...
            while (i19 < i5) {
                if (motionPathsArr[i19].hasCustomData(str8)) {
                    if (dArr5 == null) {
                        ...
                        iArr3[c] = motionPathsArr[i19].getCustomDataCount(str8);
                        iArr3[0] = i5;
                        dArr5 = (double[][]) Array.newInstance((Class<?>) Double.TYPE, iArr3);
                    }
                    MotionPaths motionPaths = motionPathsArr[i19];
                    dArr = dArr2;
                    dArr4[i20] = motionPaths.mTime;
                    motionPaths.getCustomData(str8, dArr5[i20], 0);
                    i20++;
                } else {
                    dArr = dArr2;
                }
