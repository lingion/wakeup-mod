...
public class IntentSanitizer {
    ...
    public static final class Builder {
        ...
        private boolean mAllowSourceBounds;
        private int mAllowedFlags;
        private Predicate<String> mAllowedActions = new Predicate() { // from class: androidx.core.content.o000oOoO
        ...
        private Predicate<Uri> mAllowedData = new Predicate() { // from class: androidx.core.content.o0OoOo0
            @Override // androidx.core.util.Predicate
            public /* synthetic */ Predicate and(Predicate predicate) {
                return androidx.core.util.OooOo00.OooO00o(this, predicate);
            }
        ...
        private Predicate<String> mAllowedTypes = new Predicate() { // from class: androidx.core.content.o00O0O
            @Override // androidx.core.util.Predicate
            public /* synthetic */ Predicate and(Predicate predicate) {
                return androidx.core.util.OooOo00.OooO00o(this, predicate);
            }
        ...
        private Predicate<String> mAllowedCategories = new Predicate() { // from class: androidx.core.content.o00Oo0
            @Override // androidx.core.util.Predicate
            public /* synthetic */ Predicate and(Predicate predicate) {
                return androidx.core.util.OooOo00.OooO00o(this, predicate);
            }
        ...
        private Predicate<String> mAllowedPackages = new Predicate() { // from class: androidx.core.content.o00Ooo
            @Override // androidx.core.util.Predicate
            public /* synthetic */ Predicate and(Predicate predicate) {
                return androidx.core.util.OooOo00.OooO00o(this, predicate);
            }
        ...
        private Predicate<ComponentName> mAllowedComponents = new Predicate() { // from class: androidx.core.content.oo000o
            @Override // androidx.core.util.Predicate
            public /* synthetic */ Predicate and(Predicate predicate) {
                return androidx.core.util.OooOo00.OooO00o(this, predicate);
            }
        ...
        private Predicate<Uri> mAllowedClipDataUri = new Predicate() { // from class: androidx.core.content.o00oO0o
            @Override // androidx.core.util.Predicate
            public /* synthetic */ Predicate and(Predicate predicate) {
                return androidx.core.util.OooOo00.OooO00o(this, predicate);
            }
        ...
        private Predicate<ClipData> mAllowedClipData = new Predicate() { // from class: androidx.core.content.o0ooOOo
            @Override // androidx.core.util.Predicate
            public /* synthetic */ Predicate and(Predicate predicate) {
                return androidx.core.util.OooOo00.OooO00o(this, predicate);
            }
        ...
        public Builder allowAnyComponent() {
            ...
            this.mAllowedComponents = new Predicate() { // from class: androidx.core.content.OooOo00
                @Override // androidx.core.util.Predicate
                public /* synthetic */ Predicate and(Predicate predicate) {
                    return androidx.core.util.OooOo00.OooO00o(this, predicate);
                }
        ...
        public Builder allowCategory(String str) {
            Preconditions.checkNotNull(str);
            Objects.requireNonNull(str);
            return allowCategory(new OooOO0(str));
        }
        ...
        public Builder allowClipDataUriWithAuthority(final String str) {
            Preconditions.checkNotNull(str);
            return allowClipDataUri(new Predicate() { // from class: androidx.core.content.OooOo
                @Override // androidx.core.util.Predicate
                public /* synthetic */ Predicate and(Predicate predicate) {
                    return androidx.core.util.OooOo00.OooO00o(this, predicate);
                }
        ...
        public Builder allowComponent(final ComponentName componentName) {
            ...
            return allowComponent(new Predicate() { // from class: androidx.core.content.OooOOOO
                @Override // androidx.core.util.Predicate
                public /* synthetic */ Predicate and(Predicate predicate) {
                    return androidx.core.util.OooOo00.OooO00o(this, predicate);
                }
        ...
        public Builder allowComponentWithPackage(final String str) {
            Preconditions.checkNotNull(str);
            return allowComponent(new Predicate() { // from class: androidx.core.content.OooOO0O
                @Override // androidx.core.util.Predicate
                public /* synthetic */ Predicate and(Predicate predicate) {
                    return androidx.core.util.OooOo00.OooO00o(this, predicate);
                }
        ...
        public Builder allowDataWithAuthority(final String str) {
            Preconditions.checkNotNull(str);
            allowData(new Predicate() { // from class: androidx.core.content.OooOOO0
                @Override // androidx.core.util.Predicate
                public /* synthetic */ Predicate and(Predicate predicate) {
                    return androidx.core.util.OooOo00.OooO00o(this, predicate);
                }
        ...
        public Builder allowExtra(String str, Class<?> cls) {
            return allowExtra(str, cls, new Predicate() { // from class: androidx.core.content.o0OOO0o
                @Override // androidx.core.util.Predicate
                public /* synthetic */ Predicate and(Predicate predicate) {
                    return androidx.core.util.OooOo00.OooO00o(this, predicate);
                }
        ...
        public Builder allowExtraOutput(final String str) {
            allowExtra("output", Uri.class, new Predicate() { // from class: androidx.core.content.OooO
                @Override // androidx.core.util.Predicate
                public /* synthetic */ Predicate and(Predicate predicate) {
                    return androidx.core.util.OooOo00.OooO00o(this, predicate);
                }
        ...
        public Builder allowExtraStreamUriWithAuthority(final String str) {
            Preconditions.checkNotNull(str);
            allowExtra("android.intent.extra.STREAM", Uri.class, new Predicate() { // from class: androidx.core.content.Oooo0
                @Override // androidx.core.util.Predicate
                public /* synthetic */ Predicate and(Predicate predicate) {
                    return androidx.core.util.OooOo00.OooO00o(this, predicate);
                }
        ...
        public Builder allowPackage(String str) {
            Preconditions.checkNotNull(str);
            Objects.requireNonNull(str);
            return allowPackage(new OooOO0(str));
        }
        ...
        public Builder allowType(String str) {
            Preconditions.checkNotNull(str);
            Objects.requireNonNull(str);
            return allowType(new OooOO0(str));
        }
        ...
        public <T> Builder allowExtra(String str, final Class<T> cls, final Predicate<T> predicate) {
            ...
            Preconditions.checkNotNull(predicate);
            return allowExtra(str, new Predicate() { // from class: androidx.core.content.OooOOO
                @Override // androidx.core.util.Predicate
                public /* synthetic */ Predicate and(Predicate predicate2) {
                    return androidx.core.util.OooOo00.OooO00o(this, predicate2);
                }
                ...
                public /* synthetic */ Predicate or(Predicate predicate2) {
                    return androidx.core.util.OooOo00.OooO0OO(this, predicate2);
                }
        ...
        public Builder allowExtra(String str, Predicate<Object> predicate) {
            ...
            if (predicate2 == null) {
                predicate2 = new Predicate() { // from class: androidx.core.content.Oooo000
                    @Override // androidx.core.util.Predicate
                    public /* synthetic */ Predicate and(Predicate predicate3) {
                        return androidx.core.util.OooOo00.OooO00o(this, predicate3);
                    }
                    ...
                    public /* synthetic */ Predicate or(Predicate predicate3) {
                        return androidx.core.util.OooOo00.OooO0OO(this, predicate3);
                    }
    ...
    */
    ...
    public Intent sanitizeByFiltering(Intent intent) {
        return sanitize(intent, new Consumer() { // from class: androidx.core.content.OooO0o
    ...
    public Intent sanitizeByThrowing(Intent intent) {
        return sanitize(intent, new Consumer() { // from class: androidx.core.content.OooO0OO
            @Override // androidx.core.util.Consumer
            public final void accept(Object obj) {
