...
public class PluginApplicationWrapper extends Application {
    ...
    public PluginApplicationWrapper(Application application, PluginContext pluginContext) throws NoSuchFieldException, SecurityException, IllegalArgumentException {
