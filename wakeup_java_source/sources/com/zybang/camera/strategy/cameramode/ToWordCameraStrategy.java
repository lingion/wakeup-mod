...
public final class ToWordCameraStrategy extends BaseCameraStrategy {
    ...
    @OooO0o(c = "com.zybang.camera.strategy.cameramode.ToWordCameraStrategy$onPictureTakenBeforeCrop$1", f = "ToWordCameraStrategy.kt", l = {91}, m = "invokeSuspend")
    /* renamed from: com.zybang.camera.strategy.cameramode.ToWordCameraStrategy$onPictureTakenBeforeCrop$1, reason: invalid class name */
    static final class AnonymousClass1 extends SuspendLambda implements Function2<o000OO, OooO<? super o0OOO0o>, Object> {
        ...
        @OooO0o(c = "com.zybang.camera.strategy.cameramode.ToWordCameraStrategy$onPictureTakenBeforeCrop$1$1", f = "ToWordCameraStrategy.kt", l = {}, m = "invokeSuspend")
        /* renamed from: com.zybang.camera.strategy.cameramode.ToWordCameraStrategy$onPictureTakenBeforeCrop$1$1, reason: invalid class name and collision with other inner class name */
        static final class C05611 extends SuspendLambda implements Function2<o000OO, OooO<? super o0OOO0o>, Object> {
            final /* synthetic */ o0OO0O0 $callBack;
            ...
            C05611(int i, o0OO0O0 o0oo0o0, o00O0O o00o0o2, Activity activity, OooO<? super C05611> oooO) {
                super(2, oooO);
            ...
            public final OooO<o0OOO0o> create(Object obj, OooO<?> oooO) {
                return new C05611(this.$currentSubTabMode, this.$callBack, this.$transferEntity, this.$thisActivity, oooO);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (this.$currentSubTabMode == 1) {
                    ...
                    if (o000ooOooo0 != null) {
                        o000ooOooo0.OooO0o0(this.$thisActivity, this.$transferEntity, 1);
                    }
            ...
            public final Object invoke(o000OO o000oo2, OooO<? super o0OOO0o> oooO) {
                return ((C05611) create(o000oo2, oooO)).invokeSuspend(o0OOO0o.f13233OooO00o);
            }
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i == 0) {
                ...
                C05611 c05611 = new C05611(iOooO0oo, this.$callBack, this.$transferEntity, this.$thisActivity, null);
                this.label = 1;
                if (OooOOO0.OooO0oO(oo0oOooO0OO, c05611, this) == objOooO0oO) {
                    return objOooO0oO;
                }
            } else {
                if (i != 1) {
    ...
    public ToWordCameraStrategy() {
        this.modeItem = new ToWordModeItem(null, 1, null);
    }
    ...
    public boolean onGalleryButtonClick(Activity thisActivity) {
        o0OoOo0.OooO0oO(thisActivity, "thisActivity");
        o0000O00.f18224OooOOOO.OooOoO0("GQM_006");
    ...
    public boolean takePictureLimit(Activity thisActivity, int i) {
        o0OoOo0.OooO0oO(thisActivity, "thisActivity");
        o00OO0OO.OooO00o oooO00o = o00OO0OO.f17718OooO0O0;
        boolean z = oooO00o.OooO00o().OooO0o0().OooO00o(this.modeItem.OooO0oo()) >= oooO00o.OooO00o().OooO0Oo().OooOOO(this.modeItem.OooO0oo());
        if (z) {
            try {
                ((Oooo.OooOO0) ((Oooo.OooOO0) ((Oooo.OooOO0) ((Oooo.OooOO0) ((Oooo.OooOO0) ((Oooo.OooOO0) ((CameraSDKBaseActivity) thisActivity).o00oO0o().OooOOOO(thisActivity).OooOOO0("图片张数超出上限")).OooOOO("单次最多拍摄30张图片，如需继续添加，请新建转换任务").OooOO0O("")).OooOO0o("我知道了")).OooO0O0(false)).OooO00o(false)).OooO0Oo(new com.baidu.homework.common.ui.dialog.core.OooO00o() { // from class: com.zybang.camera.strategy.cameramode.ToWordCameraStrategy.takePictureLimit.1
