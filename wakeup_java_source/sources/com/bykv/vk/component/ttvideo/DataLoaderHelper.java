...
public class DataLoaderHelper implements AVMDLDataLoaderListener, AVMDLStartCompleteListener {
    ...
    public class c {
        ...
        public class a {
            ...
            public boolean a() {
                ...
                List<C0072a> list = this.d;
                C0072a c0072a = list != null ? list.get(list.size() - 1) : null;
                if (this.f == null) {
                    return c0072a != null && this.b > 0 && c0072a.a + c0072a.b >= jMin;
                }
                return true;
            }
        }
    ...
    private class d {
        ...
        public b b(b bVar) {
            ...
            while (it2.hasNext() && (bVarC = c(it2.next().a)) == null) {
            }
            return bVarC;
        }
    ...
    private String a(String str, String str2, long j, long j2, String[] strArr, String str3) throws UnsupportedEncodingException {
        String strEncode;
        ...
        if (i != 0 && i != 15) {
            ...
            if ((str3 == null || aVMDLDataLoaderNotifyInfo.parameter != 3) && str3 != null) {
                ...
                if (strArrSplit2.length > 0 && (bVarB = this.d.b((str = strArrSplit2[0]))) != null) {
                    ...
                    dVar.c(str);
                    TTVideoEngineLog.i("DataLoaderHelper", "pop all task item. videoId = " + bVarB.a + " key = " + str);
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:37:0x006e -> B:42:0x0071). Please report as a decompilation issue!!! */
    ...
    private void a(b bVar) {
        ...
        ArrayList<TTVideoEngine> arrayListA = a(bVar.a);
    ...
    private void a(b bVar, b.a aVar) throws UnsupportedEncodingException {
        ...
        if (strArr != null) {
            String strA = a(str, bVar.a, aVar.f, 0L, strArr, aVar.d);
            aVar.b = strA;
            if (!TextUtils.isEmpty(strA)) {
                this.d.a(bVar);
                if (aVar.f > 0) {
    ...
    private void a(AVMDLDataLoaderNotifyInfo aVMDLDataLoaderNotifyInfo, boolean z, boolean z2) {
        ...
        try {
            ...
            String str3 = TextUtils.isEmpty(bVarB.a) ? str : bVarB.a;
            ...
            if (loadProgressByRawKey.b() || z2) {
                ...
                dataLoaderTaskProgressInfo.mVideoId = bVarB.a;
    ...
    private void a(String str, String str2, long j, PreloaderURLItem preloaderURLItem) throws UnsupportedEncodingException {
        if (TextUtils.isEmpty(str)) {
