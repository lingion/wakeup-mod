...
public final class WholeCameraStrategy extends SearchBaseCameraStrategy {
    ...
    @OooO0o(c = "com.zybang.camera.strategy.cameramode.WholeCameraStrategy$onPictureTakenBeforeCrop$1", f = "WholeCameraStrategy.kt", l = {}, m = "invokeSuspend")
    /* renamed from: com.zybang.camera.strategy.cameramode.WholeCameraStrategy$onPictureTakenBeforeCrop$1, reason: invalid class name */
    static final class AnonymousClass1 extends SuspendLambda implements Function2<o000OO, OooO<? super o0OOO0o>, Object> {
        ...
        int label;
        final /* synthetic */ WholeCameraStrategy this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass1(Ref$ObjectRef<byte[]> ref$ObjectRef, Activity activity, o00O0O o00o0o2, WholeCameraStrategy wholeCameraStrategy, OooO<? super AnonymousClass1> oooO) {
            super(2, oooO);
            this.$imageData = ref$ObjectRef;
            this.$thisActivity = activity;
            this.$transferEntity = o00o0o2;
            this.this$0 = wholeCameraStrategy;
        }
    ...
    public WholeCameraStrategy() {
        this.modeItem = new WholeModeItem(null, 1, null);
    }
    ...
    public void onPictureTakenBeforeCrop(Activity thisActivity, o00O0O transferEntity, o0OO0O0 callBack) {
        ...
        if (o0000ooVarOooo00o != null) {
            o0000ooVarOooo00o.OooO0O0(thisActivity, (byte[]) ref$ObjectRef.element, transferEntity);
        }
        thisActivity.finish();
    }
}
