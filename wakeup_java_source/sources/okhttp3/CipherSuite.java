...
public final class CipherSuite {
    ...
    public static final class Companion {
        ...
        private final String secondaryName(String str) {
            if (oo000o.OoooOOo(str, "TLS_", false, 2, null)) {
            ...
            if (!oo000o.OoooOOo(str, "SSL_", false, 2, null)) {
                return str;
            }
        ...
        public final synchronized CipherSuite forJavaName(String javaName) {
            ...
            try {
                o0OoOo0.OooO0oO(javaName, "javaName");
    ...
    static {
        ...
        ORDER_BY_NAME = new Comparator<String>() { // from class: okhttp3.CipherSuite$Companion$ORDER_BY_NAME$1
            ...
            public int compare(String a, String b) {
                ...
                for (int i = 4; i < iMin; i++) {
                    ...
                    if (cCharAt != cCharAt2) {
                        return o0OoOo0.OooO(cCharAt, cCharAt2) < 0 ? -1 : 1;
                    }
                }
                int length = a.length();
        ...
        TLS_DHE_DSS_WITH_AES_256_GCM_SHA384 = companion.init("TLS_DHE_DSS_WITH_AES_256_GCM_SHA384", MediaPlayer.MEDIA_PLAYER_OPTION_GET_AUDIO_DEVICE_OPENED_TIME);
        TLS_DH_anon_WITH_AES_128_GCM_SHA256 = companion.init("TLS_DH_anon_WITH_AES_128_GCM_SHA256", 166);
        TLS_DH_anon_WITH_AES_256_GCM_SHA384 = companion.init("TLS_DH_anon_WITH_AES_256_GCM_SHA384", MediaPlayer.MEDIA_PLAYER_OPTION_SUPER_RES_STRENGTH_OPTION);
    ...
    public final String m430deprecated_javaName() {
