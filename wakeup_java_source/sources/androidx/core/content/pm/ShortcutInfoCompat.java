...
public class ShortcutInfoCompat {
    ...
    static List<ShortcutInfoCompat> fromShortcuts(Context context, List<ShortcutInfo> list) {
        ...
        while (it2.hasNext()) {
            arrayList.add(new Builder(context, OooOO0.OooO00o(it2.next())).build());
        }
        return arrayList;
    }
    ...
    public ShortcutInfo toShortcutInfo() {
        OooOo.OooO00o();
        ShortcutInfo.Builder intents = OooOo00.OooO00o(this.mContext, this.mId).setShortLabel(this.mLabel).setIntents(this.mIntents);
