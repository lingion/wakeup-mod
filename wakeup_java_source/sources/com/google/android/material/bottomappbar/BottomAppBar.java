...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    protected int getActionMenuViewTranslationX(@NonNull ActionMenuView actionMenuView, int i, boolean z) throws Resources.NotFoundException {
        ...
        int i3 = zIsLayoutRtl ? this.rightInset : -this.leftInset;
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (z) {
            ...
            if (viewFindDependentView != null && ViewCompat.isLaidOut(viewFindDependentView)) {
                viewFindDependentView.post(new Runnable() { // from class: com.google.android.material.bottomappbar.OooO0OO
    ...
    boolean setFabDiameter(@Px int i) {
        float f = i;
