...
public abstract class Utf8 {
    ...
    static class DecodeUtil {
        ...
        static void handleFourBytes(byte b, byte b2, byte b3, byte b4, char[] cArr, int i) {
        ...
        static void handleThreeBytes(byte b, byte b2, byte b3, char[] cArr, int i) {
        ...
        static void handleTwoBytes(byte b, byte b2, char[] cArr, int i) {
            if (b < -62) {
