...
public class ConstraintSet {
    ...
    public static class Layout {
        ...
        void fillFromAttributeList(Context context, AttributeSet attributeSet) throws NumberFormatException {
    ...
    class WriteXmlEngine {
        ...
        void writeLayout() throws IOException {
            ...
            for (Integer num : ConstraintSet.this.mConstraints.keySet()) {
                ...
                writeEnum("app:barrierDirection", layout.mBarrierDirection, new String[]{j.d, j.e, j.f, j.g, "start", "end"}, -1);
        ...
        void writeVariable(String str, int[] iArr) throws IOException {
            ...
            this.mWriter.write(SPACE + str);
            this.mWriter.write(ServerSentEventKt.COLON);
            int i = 0;
            while (i < iArr.length) {
    ...
    private int[] convertReferenceString(View view, String str) throws IllegalAccessException, IllegalArgumentException {
        ...
        while (i < strArrSplit.length) {
            ...
            if (iIntValue == 0) {
                iIntValue = context.getResources().getIdentifier(strTrim, BaseInfo.KEY_ID_RECORD, context.getPackageName());
            }
    ...
    private Constraint fillFromAttributeList(Context context, AttributeSet attributeSet, boolean z) throws NumberFormatException {
        Constraint constraint = new Constraint();
    ...
    static String getDebugName(int i) {
        for (Field field : ConstraintSet.class.getDeclaredFields()) {
            if (field.getName().contains(PluginHandle.UNDERLINE) && field.getType() == Integer.TYPE && Modifier.isStatic(field.getModifiers()) && Modifier.isFinal(field.getModifiers())) {
                try {
    ...
    */
    static void parseDimensionConstraints(java.lang.Object r3, android.content.res.TypedArray r4, int r5, int r6) throws java.lang.NumberFormatException {
        /*
            if (r3 != 0) goto L3
            return
        L3:
    ...
    static void parseDimensionRatioString(ConstraintLayout.LayoutParams layoutParams, String str) throws NumberFormatException {
    ...
    private void populateConstraint(Constraint constraint, TypedArray typedArray, boolean z) throws NumberFormatException {
        if (z) {
    ...
    public void load(Context context, int i) throws XmlPullParserException, Resources.NotFoundException, IOException, NumberFormatException {
    ...
    */
    ...
    public void clone(ConstraintSet constraintSet) {
        ...
        for (Integer num : constraintSet.mConstraints.keySet()) {
            Constraint constraint = constraintSet.mConstraints.get(num);
            if (constraint != null) {
                this.mConstraints.put(num, constraint.m31clone());
            }
        }
    }
    ...
    public void clone(ConstraintLayout constraintLayout) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (constraint != null) {
                ...
                if (pivotX != IDataEditor.DEFAULT_NUMBER_VALUE || pivotY != IDataEditor.DEFAULT_NUMBER_VALUE) {
                    Transform transform = constraint.transform;
