...
public class JsonHelper {
    ...
    public static JSONObject parseMap2JSON(Map<String, String> map) throws JSONException {
    ...
    public static void putValue(JSONObject jSONObject, String str, String str2) throws JSONException {
        try {
    ...
    public static void putValue(JSONObject jSONObject, String str, double d) throws JSONException {
        try {
    ...
    public static void putValue(JSONObject jSONObject, String str, int i) throws JSONException {
        try {
    ...
    public static void putValue(JSONObject jSONObject, String str, float f) throws JSONException {
        try {
    ...
    public static void putValue(JSONObject jSONObject, String str, byte b) throws JSONException {
        try {
    ...
    public static void putValue(JSONObject jSONObject, String str, long j) throws JSONException {
        try {
    ...
    public static void putValue(JSONObject jSONObject, String str, boolean z) throws JSONException {
    ...
    public static void putValue(JSONObject jSONObject, String str, JSONObject jSONObject2) throws JSONException {
    ...
    public static void putValue(JSONObject jSONObject, String str, JSONArray jSONArray) throws JSONException {
    ...
    public static void putValue(JSONObject jSONObject, String str, IOfflineCompoJsonParse iOfflineCompoJsonParse) throws JSONException {
    ...
    public static void putValue(JSONObject jSONObject, String str, List<?> list) throws JSONException {
        if (list == null) {
            return;
        }
        JSONArray jSONArray = new JSONArray();
