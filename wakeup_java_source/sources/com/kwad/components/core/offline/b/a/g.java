...
final class g implements IImageLoader {

    /* renamed from: com.kwad.components.core.offline.b.a.g$2, reason: invalid class name */
    final class AnonymousClass2 implements ImageLoadingListener {
        final /* synthetic */ ImageView GT;
        final /* synthetic */ IImageLoader.ImageLoadingListener Ta;
        final /* synthetic */ IImageLoader.DisplayImageOptionsCompat Tc;
        ...
        AnonymousClass2(IImageLoader.ImageLoadingListener imageLoadingListener, IImageLoader.DisplayImageOptionsCompat displayImageOptionsCompat, ImageView imageView) {
            this.Ta = imageLoadingListener;
            this.Tc = displayImageOptionsCompat;
            this.GT = imageView;
        }

        @Override // com.kwad.sdk.core.imageloader.core.listener.ImageLoadingListener
        public final boolean onDecode(String str, InputStream inputStream, DecodedResult decodedResult) {
            return this.Ta.onDecode(str, inputStream, decodedResult == null ? null : decodedResult.mBitmap);
        }

        @Override // com.kwad.sdk.core.imageloader.core.listener.ImageLoadingListener
        public final void onLoadingCancelled(String str, View view) {
            this.Ta.onLoadingCancelled(str, view);
        }

        @Override // com.kwad.sdk.core.imageloader.core.listener.ImageLoadingListener
        public final void onLoadingComplete(final String str, final View view, final DecodedResult decodedResult) {
            IImageLoader.DisplayImageOptionsCompat displayImageOptionsCompat = this.Tc;
            if (displayImageOptionsCompat == null || displayImageOptionsCompat.getBlurRadius() <= 0 || decodedResult == null || decodedResult.mBitmap == null) {
                this.Ta.onLoadingComplete(str, view, decodedResult == null ? null : decodedResult.mBitmap);
            } else {
                GlobalThreadPools.Le().submit(new Runnable() { // from class: com.kwad.components.core.offline.b.a.g.2.1
                    @Override // java.lang.Runnable
                    public final void run() {
                        final Bitmap bitmapStackBlur = BlurUtils.stackBlur(decodedResult.mBitmap, AnonymousClass2.this.Tc.getBlurRadius(), false);
                        bw.runOnUiThread(new Runnable() { // from class: com.kwad.components.core.offline.b.a.g.2.1.1
                            @Override // java.lang.Runnable
                            public final void run() {
                                Bitmap bitmap;
                                AnonymousClass2.this.GT.setImageBitmap(bitmapStackBlur);
                                AnonymousClass1 anonymousClass1 = AnonymousClass1.this;
                                IImageLoader.ImageLoadingListener imageLoadingListener = AnonymousClass2.this.Ta;
                                String str2 = str;
                                View view2 = view;
                                ...
                                if (decodedResult2 == null) {
                                    ...
                                    Bitmap bitmap2 = bitmapStackBlur;
        ...
        public final void onLoadingFailed(String str, View view, FailReason failReason) {
            this.Ta.onLoadingFailed(str, view, failReason.getType().toString(), failReason.getCause());
        }

        @Override // com.kwad.sdk.core.imageloader.core.listener.ImageLoadingListener
        public final void onLoadingStarted(String str, View view) {
            this.Ta.onLoadingStarted(str, view);
        }
    }
    ...
    private ImageLoadingListener a(final IImageLoader.ImageLoadingListener imageLoadingListener) {
        ...
        return new ImageLoadingListener() { // from class: com.kwad.components.core.offline.b.a.g.1
            @Override // com.kwad.sdk.core.imageloader.core.listener.ImageLoadingListener
            public final boolean onDecode(String str, InputStream inputStream, DecodedResult decodedResult) {
