...
@kotlin.coroutines.jvm.internal.OooO0o(c = "com.suda.yzune.wakeupschedule.utils.AppWidgetUtils$refreshTodayWidget$3", f = "AppWidgetUtils.kt", l = {}, m = "invokeSuspend")
/* loaded from: classes4.dex */
final class AppWidgetUtils$refreshTodayWidget$3 extends SuspendLambda implements Function2<o000OO, kotlin.coroutines.OooO<? super kotlin.o0OOO0o>, Object> {
    ...
    AppWidgetUtils$refreshTodayWidget$3(Context context, TableConfig tableConfig, RemoteViews remoteViews, PendingIntent pendingIntent, AppWidgetManager appWidgetManager, int i, kotlin.coroutines.OooO<? super AppWidgetUtils$refreshTodayWidget$3> oooO) {
        super(2, oooO);
    ...
    public final kotlin.coroutines.OooO<kotlin.o0OOO0o> create(Object obj, kotlin.coroutines.OooO<?> oooO) {
        return new AppWidgetUtils$refreshTodayWidget$3(this.$context, this.$tableBean, this.$mRemoteViews, this.$pIntent, this.$appWidgetManager, this.$appWidgetId, oooO);
    }
    ...
    public final Object invoke(o000OO o000oo2, kotlin.coroutines.OooO<? super kotlin.o0OOO0o> oooO) {
        return ((AppWidgetUtils$refreshTodayWidget$3) create(o000oo2, oooO)).invokeSuspend(kotlin.o0OOO0o.f13233OooO00o);
    }
}
