...
final class u extends ContextThemeWrapper implements ResContext {
    ...
    public u(ContextThemeWrapper contextThemeWrapper) {
        ...
        this.aux = ((Integer) ApiReflect.i(contextThemeWrapper).cC("getThemeResId").get()).intValue();
    }
    ...
    public final Object getSystemService(String str) {
        return Wrapper.wrapSystemService(this.auy.getSystemService(str), str, this);
    }
    ...
    public final Resources.Theme getTheme() {
        ...
        if (theme2 == null || theme2 == theme) {
            this.auw = Wrapper.replaceTheme(theme, theme2, this.aux);
        }
        return this.auw;
    }
