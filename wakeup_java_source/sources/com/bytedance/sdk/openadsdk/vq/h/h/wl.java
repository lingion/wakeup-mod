...
public class wl implements TTFeedAd {
    private ValueSet bj;
    ...
    public View getAdView() {
        View view = (View) this.bj.objectValue(140016, View.class);
        com.bytedance.sdk.openadsdk.api.je.ta("wzj", "1-ApiFeed:view=".concat(String.valueOf(view)));
        return view;
    }
