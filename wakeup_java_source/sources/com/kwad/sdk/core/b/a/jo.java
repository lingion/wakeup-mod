...
public final class jo implements com.kwad.sdk.core.d<RewardMonitorInfo> {
    ...
    private static JSONObject b(RewardMonitorInfo rewardMonitorInfo, JSONObject jSONObject) {
        ...
        if (i != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "load_type", i);
        }
        ...
        if (i3 != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "ad_count", i3);
        }
        ...
        if (j2 != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "download_duration_ms", j2);
        }
        long j3 = rewardMonitorInfo.totalDuration;
        if (j3 != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "total_duration_ms", j3);
        }
        int i4 = rewardMonitorInfo.downloadType;
        if (i4 != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "download_type", i4);
        }
        ...
        if (j7 != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "data_load_interval_duration_ms", j7);
        }
        long j8 = rewardMonitorInfo.dataDownloadInterval;
        if (j8 != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "data_download_interval_duration_ms", j8);
        }
        int i5 = rewardMonitorInfo.adSceneType;
        if (i5 != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "ad_scene_type", i5);
        }
        long j9 = rewardMonitorInfo.renderDuration;
        if (j9 != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "render_duration_ms", j9);
        }
        long j10 = rewardMonitorInfo.currentDuration;
        if (j10 != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "video_duration_ms", j10);
        }
        int i6 = rewardMonitorInfo.pageStatus;
        if (i6 != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "page_status", i6);
        }
        ...
        if (i7 != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "reward_type", i7);
        }
        int i8 = rewardMonitorInfo.taskType;
        if (i8 != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "task_type", i8);
        }
        int i9 = rewardMonitorInfo.taskStep;
        if (i9 != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "task_step", i9);
        }
        long j11 = rewardMonitorInfo.posId;
        if (j11 != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "pos_Id", j11);
        }
        int i10 = rewardMonitorInfo.materialType;
        if (i10 != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "material_type", i10);
        }
        ...
        if (i11 != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "operation_type", i11);
        }
        int i12 = rewardMonitorInfo.tkRenderType;
        if (i12 != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "tk_render_type", i12);
        }
        ...
        if (z) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "enable_reward_layout_optimise", z);
        }
        boolean z2 = rewardMonitorInfo.enableFullscreenLayoutOptimise;
        if (z2) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "enable_fullscreen_layout_optimise", z2);
        }
        int i13 = rewardMonitorInfo.rewardTaskType;
        if (i13 != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "reward_task_type", i13);
        }
        int i14 = rewardMonitorInfo.fraudVerifyType;
        if (i14 != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "fraud_verify_type", i14);
        }
        int i15 = rewardMonitorInfo.fraudVerifyCode;
        if (i15 != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "fraud_verify_code", i15);
        }
