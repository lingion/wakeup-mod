...
public class DifferentialMotionFlingController {
    ...
    public DifferentialMotionFlingController(Context context, DifferentialMotionFlingTarget differentialMotionFlingTarget) {
        this(context, differentialMotionFlingTarget, new FlingVelocityThresholdCalculator() { // from class: androidx.core.view.o00O0O
        ...
        }, new DifferentialVelocityProvider() { // from class: androidx.core.view.o00Oo0
