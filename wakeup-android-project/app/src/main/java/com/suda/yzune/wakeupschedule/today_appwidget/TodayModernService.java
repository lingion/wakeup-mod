...
public final class TodayModernService extends RemoteViewsService {
    ...
    public RemoteViewsService.RemoteViewsFactory onGetViewFactory(Intent intent) {
        ...
        if (listO0000O0O.size() < 2) {
            ...
            return new OooO0OO(applicationContext3, 0, o0OoOo0.OooO0O0(listO0000O0O.get(0), "1"), 2, null);
        }
        Context applicationContext4 = getApplicationContext();
        o0OoOo0.OooO0o(applicationContext4, "getApplicationContext(...)");
        return new OooO0OO(applicationContext4, Integer.parseInt((String) listO0000O0O.get(1)), o0OoOo0.OooO0O0(listO0000O0O.get(0), "1"));
    }
}
