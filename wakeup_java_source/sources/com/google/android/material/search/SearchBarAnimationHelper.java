...
class SearchBarAnimationHelper {
    ...
    public void dispatchOnLoadAnimation(OnLoadAnimationInvocation onLoadAnimationInvocation) {
        Iterator<SearchBar.OnLoadAnimationCallback> it2 = this.onLoadAnimationCallbacks.iterator();
        while (it2.hasNext()) {
            onLoadAnimationInvocation.invoke(it2.next());
        }
    }
    ...
    private ValueAnimator.AnimatorUpdateListener getExpandedViewBackgroundUpdateListener(SearchBar searchBar, final View view) {
        ...
        return new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.search.OooOOO0
    ...
    private Animator getFadeOutChildrenAnimator(SearchBar searchBar, final View view) {
        ...
        valueAnimatorOfFloat.addUpdateListener(MultiViewUpdateListener.alphaListener(fadeChildren));
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.search.OooO0o
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                view.setAlpha(0.0f);
            }
    ...
    public /* synthetic */ void lambda$startExpandAnimation$0(SearchBar searchBar, View view, AppBarLayout appBarLayout, boolean z) {
        ...
        Iterator<AnimatorListenerAdapter> it2 = this.expandAnimationListeners.iterator();
        while (it2.hasNext()) {
    ...
    void startCollapseAnimation(SearchBar searchBar, View view, @Nullable AppBarLayout appBarLayout, boolean z) {
        ...
        Iterator<AnimatorListenerAdapter> it2 = this.collapseAnimationListeners.iterator();
        while (it2.hasNext()) {
            animatorSet.addListener(it2.next());
        }
        if (z) {
    ...
    void startExpandAnimation(final SearchBar searchBar, final View view, @Nullable final AppBarLayout appBarLayout, final boolean z) {
        ...
        view.post(new Runnable() { // from class: com.google.android.material.search.OooOO0O
            @Override // java.lang.Runnable
            public final void run() {
                this.f5018OooO0o0.lambda$startExpandAnimation$0(searchBar, view, appBarLayout, z);
            }
        });
    }
    ...
    void startOnLoadAnimation(SearchBar searchBar) {
        dispatchOnLoadAnimation(new OnLoadAnimationInvocation() { // from class: com.google.android.material.search.OooO
        ...
        secondaryViewAnimator.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.search.SearchBarAnimationHelper.1
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animator) {
                SearchBarAnimationHelper.this.dispatchOnLoadAnimation(new OnLoadAnimationInvocation() { // from class: com.google.android.material.search.OooOOO
                    @Override // com.google.android.material.search.SearchBarAnimationHelper.OnLoadAnimationInvocation
                    public final void invoke(SearchBar.OnLoadAnimationCallback onLoadAnimationCallback) {
        ...
        if (centerView instanceof AnimatableView) {
            ((AnimatableView) centerView).startAnimation(new AnimatableView.Listener() { // from class: com.google.android.material.search.OooOO0
