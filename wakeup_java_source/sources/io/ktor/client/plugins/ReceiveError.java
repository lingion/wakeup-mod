...
public final class ReceiveError implements ClientHook<Function3<? super HttpRequest, ? super Throwable, ? super kotlin.coroutines.OooO<? super Throwable>, ? extends Object>> {
    public static final ReceiveError INSTANCE = new ReceiveError();

    @kotlin.coroutines.jvm.internal.OooO0o(c = "io.ktor.client.plugins.ReceiveError$install$1", f = "HttpCallValidator.kt", l = {MediaPlayer.MEDIA_PLAYER_OPTION_SUPER_RES_OPTION, MediaPlayer.MEDIA_PLAYER_OPTION_SUPER_RES_STRENGTH_OPTION}, m = "invokeSuspend")
    /* renamed from: io.ktor.client.plugins.ReceiveError$install$1, reason: invalid class name */
    static final class AnonymousClass1 extends SuspendLambda implements Function3<PipelineContext<HttpResponseContainer, HttpClientCall>, HttpResponseContainer, kotlin.coroutines.OooO<? super kotlin.o0OOO0o>, Object> {
    ...
    public void install(HttpClient client, Function3<? super HttpRequest, ? super Throwable, ? super kotlin.coroutines.OooO<? super Throwable>, ? extends Object> handler) throws InvalidPhaseException {
