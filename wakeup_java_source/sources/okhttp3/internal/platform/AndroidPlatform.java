...
public final class AndroidPlatform extends Platform {
    ...
    public static final class CustomTrustRootIndex implements TrustRootIndex {
        ...
        public CustomTrustRootIndex(X509TrustManager trustManager, Method findByIssuerAndSignatureMethod) {
            ...
            o0OoOo0.OooO0oO(findByIssuerAndSignatureMethod, "findByIssuerAndSignatureMethod");
        ...
        public boolean equals(Object obj) {
            ...
            return o0OoOo0.OooO0O0(this.trustManager, customTrustRootIndex.trustManager) && o0OoOo0.OooO0O0(this.findByIssuerAndSignatureMethod, customTrustRootIndex.findByIssuerAndSignatureMethod);
        }
        ...
        public X509Certificate findByIssuerAndSignature(X509Certificate cert) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            o0OoOo0.OooO0oO(cert, "cert");
            try {
                Object objInvoke = this.findByIssuerAndSignatureMethod.invoke(this.trustManager, cert);
                o0OoOo0.OooO0o0(objInvoke, "null cannot be cast to non-null type java.security.cert.TrustAnchor");
    ...
    public AndroidPlatform() {
        List listOooOOo = o00Ooo.OooOOo(StandardAndroidSocketAdapter.Companion.buildIfSupported$default(StandardAndroidSocketAdapter.Companion, null, 1, null), new DeferredSocketAdapter(AndroidSocketAdapter.Companion.getPlayProviderFactory()), new DeferredSocketAdapter(ConscryptSocketAdapter.Companion.getFactory()), new DeferredSocketAdapter(BouncyCastleSocketAdapter.Companion.getFactory()));
