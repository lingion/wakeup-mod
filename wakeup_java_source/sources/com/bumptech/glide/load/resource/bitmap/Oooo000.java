...
public class Oooo000 extends OooOO0O {
    ...
    private static final byte[] f3165OooO0O0 = "com.bumptech.glide.load.resource.bitmap.CenterInside".getBytes(o00OO.f870OooO00o);

    @Override // OoooOoO.o00OO
    public void OooO0O0(MessageDigest messageDigest) {
        messageDigest.update(f3165OooO0O0);
    }
