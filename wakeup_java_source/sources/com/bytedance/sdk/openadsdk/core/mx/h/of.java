...
public class of extends com.bytedance.sdk.component.h.ta<JSONObject, JSONObject> {
    private String bj;
    private SSWebView h;

    public of(SSWebView sSWebView, String str) {
        this.h = sSWebView;
        this.bj = str;
    }
    ...
    public static void h(com.bytedance.sdk.component.h.r rVar, SSWebView sSWebView, String str) {
        rVar.h("close_twist_observer", (com.bytedance.sdk.component.h.ta<?, ?>) new of(sSWebView, str));
    }
