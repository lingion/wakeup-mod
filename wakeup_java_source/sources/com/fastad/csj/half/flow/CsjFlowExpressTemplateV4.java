...
public final class CsjFlowExpressTemplateV4 extends CsjBaseFlowExpressTemplate {
    ...
    public CsjFlowExpressTemplateV4(TTFeedAd ttAd, SdkRenderAdModel sdkRenderAdModel, CsjAdSlot csjAdSlot) {
        super(csjAdSlot);
    ...
    private final void dealAdView() {
        ...
        int iOooO00o = getCsjAdSlot().getHeight() == 0 ? OooOo00.OooO00o(80.0f) : OooOo00.OooO00o(getCsjAdSlot().getHeight());
    ...
    public final void generated() {
        ...
        final TTAdDislike dislikeDialog = this.ttAd.getDislikeDialog(getActivity());
        o0OoOo0.OooO0o(dislikeDialog, "ttAd.getDislikeDialog(activity)");
        dislikeDialog.setDislikeInteractionCallback(new TTAdDislike.DislikeInteractionCallback() { // from class: com.fastad.csj.half.flow.CsjFlowExpressTemplateV4$generated$1$1
        ...
        if (view != null) {
            view.setOnClickListener(new View.OnClickListener() { // from class: com.fastad.csj.half.flow.OooO00o
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    CsjFlowExpressTemplateV4.m242generated$lambda12$lambda11(dislikeDialog, view2);
                }
            });
        }
        this.ttAd.registerViewForInteraction(adView, getClickList(), null, this.closeView, new TTNativeAd.AdInteractionListener() { // from class: com.fastad.csj.half.flow.CsjFlowExpressTemplateV4$generated$1$3
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: generated$lambda-12$lambda-11, reason: not valid java name */
    public static final void m242generated$lambda12$lambda11(TTAdDislike ttAdDislike, View view) {
        o0OoOo0.OooO0oO(ttAdDislike, "$ttAdDislike");
    ...
    private final void showImageOrVideo() throws IllegalStateException {
        ...
        ViewGroup adView2 = getAdView();
        this.videoLayout = adView2 == null ? null : (CsjVideoPlayLayout) adView2.findViewById(R.id.id_ad_video);
        ViewGroup adView3 = getAdView();
        final ImageView imageView2 = adView3 != null ? (ImageView) adView3.findViewById(R.id.id_blur) : null;
        if (((AdMaterials.FileMaterials) ref$ObjectRef.element).fileType == 1) {
            ...
            OooO0OO.OooOo0(imageView.getContext()).OooO0O0().o0000(((AdMaterials.FileMaterials) ref$ObjectRef.element).url).o000000O(new o00O0O() { // from class: com.fastad.csj.half.flow.CsjFlowExpressTemplateV4$showImageOrVideo$3$1
        ...
        csjVideoPlayLayout2.setVideoPlayListener(new CsjOnVideoPlayListener() { // from class: com.fastad.csj.half.flow.CsjFlowExpressTemplateV4$showImageOrVideo$4$1
    ...
    public void formatCloseTemplate() {
        CsjFlowExpressAdActionListener adActionListener;
        ViewGroup adView = getAdView();
    ...
    public void generateAdView(Activity activity, CsjFlowExpressAdActionListener csjFlowExpressAdActionListener) throws IllegalStateException {
        ...
        View viewInflate = LayoutInflater.from(activity).inflate(R.layout.csj_flow_express_v4_layout, (ViewGroup) null);
        if (viewInflate == null) {
