...
public final class BuildConfig {
    ...
    public static final String LIBRARY_PACKAGE_NAME = "com.hihonor.ads.identifier";
    public static final boolean RELEASE_VERSION = true;
    public static final String SDK_VERSION = "1.0.3.300";
    public static final String SDK_VERSION_CODE = "10003300";
