...
class FloatingActionButtonImpl {
    ...
    private AnimatorSet createAnimator(@NonNull MotionSpec motionSpec, float f, float f2, float f3) {
        ...
        motionSpec.getTiming(j.c).apply(objectAnimatorOfFloat2);
        ...
        motionSpec.getTiming(j.c).apply(objectAnimatorOfFloat3);
    ...
    void hide(@Nullable final InternalVisibilityChangedListener internalVisibilityChangedListener, final boolean z) {
        ...
        AnimatorSet animatorSetCreateAnimator = motionSpec != null ? createAnimator(motionSpec, 0.0f, 0.0f, 0.0f) : createDefaultAnimator(0.0f, 0.4f, 0.4f, HIDE_ANIM_DURATION_ATTR, HIDE_ANIM_EASING_ATTR);
        ...
        if (arrayList != null) {
            ...
            while (it2.hasNext()) {
                animatorSetCreateAnimator.addListener(it2.next());
            }
        }
