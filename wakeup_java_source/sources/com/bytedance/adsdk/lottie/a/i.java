...
class i {
    static com.bytedance.adsdk.lottie.model.a h(JsonReader jsonReader, com.bytedance.adsdk.lottie.je jeVar) {
                ...
                case "data":
                    ...
                    while (jsonReader.hasNext()) {
                        if ("shapes".equals(jsonReader.nextName())) {
                            ...
                            while (jsonReader.hasNext()) {
                                arrayList.add((com.bytedance.adsdk.lottie.model.bj.vq) u.h(jsonReader, jeVar));
                            }
                            jsonReader.endArray();
                        } else {
