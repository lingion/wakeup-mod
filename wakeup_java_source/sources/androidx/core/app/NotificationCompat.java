...
public class NotificationCompat {
    ...
    public static class BigPictureStyle extends Style {
        ...
        private static IconCompat asIconCompat(Parcelable parcelable) {
            ...
            if (Build.VERSION.SDK_INT >= 23 && o00oO0o.OooO00o(parcelable)) {
                return IconCompat.createFromIcon(o0ooOOo.OooO00o(parcelable));
            }
    ...
    public static class Builder {
        ...
        public Builder(Context context, Notification notification) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && (parcelableArrayList = notification.extras.getParcelableArrayList(NotificationCompat.EXTRA_PEOPLE_LIST)) != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it3.hasNext()) {
                    addPerson(Person.fromAndroidPerson(oo000o.OooO00o(it3.next())));
                }
            }
            int i = Build.VERSION.SDK_INT;
        ...
        public RemoteViews createHeadsUpContentView() {
            ...
            Notification notificationBuild = notificationCompatBuilder.build();
            return i >= 24 ? Api24Impl.createHeadsUpContentView(Api24Impl.recoverBuilder(this.mContext, notificationBuild)) : notificationBuild.headsUpContentView;
        }
    ...
    public static class CallStyle extends Style {
        ...
        private Action makeNegativeAction() {
            ...
            return pendingIntent == null ? makeAction(i, R.string.call_notification_hang_up_action, this.mDeclineButtonColor, R.color.call_notification_decline_color, this.mHangUpIntent) : makeAction(i, R.string.call_notification_decline_action, this.mDeclineButtonColor, R.color.call_notification_decline_color, pendingIntent);
        }
        ...
        protected void restoreFromCompatExtras(Bundle bundle) {
            ...
            if (i >= 28 && bundle.containsKey(NotificationCompat.EXTRA_CALL_PERSON)) {
                this.mPerson = Person.fromAndroidPerson(oo000o.OooO00o(bundle.getParcelable(NotificationCompat.EXTRA_CALL_PERSON)));
            ...
            if (i >= 23 && bundle.containsKey(NotificationCompat.EXTRA_VERIFICATION_ICON)) {
                this.mVerificationIcon = IconCompat.createFromIcon(o0ooOOo.OooO00o(bundle.getParcelable(NotificationCompat.EXTRA_VERIFICATION_ICON)));
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) throws Resources.NotFoundException {
            int iMin;
            int i = 0;
        ...
        public static List<CharSequence> getTextsFromContentView(Context context, Notification notification) throws PackageManager.NameNotFoundException {
            if (!o0Oo0oo.OooO00o().getName().equals(notification.extras.getString(NotificationCompat.EXTRA_TEMPLATE))) {
    ...
    public static abstract class Style {
        ...
        private static Style constructCompatStyleByPlatformName(String str) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                if (str.equals(oo0o0Oo.OooO00o().getName())) {
                    return new MessagingStyle();
                }
                if (str.equals(o0Oo0oo.OooO00o().getName())) {
                    return new DecoratedCustomViewStyle();
                }
            }
            return null;
    ...
    public static List<Person> getPeople(Notification notification) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (parcelableArrayList != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it2.hasNext()) {
                    arrayList.add(Person.fromAndroidPerson(oo000o.OooO00o(it2.next())));
                }
            }
        } else {
    ...
    public static class MessagingStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (i >= 24) {
                ...
                while (it2.hasNext()) {
                    Api24Impl.addMessage(o0OO00O.OooO00o(messagingStyleCreateMessagingStyle), it2.next().toAndroidMessage());
                }
                if (Build.VERSION.SDK_INT >= 26) {
                    Iterator<Message> it3 = this.mHistoricMessages.iterator();
                    while (it3.hasNext()) {
                        Api26Impl.addHistoricMessage(o0OO00O.OooO00o(messagingStyleCreateMessagingStyle), it3.next().toAndroidMessage());
                    }
                }
                if (this.mIsGroupConversation.booleanValue() || Build.VERSION.SDK_INT >= 28) {
                    Api24Impl.setConversationTitle(o0OO00O.OooO00o(messagingStyleCreateMessagingStyle), this.mConversationTitle);
                }
                if (Build.VERSION.SDK_INT >= 28) {
                    Api28Impl.setGroupConversation(o0OO00O.OooO00o(messagingStyleCreateMessagingStyle), this.mIsGroupConversation.booleanValue());
                }
            ...
            for (int size = this.mMessages.size() - 1; size >= 0; size--) {
                ...
                if (size != this.mMessages.size() - 1) {
                    spannableStringBuilder.insert(0, (CharSequence) a.c);
                }
