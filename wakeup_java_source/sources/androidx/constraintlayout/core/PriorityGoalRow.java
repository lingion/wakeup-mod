    ...
    class GoalVariableAccessor {
        ...
        public boolean addToGoal(SolverVariable solverVariable, float f) {
            ...
            for (int i2 = 0; i2 < 9; i2++) {
                float[] fArr = this.mVariable.mGoalStrengthVector;
                float f4 = fArr[i2] + (solverVariable.mGoalStrengthVector[i2] * f);
                fArr[i2] = f4;
        ...
        public String toString() {
            ...
            if (this.mVariable != null) {
                for (int i = 0; i < 9; i++) {
                    str = str + this.mVariable.mGoalStrengthVector[i] + ServerSentEventKt.SPACE;
                }
            }
    ...
    */
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.mNumGoals; i++) {
            ...
            str = str + this.mAccessor + ServerSentEventKt.SPACE;
        }
        return str;
    }
