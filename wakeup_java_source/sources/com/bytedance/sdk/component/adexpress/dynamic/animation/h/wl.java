...
public class wl extends a {
    public wl(View view, com.bytedance.sdk.component.adexpress.dynamic.cg.h hVar) {
        super(view, hVar);
    }

    @Override // com.bytedance.sdk.component.adexpress.dynamic.animation.h.a
    List<ObjectAnimator> h() {
        ObjectAnimator duration = ObjectAnimator.ofFloat(this.cg, Key.ROTATION, 0.0f, 360.0f).setDuration((int) (this.bj.rb() * 1000.0d));
