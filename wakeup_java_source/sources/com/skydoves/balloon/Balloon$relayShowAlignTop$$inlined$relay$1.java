...
public final class Balloon$relayShowAlignTop$$inlined$relay$1 extends Lambda implements Function0<o0OOO0o> {
    ...
    public Balloon$relayShowAlignTop$$inlined$relay$1(Balloon balloon, Balloon balloon2, View view, int i, int i2) {
        super(0);
        this.this$0 = balloon;
