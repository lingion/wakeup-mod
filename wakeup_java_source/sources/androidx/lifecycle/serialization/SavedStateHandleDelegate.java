...
final class SavedStateHandleDelegate<T> implements OooO0OO {
    ...
    public SavedStateHandleDelegate(SavedStateHandle savedStateHandle, OooOOOO serializer, String str, SavedStateConfiguration configuration, Function0<? extends T> init) {
        o0OoOo0.OooO0oO(savedStateHandle, "savedStateHandle");
    ...
    private final void registerSave(String str) {
        this.savedStateHandle.setSavedStateProvider(str, new SavedStateRegistry.SavedStateProvider() { // from class: androidx.lifecycle.serialization.OooO00o
            @Override // androidx.savedstate.SavedStateRegistry.SavedStateProvider
            public final Bundle saveState() {
                return SavedStateHandleDelegate.registerSave$lambda$1(this.f1321OooO00o);
            }
        });
    }
    ...
    public static final Bundle registerSave$lambda$1(SavedStateHandleDelegate savedStateHandleDelegate) {
        OooOOOO oooOOOO = savedStateHandleDelegate.serializer;
        Object obj = savedStateHandleDelegate.value;
        if (obj == null) {
            o0OoOo0.OooOoO0("value");
            obj = o0OOO0o.f13233OooO00o;
        }
        return SavedStateEncoderKt.encodeToSavedState(oooOOOO, obj, savedStateHandleDelegate.configuration);
    }
