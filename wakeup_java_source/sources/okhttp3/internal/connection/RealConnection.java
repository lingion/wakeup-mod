...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    private final void connectSocket(int i, int i2, Call call, EventListener eventListener) throws IOException {
        ...
        if (i3 == 1 || i3 == 2) {
            ...
            o0OoOo0.OooO0Oo(socketCreateSocket);
        } else {
        ...
        try {
            ...
            try {
                ...
                if (o0OoOo0.OooO0O0(e.getMessage(), NPE_THROW_WITH_NULL)) {
    ...
    private final void connectTls(ConnectionSpecSelector connectionSpecSelector) throws Throwable {
        ...
        try {
            o0OoOo0.OooO0Oo(sslSocketFactory);
            Socket socketCreateSocket = sslSocketFactory.createSocket(this.rawSocket, address.url().host(), address.url().port(), true);
            o0OoOo0.OooO0o0(socketCreateSocket, "null cannot be cast to non-null type javax.net.ssl.SSLSocket");
        ...
        try {
            ...
            o0OoOo0.OooO0o(sslSocketSession, "sslSocketSession");
            final Handshake handshake = companion.get(sslSocketSession);
            HostnameVerifier hostnameVerifier = address.hostnameVerifier();
            o0OoOo0.OooO0Oo(hostnameVerifier);
            if (hostnameVerifier.verify(address.url().host(), sslSocketSession)) {
                final CertificatePinner certificatePinner = address.certificatePinner();
                o0OoOo0.OooO0Oo(certificatePinner);
            ...
            throw new SSLPeerUnverifiedException(oo000o.OooOOOo("\n              |Hostname " + address.url().host() + " not verified:\n              |    certificate: " + CertificatePinner.Companion.pin(x509Certificate) + "\n              |    DN: " + x509Certificate.getSubjectDN().getName() + "\n              |    subjectAltNames: " + OkHostnameVerifier.INSTANCE.allSubjectAltNames(x509Certificate) + "\n              ", null, 1, null));
        } catch (Throwable th2) {
            th = th2;
    ...
    private final Request createTunnel(int i, int i2, Request request, HttpUrl httpUrl) throws IOException {
        ...
        while (true) {
            ...
            o0OoOo0.OooO0Oo(bufferedSource);
            ...
            o0OoOo0.OooO0Oo(responseHeaders);
            ...
            if (oo000o.Oooo0OO("close", Response.header$default(responseBuild, "Connection", null, 2, null), true)) {
    ...
    private final Request createTunnelRequest() {
        Request requestBuild = new Request.Builder().url(this.route.address().url()).method("CONNECT", null).header("Host", Util.toHostHeader(this.route.address().url(), true)).header("Proxy-Connection", "Keep-Alive").header(RequestParamsUtils.USER_AGENT_KEY, Util.userAgent).build();
    ...
    private final boolean routeMatchesAny(List<Route> list) {
        ...
        for (Route route : list) {
            ...
            if (type == type2 && this.route.proxy().type() == type2 && o0OoOo0.OooO0O0(this.route.socketAddress(), route.socketAddress())) {
                return true;
            }
        }
        return false;
    ...
    private final boolean supportsUrl(HttpUrl httpUrl) {
        ...
        if (o0OoOo0.OooO0O0(httpUrl.host(), httpUrlUrl.host())) {
            return true;
        }
    ...
    */
    ...
    public final void connectFailed$okhttp(OkHttpClient client, Route failedRoute, IOException failure) {
        ...
        o0OoOo0.OooO0oO(failure, "failure");
    ...
    public final boolean isEligible$okhttp(Address address, List<Route> list) {
        ...
        if (o0OoOo0.OooO0O0(address.url().host(), route().address().url().host())) {
            return true;
        }
