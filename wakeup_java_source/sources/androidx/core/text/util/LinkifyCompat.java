...
public final class LinkifyCompat {
    ...
    private static final Comparator<LinkSpec> COMPARATOR = new Comparator() { // from class: androidx.core.text.util.OooO00o
        ...
        while (true) {
            try {
                ...
                if (strFindAddress != null && (iIndexOf = string.indexOf(strFindAddress)) >= 0) {
                    ...
                    try {
                        linkSpec.url = com.zuoyebang.common.web.WebView.SCHEME_GEO + URLEncoder.encode(strFindAddress, "UTF-8");
                        arrayList.add(linkSpec);
