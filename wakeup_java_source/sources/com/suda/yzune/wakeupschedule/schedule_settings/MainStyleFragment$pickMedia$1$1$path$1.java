...
@kotlin.coroutines.jvm.internal.OooO0o(c = "com.suda.yzune.wakeupschedule.schedule_settings.MainStyleFragment$pickMedia$1$1$path$1", f = "MainStyleFragment.kt", l = {}, m = "invokeSuspend")
/* loaded from: classes4.dex */
final class MainStyleFragment$pickMedia$1$1$path$1 extends SuspendLambda implements Function2<o000OO, kotlin.coroutines.OooO<? super String>, Object> {
    ...
    MainStyleFragment$pickMedia$1$1$path$1(MainStyleFragment mainStyleFragment, Uri uri, Ref$ObjectRef<BufferedSource> ref$ObjectRef, Ref$ObjectRef<BufferedSink> ref$ObjectRef2, kotlin.coroutines.OooO<? super MainStyleFragment$pickMedia$1$1$path$1> oooO) {
        super(2, oooO);
    ...
    public final kotlin.coroutines.OooO<kotlin.o0OOO0o> create(Object obj, kotlin.coroutines.OooO<?> oooO) {
        return new MainStyleFragment$pickMedia$1$1$path$1(this.this$0, this.$uri, this.$bufferedSource, this.$bufferedSink, oooO);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r2v8, types: [T, okio.BufferedSink] */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Object invokeSuspend(Object obj) throws FileNotFoundException {
        ...
        try {
            ...
            File file = new File(this.this$0.requireContext().getFilesDir(), "table" + this.this$0.OooOoo().OooOO0o().getId() + "_bg_" + System.currentTimeMillis());
    ...
    public final Object invoke(o000OO o000oo2, kotlin.coroutines.OooO<? super String> oooO) {
        return ((MainStyleFragment$pickMedia$1$1$path$1) create(o000oo2, oooO)).invokeSuspend(kotlin.o0OOO0o.f13233OooO00o);
    }
}
