...
public class SideSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> implements Sheet<SideSheetCallback> {
    ...
    class StateSettlingTracker {
        private final Runnable continueSettlingRunnable = new Runnable() { // from class: com.google.android.material.sidesheet.OooO
            @Override // java.lang.Runnable
            public final void run() {
                this.f5044OooO0o0.lambda$new$0();
            }
        };
    ...
    private AccessibilityViewCommand createAccessibilityViewCommandForState(final int i) {
        return new AccessibilityViewCommand() { // from class: com.google.android.material.sidesheet.OooO0OO
            @Override // androidx.core.view.accessibility.AccessibilityViewCommand
            public final boolean perform(View view, AccessibilityViewCommand.CommandArguments commandArguments) {
                return this.f5048OooO00o.lambda$createAccessibilityViewCommandForState$2(i, view, commandArguments);
            }
        };
    }
    ...
    public void dispatchOnSlide(@NonNull View view, int i) {
        ...
        Iterator<SideSheetCallback> it2 = this.callbacks.iterator();
        while (it2.hasNext()) {
            it2.next().onSlide(view, fCalculateSlideOffset);
        }
    }
    ...
    private ValueAnimator.AnimatorUpdateListener getCoplanarFinishAnimatorUpdateListener() {
        ...
        return new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.sidesheet.OooO0o
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f5051OooO0o0.lambda$getCoplanarFinishAnimatorUpdateListener$1(marginLayoutParams, coplanarSiblingAdjacentMargin, coplanarSiblingView, valueAnimator);
            }
        };
    }
    ...
    public void setState(final int i) {
        ...
        if (weakReference == null || weakReference.get() == null) {
            ...
            runAfterLayout(this.viewRef.get(), new Runnable() { // from class: com.google.android.material.sidesheet.OooO0O0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f5047OooO0o0.lambda$setState$0(i);
                }
            });
        }
    }
    ...
    private void setSheetEdge(int i) {
        ...
        if (sheetDelegate == null || sheetDelegate.getSheetEdge() != i) {
            ...
            throw new IllegalArgumentException("Invalid sheet edge position value: " + i + ". Must be 0 or 1" + Consts.DOT);
        }
    }
