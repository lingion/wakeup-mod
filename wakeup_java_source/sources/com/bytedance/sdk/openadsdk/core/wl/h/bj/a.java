...
public class a implements com.bytedance.sdk.component.qo.h.h.cg {

    @com.bytedance.sdk.component.qo.bj.h(h = "privacy_popup_listener")
    private je.h a;
    ...
    public boolean h(Map<String, Object> map, Map<String, Object> map2, com.bytedance.sdk.component.qo.h.h hVar) {
        ...
        TTDelegateActivity.bj(this.h, this.cg, this.ta);
        hVar.h(map2);
        return true;
    }

    private je.h h() {
        return new je.h() { // from class: com.bytedance.sdk.openadsdk.core.wl.h.bj.a.1
            @Override // com.bytedance.sdk.openadsdk.core.nd.je.h
            public void onDialogBtnNo() {
                if (a.this.a == null) {
                    return;
                }
                a.this.a.onDialogBtnNo();
                a aVar = a.this;
                aVar.h(aVar.yv);
            }
