...
public class bj extends com.bytedance.sdk.component.h.ta<JSONObject, JSONObject> {
    private String bj;
    private SSWebView h;

    public bj(SSWebView sSWebView, String str) {
        this.h = sSWebView;
        this.bj = str;
    }
    ...
    public JSONObject cg() {
        ...
        try {
            if (com.bytedance.sdk.openadsdk.core.u.vq().bj(com.bytedance.sdk.openadsdk.core.uj.getContext()) && this.h != null) {
                jSONObject.put(PluginConstants.KEY_ERROR_CODE, 0);
                jSONObject.put("codeMsg", bz.o);
                this.h.h(2, com.bytedance.sdk.openadsdk.core.u.vq().ta());
                return jSONObject;
            }
    ...
    public static void h(com.bytedance.sdk.component.h.r rVar, SSWebView sSWebView, String str) {
        rVar.h("start_twist_observer", (com.bytedance.sdk.component.h.ta<?, ?>) new bj(sSWebView, str));
    }
