...
abstract class DateFormatTextWatcher extends TextWatcherAdapter {
    ...
    DateFormatTextWatcher(final String str, DateFormat dateFormat, @NonNull TextInputLayout textInputLayout, CalendarConstraints calendarConstraints) {
        ...
        this.setErrorCallback = new Runnable() { // from class: com.google.android.material.datepicker.OooO00o
            @Override // java.lang.Runnable
            public final void run() {
                this.f4997OooO0o0.lambda$new$0(str);
            }
        };
    }

    private Runnable createRangeErrorCallback(final long j) {
        return new Runnable() { // from class: com.google.android.material.datepicker.OooO0O0
            @Override // java.lang.Runnable
            public final void run() {
                this.f4999OooO0o0.lambda$createRangeErrorCallback$1(j);
            }
        };
    }
    ...
    public /* synthetic */ void lambda$new$0(String str) {
        ...
        textInputLayout.setError(context.getString(R.string.mtrl_picker_invalid_format) + a.c + String.format(context.getString(R.string.mtrl_picker_invalid_format_use), sanitizeDateString(str)) + a.c + String.format(context.getString(R.string.mtrl_picker_invalid_format_example), sanitizeDateString(dateFormat.format(new Date(UtcDates.getTodayCalendar().getTimeInMillis())))));
        onInvalidDate();
    }
