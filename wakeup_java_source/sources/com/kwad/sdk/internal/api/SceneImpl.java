...
public class SceneImpl extends com.kwad.sdk.core.response.a.a implements KsScene, Serializable, Cloneable {
    ...
    public void setAdNum(int i) {
        this.adNum = i;
        if (!com.kwad.framework.a.a.oy.booleanValue() || bs.Ub() == 0) {
            return;
        }
        this.adNum = (int) bs.Ub();
    }
    ...
    public void setPosId(long j) {
        this.posId = j;
        this.entryScene = j;
        if (!com.kwad.framework.a.a.oy.booleanValue() || bs.getPosId() == 0) {
            return;
        }
