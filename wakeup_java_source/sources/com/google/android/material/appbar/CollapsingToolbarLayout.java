...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    private void updateTextBounds(int i, int i2, int i3, int i4, boolean z) throws NoSuchMethodException, SecurityException {
        View view;
        if (!this.collapsingTitleEnabled || (view = this.dummyView) == null) {
            return;
        }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) throws NoSuchMethodException, SecurityException {
    ...
    protected void onMeasure(int i, int i2) throws NoSuchMethodException, SecurityException {
        ensureToolbar();
