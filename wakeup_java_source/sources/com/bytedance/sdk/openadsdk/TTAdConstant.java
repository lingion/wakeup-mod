...
public class TTAdConstant {
    ...
    public static final int AD_EVENT_APP_INSTALL_TYPE = 101;
    public static final int AD_EVENT_APP_OPEN_TYPE = 102;
    public static final int AD_EVENT_APP_UN_FINISH_TYPE = 103;
    public static final int AD_EVENT_AUTH_DOUYIN = 1;
    public static final int AD_EVENT_CONVERT_CLICK_TYPE = 100;
    public static final int AD_EVENT_EXCHANGE_COUPON_FINISH = 4;
    public static final int AD_EVENT_FEED_REWARD = 2;
    public static final int AD_EVENT_LIVE_TASK_FINISH = 3;
    public static final int AD_EVENT_MALL_REACH_BOUND = 200;
    ...
    public enum RitScenes {
        ...
        GAME_MORE_KLLKRTUNITIES(TTAdConstant.bj("game_more_kllkrtunities")),
