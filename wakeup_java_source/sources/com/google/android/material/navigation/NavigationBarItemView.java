...
public abstract class NavigationBarItemView extends FrameLayout implements MenuView.ItemView {
    ...
    private static class ActiveIndicatorTransform {
        ...
        protected float calculateAlpha(@FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = Contrast.RATIO_MIN) float f, @FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = Contrast.RATIO_MIN) float f2) {
            return AnimationUtils.lerp(0.0f, 1.0f, f2 == 0.0f ? 0.8f : 0.0f, f2 == 0.0f ? 1.0f : 0.2f, f);
        }

        protected float calculateScaleX(@FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = Contrast.RATIO_MIN) float f, @FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = Contrast.RATIO_MIN) float f2) {
            return AnimationUtils.lerp(SCALE_X_HIDDEN, 1.0f, f);
        }

        protected float calculateScaleY(@FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = Contrast.RATIO_MIN) float f, @FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = Contrast.RATIO_MIN) float f2) {
            return 1.0f;
        }

        public void updateForProgress(@FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = Contrast.RATIO_MIN) float f, @FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = Contrast.RATIO_MIN) float f2, @NonNull View view) {
    ...
    private void maybeAnimateActiveIndicatorToProgress(@FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = Contrast.RATIO_MIN) final float f) {
    ...
    public void setActiveIndicatorProgress(@FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = Contrast.RATIO_MIN) float f, float f2) {
    ...
    private static void setTextAppearanceWithoutFontScaling(TextView textView, @StyleRes int i) throws Resources.NotFoundException {
