...
public final class p extends a implements View.OnClickListener, com.kwad.sdk.widget.d {
    ...
    private void d(View view, final int i) {
        if (view == this.hC) {
            ...
            com.kwad.components.core.e.d.a.a(new a.C0339a(getContext()).aE(this.mAdTemplate).aB(5).aC(i).b(this.mApkDownloadHelper).aD(view == this.hH ? 1 : 2).as(view == this.hH).a(new a.b() { // from class: com.kwad.components.ad.feed.widget.p.1
