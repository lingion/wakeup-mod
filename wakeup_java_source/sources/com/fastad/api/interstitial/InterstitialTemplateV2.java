...
public final class InterstitialTemplateV2 extends BaseInterstitialTemplate {
    private VideoPlayLayout adVideo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public InterstitialTemplateV2(ApiAdModel apiAdModel, AdSlot apiAdSlot) {
    ...
    public void showAd(Activity activity, InterstitialAdActionListener interstitialAdActionListener) {
        ...
        setParentView(LayoutInflater.from(activity).inflate(R.layout.interstitial_v2_layout, (ViewGroup) null));
        ...
        View parentView2 = getParentView();
        VideoPlayLayout videoPlayLayout = parentView2 != null ? (VideoPlayLayout) parentView2.findViewById(R.id.id_ad_video) : null;
        this.adVideo = videoPlayLayout;
        setFileMaterials(imageView, videoPlayLayout, "10006");
    }
}
