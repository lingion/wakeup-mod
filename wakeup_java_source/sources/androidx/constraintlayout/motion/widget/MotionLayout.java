...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    private class DevModeDraw {
        ...
        public void draw(Canvas canvas, HashMap<View, MotionController> map, int i, int i2) {
            ...
            if (!MotionLayout.this.isInEditMode() && (i2 & 1) == 2) {
                String str = MotionLayout.this.getContext().getResources().getResourceName(MotionLayout.this.mEndState) + ServerSentEventKt.COLON + MotionLayout.this.getProgress();
    ...
    class Model {
        ...
        private void debugLayout(String str, ConstraintWidgetContainer constraintWidgetContainer) {
            String str2 = str + ServerSentEventKt.SPACE + Debug.getName((View) constraintWidgetContainer.getCompanionWidget());
            ...
            for (int i = 0; i < size; i++) {
                ...
                String str4 = PluginHandle.UNDERLINE;
                sb2.append(constraintAnchor != null ? ExifInterface.GPS_DIRECTION_TRUE : PluginHandle.UNDERLINE);
                String string = sb2.toString();
                StringBuilder sb3 = new StringBuilder();
                sb3.append(string);
                sb3.append(constraintWidget.mBottom.mTarget != null ? "B" : PluginHandle.UNDERLINE);
                String string2 = sb3.toString();
                StringBuilder sb4 = new StringBuilder();
                sb4.append(string2);
                sb4.append(constraintWidget.mLeft.mTarget != null ? "L" : PluginHandle.UNDERLINE);
                ...
                sb6.append("  ");
                sb6.append(name);
                sb6.append(ServerSentEventKt.SPACE);
    ...
    public void setupMotionViews() {
        ...
        if (staggered != 0.0f) {
            boolean z = ((double) staggered) < IDataEditor.DEFAULT_NUMBER_VALUE;
