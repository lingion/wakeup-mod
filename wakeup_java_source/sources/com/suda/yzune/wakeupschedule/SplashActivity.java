...
public final class SplashActivity extends BaseInitPrivacyCheckActivity implements o00OO0.OooO0O0 {
    ...
    private final void o0ooOOo() {
        ...
        if (!com.baidu.homework.common.utils.OooOo.OooO0O0(CommonPreference.IS_REPORT_FIRST_LAUNCH)) {
            o00oO0O();
            return;
        }
        if (!com.suda.yzune.wakeupschedule.aaa.utils.OooOOOO.OooO0O0()) {
            o000O.OooO0OO("InitActivity", "not showAd,jumpMainPage");
            SystemClock.elapsedRealtime();
            o00oO0O();
            return;
        }
        this.f6643OooO0oo = true;
        o000O.OooO0OO("InitActivity", "showAd");
        AppLaunchProxy.getAppLaunch().addTag("showAd");
        AppLaunchProxy.getAppLaunch().reportAppFullLaunch();
        Lifecycle lifecycle = getLifecycle();
        kotlin.jvm.internal.o0OoOo0.OooO0o(lifecycle, "<get-lifecycle>(...)");
        o00O0oO.Oooo0.OooO00o(this, lifecycle, new OooO0OO());
    }
