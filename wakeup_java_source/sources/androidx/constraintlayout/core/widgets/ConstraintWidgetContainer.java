...
public class ConstraintWidgetContainer extends WidgetContainer {
    ...
    public boolean addChildrenToSolver(LinearSystem linearSystem) {
        ...
        while (this.mWidgetsToAdd.size() > 0) {
            ...
            if (size2 == this.mWidgetsToAdd.size()) {
                Iterator<ConstraintWidget> it3 = this.mWidgetsToAdd.iterator();
                while (it3.hasNext()) {
                    it3.next().addToSolver(linearSystem, zOptimizeFor);
                }
                this.mWidgetsToAdd.clear();
            }
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:154:0x0312 A[PHI: r2 r16
      0x0312: PHI (r2v14 boolean) = (r2v13 boolean), (r2v18 boolean), (r2v18 boolean), (r2v18 boolean) binds: [B:141:0x02d3, B:149:0x02f8, B:150:0x02fa, B:152:0x0300] A[DONT_GENERATE, DONT_INLINE]
