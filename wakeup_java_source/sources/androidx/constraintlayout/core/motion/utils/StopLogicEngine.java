...
public class StopLogicEngine implements StopEngine {
    ...
    public String debug(String str, float f) {
        String str2 = str + " ===== " + this.mType + a.c;
        ...
        sb.append(a.c);
        String str3 = sb.toString() + str + " dur " + this.mStage1Duration + " vel " + this.mStage1Velocity + " pos " + this.mStage1EndPosition + a.c;
        if (this.mNumberOfStages > 1) {
            str3 = str3 + str + " dur " + this.mStage2Duration + " vel " + this.mStage2Velocity + " pos " + this.mStage2EndPosition + a.c;
        }
        if (this.mNumberOfStages > 2) {
            str3 = str3 + str + " dur " + this.mStage3Duration + " vel " + this.mStage3Velocity + " pos " + this.mStage3EndPosition + a.c;
        }
        float f2 = this.mStage1Duration;
        if (f <= f2) {
    ...
    public static class Decelerate implements StopEngine {
        ...
        @Override // androidx.constraintlayout.core.motion.utils.StopEngine
        public String debug(String str, float f) {
            return this.mDuration + ServerSentEventKt.SPACE + this.mLastVelocity;
        }
