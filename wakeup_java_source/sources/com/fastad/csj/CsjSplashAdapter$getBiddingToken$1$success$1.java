...
@OooO0o(c = "com.fastad.csj.CsjSplashAdapter$getBiddingToken$1$success$1", f = "CsjSplashAdapter.kt", l = {MediaPlayer.MEDIA_PLAYER_OPTION_ABR_PROBE_COUNT, MediaPlayer.MEDIA_PLAYER_OPTION_ABR_PROBE_COUNT, MediaPlayer.MEDIA_PLAYER_OPTION_ABR_PROBE_COUNT}, m = "invokeSuspend")
/* loaded from: classes3.dex */
final class CsjSplashAdapter$getBiddingToken$1$success$1 extends SuspendLambda implements Function2<o000OO, OooO<? super o0OOO0o>, Object> {
    final /* synthetic */ o00Ooo $callback;
    final /* synthetic */ CodePos $codePos;
    final /* synthetic */ Ref$ObjectRef<String> $token;
    Object L$0;
    int label;
    final /* synthetic */ CsjSplashAdapter this$0;

    @OooO0o(c = "com.fastad.csj.CsjSplashAdapter$getBiddingToken$1$success$1$1", f = "CsjSplashAdapter.kt", l = {}, m = "invokeSuspend")
    /* renamed from: com.fastad.csj.CsjSplashAdapter$getBiddingToken$1$success$1$1, reason: invalid class name */
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    CsjSplashAdapter$getBiddingToken$1$success$1(Ref$ObjectRef<String> ref$ObjectRef, CsjSplashAdapter csjSplashAdapter, CodePos codePos, o00Ooo o00ooo2, OooO<? super CsjSplashAdapter$getBiddingToken$1$success$1> oooO) {
        super(2, oooO);
        this.$token = ref$ObjectRef;
        this.this$0 = csjSplashAdapter;
    ...
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final OooO<o0OOO0o> create(Object obj, OooO<?> oooO) {
        return new CsjSplashAdapter$getBiddingToken$1$success$1(this.$token, this.this$0, this.$codePos, this.$callback, oooO);
    }
        ...
        if (i == 0) {
            ...
            try {
                try {
                    ...
                    ref$ObjectRef.element = aDManger == null ? 0 : aDManger.getBiddingToken(this.this$0.getAdSlot(this.$codePos, null), true, 3);
    ...
    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(o000OO o000oo2, OooO<? super o0OOO0o> oooO) {
        return ((CsjSplashAdapter$getBiddingToken$1$success$1) create(o000oo2, oooO)).invokeSuspend(o0OOO0o.f13233OooO00o);
    }
}
