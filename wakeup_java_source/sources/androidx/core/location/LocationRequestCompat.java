...
public final class LocationRequestCompat {
    ...
    @FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = 3.4028234663852886E38d)
    ...
    public String toString() {
        ...
        if (this.mMinUpdateDistanceMeters > IDataEditor.DEFAULT_NUMBER_VALUE) {
    ...
    public LocationRequest toLocationRequest(String str) {
        return Build.VERSION.SDK_INT >= 31 ? toLocationRequest() : o0000O0O.OooO00o(Api19Impl.toLocationRequest(this, str));
    }
    ...
    public static final class Builder {
        ...
        public Builder setMinUpdateDistanceMeters(@FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = 3.4028234663852886E38d) float f) {
            this.mMinUpdateDistanceMeters = f;
