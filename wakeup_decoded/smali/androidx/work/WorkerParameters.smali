...
.field private mWorkerContext:Lkotlin/coroutines/OooOOO;
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
.end field
...
.method public constructor <init>(Ljava/util/UUID;Landroidx/work/Data;Ljava/util/Collection;Landroidx/work/WorkerParameters$RuntimeExtras;IILjava/util/concurrent/Executor;Lkotlin/coroutines/OooOOO;Landroidx/work/impl/utils/taskexecutor/TaskExecutor;Landroidx/work/WorkerFactory;Landroidx/work/ProgressUpdater;Landroidx/work/ForegroundUpdater;)V
    ...
    .param p7    # Ljava/util/concurrent/Executor;
        ...
        .end annotation
    .end param
    .param p8    # Lkotlin/coroutines/OooOOO;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    .param p9    # Landroidx/work/impl/utils/taskexecutor/TaskExecutor;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    .param p10    # Landroidx/work/WorkerFactory;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    .param p11    # Landroidx/work/ProgressUpdater;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    .param p12    # Landroidx/work/ForegroundUpdater;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    ...
    .line 22
    .line 23
    iput-object p8, p0, Landroidx/work/WorkerParameters;->mWorkerContext:Lkotlin/coroutines/OooOOO;
...
.method public getWorkerContext()Lkotlin/coroutines/OooOOO;
    .locals 1
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
    ...
    .line 1
    iget-object v0, p0, Landroidx/work/WorkerParameters;->mWorkerContext:Lkotlin/coroutines/OooOOO;
