...
public final class WindowInsetsAnimationCompat {
    ...
    public void setFraction(@FloatRange(from = IDataEditor.DEFAULT_NUMBER_VALUE, to = Contrast.RATIO_MIN) float f) {
    ...
    private static class Impl30 extends Impl {
        ...
        private static class ProxyCallback extends WindowInsetsAnimation.Callback {
            ...
            public WindowInsets onProgress(WindowInsets windowInsets, List<WindowInsetsAnimation> list) {
                ...
                for (int size = list.size() - 1; size >= 0; size--) {
                    WindowInsetsAnimation windowInsetsAnimationOooO00o = o00.OooO00o(list.get(size));
                    WindowInsetsAnimationCompat windowInsetsAnimationCompat = getWindowInsetsAnimationCompat(windowInsetsAnimationOooO00o);
                    windowInsetsAnimationCompat.setFraction(windowInsetsAnimationOooO00o.getFraction());
        ...
        public static WindowInsetsAnimation.Bounds createPlatformBounds(BoundsCompat boundsCompat) {
            o000Oo0.OooO00o();
            return o000O0o.OooO00o(boundsCompat.getLowerBound().toPlatformInsets(), boundsCompat.getUpperBound().toPlatformInsets());
        }
        ...
        Impl30(int i, Interpolator interpolator, long j) {
            this(o000O000.OooO00o(i, interpolator, j));
        }
    }
