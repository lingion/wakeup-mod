...
abstract class SheetDialog<C extends SheetCallback> extends AppCompatDialog {
    ...
    SheetDialog(@NonNull Context context, @StyleRes int i, @AttrRes int i2, @StyleRes int i3) {
    ...
    private View wrapInSheet(int i, @Nullable View view, @Nullable ViewGroup.LayoutParams layoutParams) {
        ...
        coordinatorLayout.findViewById(TOUCH_OUTSIDE_ID).setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.sidesheet.OooO00o
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                this.f5045OooO0o0.lambda$wrapInSheet$0(view2);
            }
        });
