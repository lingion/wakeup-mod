...
public class ConstraintLayout extends ViewGroup {
    ...
    private void init(AttributeSet attributeSet, int i, int i2) throws XmlPullParserException, IOException, NumberFormatException {
    ...
    protected boolean dynamicUpdateConstraints(int i, int i2) {
        ...
        while (it2.hasNext()) {
            ValueModifier next = it2.next();
            Iterator<ConstraintWidget> it3 = this.mLayoutWidget.getChildren().iterator();
            while (it3.hasNext()) {
                View view = (View) it3.next().getCompanionWidget();
    ...
    public void resolveMeasuredDimension(int i, int i2, int i3, int i4, boolean z, boolean z2) {
        ...
        int iResolveSizeAndState = View.resolveSizeAndState(i3 + measurer.mPaddingWidth, i, 0);
    ...
    public void resolveSystem(ConstraintWidgetContainer constraintWidgetContainer, int i, int i2, int i3) {
        ...
        this.mMeasurer.captureLayoutInfo(i2, i3, iMax, iMax2, paddingWidth, i4);
        ...
        constraintWidgetContainer.measure(i, mode, i5, mode2, i6, this.mLastMeasureWidth, this.mLastMeasureHeight, iMax5, iMax);
    }
    ...
    */
    ...
    public ConstraintLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) throws XmlPullParserException, IOException, NumberFormatException {
    ...
    @TargetApi(21)
    public ConstraintLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i2) throws XmlPullParserException, IOException, NumberFormatException {
