...
import com.bytedance.sdk.openadsdk.vq.h.h.u;
...
public class h implements Function<SparseArray<Object>, Object> {
    private final TTAdNative.DrawFeedAdListener h;

    public h(TTAdNative.DrawFeedAdListener drawFeedAdListener) {
        this.h = drawFeedAdListener;
    }
    ...
    public Object apply(SparseArray<Object> sparseArray) {
        ...
        switch (valueSetOooO00o.intValue(-99999987)) {
            ...
            case 172102:
                ...
                while (it2.hasNext()) {
                    arrayList2.add(new u(OooO00o.OooO00o(it2.next())));
                }
                this.h.onDrawFeedAdLoad(arrayList2);
                return null;
            default:
                return null;
        }
