...
public final class KsFlowExpressTemplateV1 extends KsBaseFlowExpressTemplate {
    ...
    public KsFlowExpressTemplateV1(KsNativeAd ksAd, SdkRenderAdModel sdkRenderAdModel, AdSlot adSlot) {
        super(adSlot);
    ...
    private final void dealAdView() {
        ...
        int iOooO00o = getAdSlot().getHeight() == 0 ? OooOo00.OooO00o(96.0f) : OooOo00.OooO00o(getAdSlot().getHeight());
    ...
    private final void showImageOrVideo() throws IllegalStateException {
        ...
        this.videoLayout = adView3 == null ? null : (KsVideoPlayLayout) adView3.findViewById(R.id.id_ad_video);
        ...
        if (((AdMaterials.FileMaterials) ref$ObjectRef.element).fileType == 1) {
            ...
            OooO0OO.OooOo0(imageView.getContext()).OooO0O0().o0000(((AdMaterials.FileMaterials) ref$ObjectRef.element).url).o000000O(new o00O0O() { // from class: com.fastad.ks.half.flow.KsFlowExpressTemplateV1$showImageOrVideo$3$1
    ...
    public void generateAdView(Activity activity, KsFlowExpressAdActionListener ksFlowExpressAdActionListener) throws IllegalStateException {
        ...
        View viewInflate = LayoutInflater.from(activity).inflate(R.layout.ks_flow_express_v1_layout, (ViewGroup) null);
        if (viewInflate == null) {
