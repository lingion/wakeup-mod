...
@kotlin.coroutines.jvm.internal.OooO0o(c = "com.suda.yzune.wakeupschedule.settings.AdvancedSettingsActivity$pickMedia$1$1$path$1", f = "AdvancedSettingsActivity.kt", l = {}, m = "invokeSuspend")
/* loaded from: classes4.dex */
final class AdvancedSettingsActivity$pickMedia$1$1$path$1 extends SuspendLambda implements Function2<kotlinx.coroutines.o000OO, kotlin.coroutines.OooO<? super String>, Object> {
    ...
    AdvancedSettingsActivity$pickMedia$1$1$path$1(AdvancedSettingsActivity advancedSettingsActivity, Uri uri, Ref$ObjectRef<BufferedSource> ref$ObjectRef, Ref$ObjectRef<BufferedSink> ref$ObjectRef2, kotlin.coroutines.OooO<? super AdvancedSettingsActivity$pickMedia$1$1$path$1> oooO) {
        super(2, oooO);
    ...
    public final kotlin.coroutines.OooO<kotlin.o0OOO0o> create(Object obj, kotlin.coroutines.OooO<?> oooO) {
        return new AdvancedSettingsActivity$pickMedia$1$1$path$1(this.this$0, this.$uri, this.$bufferedSource, this.$bufferedSink, oooO);
    }
    ...
    public final Object invoke(kotlinx.coroutines.o000OO o000oo2, kotlin.coroutines.OooO<? super String> oooO) {
        return ((AdvancedSettingsActivity$pickMedia$1$1$path$1) create(o000oo2, oooO)).invokeSuspend(kotlin.o0OOO0o.f13233OooO00o);
    }
}
