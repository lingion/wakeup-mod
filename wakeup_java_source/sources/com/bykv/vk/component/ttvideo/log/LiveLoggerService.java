...
public class LiveLoggerService implements Handler.Callback {
    ...
    private final long mNTPInterval = PeriodicWorkRequest.MIN_PERIODIC_FLEX_MILLIS;
                ...
                public void handleMessage(Message message) {
                    ...
                    if (message.what == 103) {
                        ...
                        if (liveLoggerService.mNTPRunning) {
                            MyNTPTask.this.mHandler.sendEmptyMessageDelayed(103, PeriodicWorkRequest.MIN_PERIODIC_FLEX_MILLIS);
                        }
                    }
                }
            };
    ...
    private void checkSeiIndex(int i) throws JSONException {
    ...
    private void checkVideoFrame(int i, int i2, long j) throws JSONException {
    ...
    private void onLink(boolean z) throws JSONException {
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                jSONObjectCreateCommonLog.put("event_key", "link").put("info", z ? "start" : "end");
    ...
    private void onStreamAbnormalFrame(int i, int i2, int i3) throws JSONException {
    ...
    private void onStreamAbnormalSEI(int i, int i2, int i3) throws JSONException {
        JSONObject jSONObjectCreateCommonLog;
        if (this.mLiveEngine == null || (jSONObjectCreateCommonLog = createCommonLog()) == null) {
            return;
        }
    ...
    private void updateRequestTimeFieldInRtcPlay(JSONObject jSONObject) {
        if (jSONObject.has("event_message")) {
            ...
            if (TextUtils.equals("tls handshaked", strOptString)) {
            ...
            if (TextUtils.equals("response received", strOptString) || TextUtils.equals("remote answer got", strOptString)) {
    ...
    public void calculateRenderFailType() {
        ...
        long j = logBundle.audioRenderTimestamp;
        if (j > 0 && logBundle.videoRenderTimestamp > 0) {
            this.mRenderFailType = 0;
            return;
        }
        if (j > 0 && logBundle.videoRenderTimestamp <= 0) {
            this.mRenderFailType = 1;
        } else if (j > 0 || logBundle.videoRenderTimestamp <= 0) {
    ...
    public JSONObject createCommonLog() throws JSONException {
        ...
        try {
            ...
            if (map != null) {
                ...
                while (true) {
                    ...
                    if (next.getKey().equals("Host")) {
                        jSONObjectPut11.put("headers_host", next.getValue().replace(ServerSentEventKt.SPACE, ""));
                        break;
                    }
                }
            }
            ...
            if (i2 != -1) {
                jSONObjectPut11.put("fcdn_res_type", i2);
            }
            return jSONObjectPut11;
        } catch (JSONException e) {
            l.h(e);
            return null;
        }
    ...
    public JSONObject getLiveInfoItems() {
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            Iterator<Long> it2 = this.mDownloadSpeedTimeSeries.iterator();
            while (it2.hasNext()) {
                lValueOf = Long.valueOf(lValueOf.longValue() + it2.next().longValue());
            }
            lValueOf = Long.valueOf(lValueOf.longValue() / this.mDownloadSpeedTimeSeries.size());
        }
        try {
    ...
    public JSONObject getStaticLog() throws JSONException {
    ...
    public void onError(int i, String str) throws JSONException {
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                jSONObjectCreateCommonLog.put("event_key", com.component.feed.a.i).put(PluginConstants.KEY_ERROR_CODE, i).put("info", str);
    ...
    public void onErrorRecovered() {
        ...
        l.h(TAG, "recover from error time ".concat(String.valueOf(System.currentTimeMillis() - this.mErrorStartTime)));
    ...
    public void onFirstFrameFail(int i) throws JSONException {
        VideoLiveManager videoLiveManager;
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                jSONObjectCreateCommonLog.put("event_key", "first_frame_failed").put("start_time", System.currentTimeMillis()).put(MediationConstant.KEY_REASON, i);
                reportQuicOpenResult(jSONObjectCreateCommonLog);
                this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
                long j = this.mLogTotalCount;
                if (j > 0) {
    ...
    public void onLoaderError(int i, String str) {
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                jSONObjectCreateCommonLog.put("event_key", "p2p_error").put("error_msg", str).put(PluginConstants.KEY_ERROR_CODE, i);
                this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
                long j = this.mLogTotalCount;
                if (j > 0) {
                    this.mLogTotalCount = j + 1;
    ...
    public void onLoaderSwitch(int i, String str) {
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                ...
                jSONObjectCreateCommonLog.put("event_key", "p2p_switch").put("switch_info", str).put("p2p_vendor", "none").put(MediationConstant.KEY_REASON, i);
                this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
                long j = this.mLogTotalCount;
                if (j > 0) {
                    this.mLogTotalCount = j + 1;
    ...
    */
    public void onPrepare(int r12) {
        ...
        L26:
            if (r0 == 0) goto Lc8
            long r4 = r11.mFirstAudioPacketDTS     // Catch: org.json.JSONException -> L3d
            r6 = 0
            r1 = 0
            int r8 = (r4 > r6 ? 1 : (r4 == r6 ? 0 : -1))
            if (r8 <= 0) goto L40
            long r8 = r11.mPreviousAudioPacketDTS     // Catch: org.json.JSONException -> L3d
        ...
        L41:
            ...
            org.json.JSONObject r5 = r0.put(r5, r8)     // Catch: org.json.JSONException -> L3d
            java.lang.String r8 = "error_msg"
            if (r12 == 0) goto L54
            com.bykv.vk.component.ttvideo.VideoLiveManager r9 = r11.mLiveEngine     // Catch: org.json.JSONException -> L3d
            java.lang.String r9 = r9.getPlayerErrorInfo()     // Catch: org.json.JSONException -> L3d
            goto L55
        L54:
            r9 = r2
        L55:
            org.json.JSONObject r5 = r5.put(r8, r9)     // Catch: org.json.JSONException -> L3d
            java.lang.String r8 = "result"
            org.json.JSONObject r12 = r5.put(r8, r12)     // Catch: org.json.JSONException -> L3d
            java.lang.String r5 = "sdk_params"
            java.lang.String r8 = r11.mSdkParams     // Catch: org.json.JSONException -> L3d
            if (r8 != 0) goto L66
            goto L67
        L66:
            r2 = r8
        L67:
            org.json.JSONObject r12 = r12.put(r5, r2)     // Catch: org.json.JSONException -> L3d
            java.lang.String r2 = "first_audio_packet_dts_rollback"
            org.json.JSONObject r12 = r12.put(r2, r4)     // Catch: org.json.JSONException -> L3d
            java.lang.String r2 = "first_audio_packet_dts"
            long r4 = r11.mFirstAudioPacketDTS     // Catch: org.json.JSONException -> L3d
            org.json.JSONObject r12 = r12.put(r2, r4)     // Catch: org.json.JSONException -> L3d
            java.lang.String r2 = "previous_audio_packet_dts"
            long r4 = r11.mPreviousAudioPacketDTS     // Catch: org.json.JSONException -> L3d
            org.json.JSONObject r12 = r12.put(r2, r4)     // Catch: org.json.JSONException -> L3d
            java.lang.String r2 = "stream_type"
            com.bykv.vk.component.ttvideo.log.LogBundle r4 = r11.mLogBundle     // Catch: org.json.JSONException -> L3d
            int r4 = r4.mStreamType     // Catch: org.json.JSONException -> L3d
            org.json.JSONObject r12 = r12.put(r2, r4)     // Catch: org.json.JSONException -> L3d
            java.lang.String r2 = "suggest_format"
            java.lang.String r4 = r11.mSuggestFormat     // Catch: org.json.JSONException -> L3d
            org.json.JSONObject r12 = r12.put(r2, r4)     // Catch: org.json.JSONException -> L3d
            java.lang.String r2 = "suggest_protocol"
            java.lang.String r4 = r11.mSuggestProtocol     // Catch: org.json.JSONException -> L3d
            org.json.JSONObject r12 = r12.put(r2, r4)     // Catch: org.json.JSONException -> L3d
            java.lang.String r2 = "nnsr_enabled"
            com.bykv.vk.component.ttvideo.VideoLiveManager r4 = r11.mLiveEngine     // Catch: org.json.JSONException -> L3d
            boolean r4 = r4.getSRState()     // Catch: org.json.JSONException -> L3d
            if (r4 != 0) goto Laf
            com.bykv.vk.component.ttvideo.VideoLiveManager r4 = r11.mLiveEngine     // Catch: org.json.JSONException -> L3d
            boolean r4 = r4.getSharpenState()     // Catch: org.json.JSONException -> L3d
            if (r4 == 0) goto Lae
            goto Laf
        Lae:
            r3 = 0
        Laf:
            r12.put(r2, r3)     // Catch: org.json.JSONException -> L3d
            com.bykv.vk.component.ttvideo.ILiveListener r12 = r11.mLogUploader     // Catch: org.json.JSONException -> L3d
            java.lang.String r1 = "live_client_monitor_log"
            r12.onMonitorLog(r0, r1)     // Catch: org.json.JSONException -> L3d
            long r0 = r11.mLogTotalCount     // Catch: org.json.JSONException -> L3d
            int r12 = (r0 > r6 ? 1 : (r0 == r6 ? 0 : -1))
            if (r12 <= 0) goto Lc4
            r2 = 1
            long r0 = r0 + r2
            r11.mLogTotalCount = r0     // Catch: org.json.JSONException -> L3d
        Lc4:
            return
        Lc5:
    ...
    public void onRecvedRtcTraceInfo(String str) throws JSONException {
        if (this.mLiveEngine == null || this.mLogUploader == null) {
            return;
        }
        try {
    ...
    public void onRecvedSPSPPS(String str) throws JSONException {
        if (this.mLiveEngine == null || this.mLogUploader == null) {
            return;
        }
        try {
    ...
    public void onRetry(int i) {
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                jSONObjectCreateCommonLog.put("event_key", "retry").put(MediationConstant.KEY_REASON, this.mErrorCode).put(PluginConstants.KEY_ERROR_CODE, i).put("render_fail_type", this.mRenderFailType);
                reportQuicOpenResult(jSONObjectCreateCommonLog);
                this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
                long j = this.mLogTotalCount;
                if (j > 0) {
    ...
    public void onStop(String str) throws JSONException {
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                ...
                if (j4 > 0) {
                    j2 = j4 - this.mLogBundle.videoRenderTimestamp;
                    j = this.mFirstStallEndTime - j4;
                } else {
                    j = 0;
                    j2 = 0;
                }
                ...
                if (jSONArray2 != null) {
                    jSONObjectCreateCommonLog.put("avph_stream_info", jSONArray2);
                }
                if (this.mLiveEngine.getEnableTexturerender() == 1) {
                ...
                if (z) {
                    jSONObjectCreateCommonLog.put("cdn_abr_switch_performed", z ? 1 : 0).put("cdn_abr_switch_code", this.mCdnAbrSwitchCode);
                }
                long j7 = this.mLogTotalCount + 1;
                this.mLogTotalCount = j7;
                jSONObjectCreateCommonLog.put("log_total_count_when_playing", j7);
                this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
                this.mLogTotalCount = 0L;
            } catch (JSONException e) {
                l.h(e);
    ...
    public void onSwitch(String str, String str2, String str3, int i) {
        ...
        try {
            ...
            jSONObjectPut2.put("next_cdn_play_url", str2).put("res_bitrate", this.mResBitrate).put("last_res", this.mLastResolution).put(PluginConstants.KEY_ERROR_CODE, i).put(MediationConstant.KEY_REASON, str3);
            this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
            long j = this.mLogTotalCount;
            if (j > 0) {
                this.mLogTotalCount = j + 1;
    ...
    public void onUpdateMetaData(String str) {
        ...
        try {
            JSONObject jSONObject = new JSONObject(str);
            if (jSONObject.has(PluginConstants.KEY_SDK_VERSION)) {
                this.mPushClientSDKVersion = jSONObject.getString(PluginConstants.KEY_SDK_VERSION);
            }
    ...
    public void onUpdateSeiInfo(String str) throws JSONException {
        String str2;
        String str3;
        boolean z;
        MyNTPTask myNTPTask;
        ...
        try {
            JSONObject jSONObject = new JSONObject(str);
            if (jSONObject.has(j.s)) {
                long j = jSONObject.getLong(j.s);
            ...
            if (jSONObject.has("source")) {
                ...
                if (jSONObject2.has("vendor")) {
                    this.mLogBundle.seiSource = jSONObject2.getString("vendor");
                }
            }
            LogBundle logBundle2 = this.mSessionLogBundle;
            if (logBundle2 != null) {
            ...
            if (jSONObject.has("app_data")) {
                ...
                if (jSONObject3.has("channel_id")) {
                    this.mLogBundle.channelId = jSONObject3.getString("channel_id");
                }
            } else {
            ...
            if (jSONObject.has(str5)) {
                this.mLogBundle.seiBitrate = jSONObject.getInt(str5);
                this.mSeiHasBitrateAndFps = true;
            }
            if (jSONObject.has(str2)) {
                this.mLogBundle.seiFps = jSONObject.getInt(str2);
                this.mSeiHasBitrateAndFps = true;
            }
            if (jSONObject.has("trans_info") || jSONObject.has("tans_info")) {
                JSONObject jSONObject4 = jSONObject.has("trans_info") ? jSONObject.getJSONObject("trans_info") : jSONObject.getJSONObject("tans_info");
                if (jSONObject4 != null) {
                    checkVideoFrame(jSONObject4.getInt("index"), jSONObject4.getInt("sent_frames"), jSONObject4.getInt("checked_dts"));
                }
            }
            if (this.mEnableCheckSei && jSONObject.has("sei_index")) {
                checkSeiIndex(jSONObject.getInt("sei_index"));
            }
        } catch (JSONException e) {
            l.h(e);
        }
    ...
    public void onVideoStallCounter(long j, long j2, long j3, long j4, long j5, long j6, long j7) throws JSONException {
        JSONObject jSONObjectCreateCommonLog = createCommonLog();
        if (jSONObjectCreateCommonLog != null) {
            try {
