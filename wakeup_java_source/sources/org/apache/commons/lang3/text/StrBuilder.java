...
public class StrBuilder implements CharSequence, Appendable, Serializable {
    ...
    class OooO0O0 extends org.apache.commons.lang3.text.OooO0O0 {
        OooO0O0() {
        }

        @Override // org.apache.commons.lang3.text.OooO0O0
    ...
    public <T> StrBuilder appendAll(T... tArr) {
        if (org.apache.commons.lang3.OooO0O0.OooOOO(tArr)) {
            for (T t : tArr) {
                append(t);
            }
        }
    ...
    public org.apache.commons.lang3.text.OooO0O0 asTokenizer() {
        return new OooO0O0();
    }
    ...
    class OooO00o extends Reader {
        ...
        private int f19907OooO0o;

        /* renamed from: OooO0o0, reason: collision with root package name */
        private int f19908OooO0o0;
        ...
        public void mark(int i) {
            this.f19907OooO0o = this.f19908OooO0o0;
        }
        ...
        public int read() {
            ...
            StrBuilder strBuilder = StrBuilder.this;
            int i = this.f19908OooO0o0;
            this.f19908OooO0o0 = i + 1;
            return strBuilder.charAt(i);
        }

        @Override // java.io.Reader
        public boolean ready() {
            return this.f19908OooO0o0 < StrBuilder.this.size();
        }

        @Override // java.io.Reader
        public void reset() {
            this.f19908OooO0o0 = this.f19907OooO0o;
        }

        @Override // java.io.Reader
        public long skip(long j) {
            if (this.f19908OooO0o0 + j > StrBuilder.this.size()) {
                j = StrBuilder.this.size() - this.f19908OooO0o0;
            }
            if (j < 0) {
                return 0L;
            }
            this.f19908OooO0o0 = (int) (this.f19908OooO0o0 + j);
            return j;
        }
        ...
        public int read(char[] cArr, int i, int i2) {
            ...
            if (this.f19908OooO0o0 >= StrBuilder.this.size()) {
                return -1;
            }
            if (this.f19908OooO0o0 + i2 > StrBuilder.this.size()) {
                i2 = StrBuilder.this.size() - this.f19908OooO0o0;
            }
            StrBuilder strBuilder = StrBuilder.this;
            int i4 = this.f19908OooO0o0;
            strBuilder.getChars(i4, i4 + i2, cArr, i);
            this.f19908OooO0o0 += i2;
            return i2;
        }
    }
    ...
    public StrBuilder replace(org.apache.commons.lang3.text.OooO00o oooO00o, String str, int i, int i2, int i3) {
        return replaceImpl(oooO00o, str, i, validateRange(i, i2), i3);
    }
    ...
    public boolean contains(org.apache.commons.lang3.text.OooO00o oooO00o) {
        return indexOf(oooO00o, 0) >= 0;
    }
    ...
    */
    ...
    private StrBuilder replaceImpl(org.apache.commons.lang3.text.OooO00o oooO00o, String str, int i, int i2, int i3) {
        if (oooO00o != null && this.size != 0) {
            int length = str == null ? 0 : str.length();
            int i4 = i;
            while (i4 < i2 && i3 != 0) {
                int iOooO0Oo = oooO00o.OooO0Oo(this.buffer, i4, i, i2);
                if (iOooO0Oo > 0) {
    ...
    public StrBuilder deleteFirst(org.apache.commons.lang3.text.OooO00o oooO00o) {
        return replace(oooO00o, null, 0, this.size, 1);
    }
    ...
    */
    ...
    public StrBuilder replaceFirst(org.apache.commons.lang3.text.OooO00o oooO00o, String str) {
        return replace(oooO00o, str, 0, this.size, 1);
    }
    ...
    public StrBuilder replaceAll(org.apache.commons.lang3.text.OooO00o oooO00o, String str) {
        return replace(oooO00o, str, 0, this.size, -1);
    }
    ...
    public StrBuilder deleteAll(org.apache.commons.lang3.text.OooO00o oooO00o) {
        return replace(oooO00o, null, 0, this.size, -1);
    }

    public int lastIndexOf(org.apache.commons.lang3.text.OooO00o oooO00o) {
        return lastIndexOf(oooO00o, this.size);
    }
    ...
    public int lastIndexOf(org.apache.commons.lang3.text.OooO00o oooO00o, int i) {
        int i2 = this.size;
        if (i >= i2) {
            i = i2 - 1;
        }
        if (oooO00o != null && i >= 0) {
            ...
            int i3 = i + 1;
            while (i >= 0) {
                if (oooO00o.OooO0Oo(cArr, i, 0, i3) > 0) {
                    return i;
                }
                i--;
            }
    ...
    public int indexOf(org.apache.commons.lang3.text.OooO00o oooO00o) {
        return indexOf(oooO00o, 0);
    }
    ...
    public int indexOf(org.apache.commons.lang3.text.OooO00o oooO00o, int i) {
        int i2;
        int iMax = Math.max(i, 0);
        if (oooO00o != null && iMax < (i2 = this.size)) {
            char[] cArr = this.buffer;
            for (int i3 = iMax; i3 < i2; i3++) {
                if (oooO00o.OooO0Oo(cArr, i3, iMax, i2) > 0) {
                    return i3;
                }
            }
        }
