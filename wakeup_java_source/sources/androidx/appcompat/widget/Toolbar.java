...
public class Toolbar extends ViewGroup implements MenuHost {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<Toolbar> {
        ...
        public void mapProperties(@NonNull PropertyMapper propertyMapper) {
            ...
            this.mSubtitleId = propertyMapper.mapObject(MediaFormat.KEY_SUBTITLE, R.attr.subtitle);
    ...
    */
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            ...
            if (z && this.mBackInvokedDispatcher == null) {
                if (this.mBackInvokedCallback == null) {
                    this.mBackInvokedCallback = Api33Impl.newOnBackInvokedCallback(new Runnable() { // from class: androidx.appcompat.widget.o0000OO0
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f1137OooO0o0.collapseActionView();
                        }
                    });
                }
    ...
    public Toolbar(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mMenuHostHelper = new MenuHostHelper(new Runnable() { // from class: androidx.appcompat.widget.o000
            @Override // java.lang.Runnable
            public final void run() {
                this.f1136OooO0o0.invalidateMenu();
            }
        });
