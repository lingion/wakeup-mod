...
public class OfflineMemExceptionMessage extends ExceptionMessage {
    ...
    public JSONObject toJson() {
        ...
        aa.putValue(json, REASON, this.mReason);
        aa.putValue(json, MSG_QUEUE_DETAIL, this.mMessageQueueDetail);
        aa.putValue(json, THREAD_DETAIL, this.mThreadDetail);
        aa.putValue(json, THREAD_STATUS, this.mThreadStatus);
        return json;
    }
}
