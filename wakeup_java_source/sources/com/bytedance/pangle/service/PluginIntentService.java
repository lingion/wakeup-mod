...
public abstract class PluginIntentService extends IntentService implements h {
    ...
    @Override // com.bytedance.pangle.service.h
    ...
    protected Object createActivityManagerProxy() {
        return Proxy.newProxyInstance(getClassLoader(), new Class[]{Class.forName("android.app.IActivityManager")}, new InvocationHandler() { // from class: com.bytedance.pangle.service.PluginIntentService.1
            ...
            public Object invoke(Object obj, Method method, Object[] objArr) {
                ...
                com.bytedance.pangle.service.h.h hVarBj = com.bytedance.pangle.service.h.h.bj();
                PluginIntentService pluginIntentService = PluginIntentService.this;
                return Boolean.valueOf(hVarBj.h(new ComponentName(pluginIntentService, pluginIntentService.getClass().getName())));
            }
        });
    }
}
