...
import com.bytedance.sdk.component.rb.cg;
...
public class LivePluginHelper {
    ...
    public static final ScheduledExecutorService sExecutor = cg.cg(new DefaultThreadFactory());
    ...
    private static class DefaultThreadFactory implements ThreadFactory {
        ...
        public Thread newThread(Runnable runnable) {
            com.bytedance.sdk.component.rb.a.cg cgVar = new com.bytedance.sdk.component.rb.a.cg(this.group, runnable, this.namePrefix + this.threadNumber.getAndIncrement(), 0L);
            if (cgVar.isDaemon()) {
                cgVar.setDaemon(false);
            }
            if (cgVar.getPriority() != 10) {
    ...
    public static void init(Application application, String str, ILiveHostContextParam.Builder builder, ILiveInitCallback iLiveInitCallback) throws IOException {
    ...
    public static void logVersionInfo() {
        ...
        try {
            ...
            je.cg("live init", "version_info: lib_version_name=2.1.1.4-tob-tob-61440787; sdkApiVersionName=2.1.1.4-tob-tob-61440787; pluginVersionCode=" + ((Long) pair.first).longValue() + "; pluginVersionName=" + ((String) pair.second));
        } catch (Throwable th) {
            je.h(th);
        }
    }
    ...
    public static void init(Application application, String str, ILiveHostContextParam.Builder builder, ILiveInitCallback iLiveInitCallback, boolean z) throws IOException {
        init(application, str, builder, iLiveInitCallback, z, false);
    }

    public static void init(Application application, String str, ILiveHostContextParam.Builder builder, ILiveInitCallback iLiveInitCallback, boolean z, boolean z2) throws IOException {
