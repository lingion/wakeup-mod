...
@kotlin.coroutines.jvm.internal.OooO0o(c = "com.suda.yzune.wakeupschedule.suda_life.BathFragment$refreshData$2", f = "BathFragment.kt", l = {62}, m = "invokeSuspend")
/* loaded from: classes4.dex */
final class BathFragment$refreshData$2 extends SuspendLambda implements Function2<o000OO, OooO<? super o0OOO0o>, Object> {
    int label;
    final /* synthetic */ BathFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    BathFragment$refreshData$2(BathFragment bathFragment, OooO<? super BathFragment$refreshData$2> oooO) {
        super(2, oooO);
    ...
    public final OooO<o0OOO0o> create(Object obj, OooO<?> oooO) {
        return new BathFragment$refreshData$2(this.this$0, oooO);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            if (i == 0) {
                ...
                this.label = 1;
                if (sudaLifeViewModel.OooO0OO(false, this) == objOooO0oO) {
                    return objOooO0oO;
                }
            } else {
                if (i != 1) {
            ...
            fragmentBathBinding2.f8223OooO.setText(String.valueOf(outNum));
            ...
            fragmentBathBinding.f8227OooO0oo.setText("拥挤度：" + ((outNum / 90.0f) * 100) + "%");
        } catch (Exception e) {
    ...
    public final Object invoke(o000OO o000oo2, OooO<? super o0OOO0o> oooO) {
        return ((BathFragment$refreshData$2) create(o000oo2, oooO)).invokeSuspend(o0OOO0o.f13233OooO00o);
    }
}
