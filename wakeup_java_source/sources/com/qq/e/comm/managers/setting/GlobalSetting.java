...
public final class GlobalSetting {
    ...
    public static void setEnableCollectAppInstallStatus(boolean z) throws JSONException {
        try {
    ...
    public static void setMediaExtData(Map<String, String> map, boolean z) throws JSONException {
        if (map == null) {
            return;
        }
        if (z) {
