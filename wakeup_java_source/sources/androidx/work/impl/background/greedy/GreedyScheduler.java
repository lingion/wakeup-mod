...
import androidx.work.impl.OooOO0;
...
public class GreedyScheduler implements Scheduler, OnConstraintsStateChangedListener, ExecutionListener {
    ...
    private final Map<WorkGenerationalId, o00O0OOO> mConstrainedWorkSpecs = new HashMap();
    private final Object mLock = new Object();
    private final StartStopTokens mStartStopTokens = OooOO0.OooO0OO();
    ...
    private void removeConstraintTrackingFor(@NonNull WorkGenerationalId workGenerationalId) {
        o00O0OOO o00o0oooRemove;
        synchronized (this.mLock) {
            o00o0oooRemove = this.mConstrainedWorkSpecs.remove(workGenerationalId);
        }
    ...
    private long throttleIfNeeded(WorkSpec workSpec) {
        ...
        synchronized (this.mLock) {
            try {
                ...
                jMax = attemptData.mTimeStamp + (Math.max((workSpec.runAttemptCount - attemptData.mRunAttemptCount) - 5, 0) * WorkRequest.DEFAULT_BACKOFF_DELAY_MILLIS);
            } catch (Throwable th) {
                throw th;
            }
        }
