...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    public void setCheckedState(int i) {
        ...
        if (this.checkedState != i) {
            ...
            if (linkedHashSet != null) {
                ...
                while (it2.hasNext()) {
                    it2.next().onCheckedStateChangedListener(this, this.checkedState);
                }
            }
            if (this.checkedState != 2 && (onCheckedChangeListener = this.onCheckedChangeListener) != null) {
                onCheckedChangeListener.onCheckedChanged(this, isChecked());
            }
            if (Build.VERSION.SDK_INT >= 26 && (autofillManagerOooO00o = OooO0O0.OooO00o(getContext().getSystemService(OooO00o.OooO00o()))) != null) {
    ...
    public void setErrorShown(boolean z) {
        ...
        this.errorShown = z;
        refreshDrawableState();
        Iterator<OnErrorChangedListener> it2 = this.onErrorChangedListeners.iterator();
        while (it2.hasNext()) {
            it2.next().onErrorChanged(this, this.errorShown);
        }
    }
