...
public final class ScatterMap$MapWrapper$entries$1<K, V> implements Set<Map.Entry<? extends K, ? extends V>>, o0oO0Ooo.OooO00o {
    ...
    public boolean containsAll(Collection<? extends Object> elements) {
        ...
        while (it2.hasNext()) {
            ...
            if (!o0OoOo0.OooO0O0(scatterMap.get(entry.getKey()), entry.getValue())) {
                return false;
            }
        }
        return true;
    ...
    public Iterator<Map.Entry<K, V>> iterator() {
        return OooOo.OooO00o(new ScatterMap$MapWrapper$entries$1$iterator$1(this.this$0, null));
    }
