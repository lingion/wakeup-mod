...
public class Utils {
    ...
    public static void logStack(String str, int i) {
        ...
        for (int i2 = 1; i2 <= iMin; i2++) {
            ...
            String str3 = ".(" + stackTraceElement.getFileName() + ServerSentEventKt.COLON + stackTraceElement.getLineNumber() + ") " + stackTraceElement.getMethodName();
    ...
    public static void socketSend(String str) throws IOException {
        try {
            ...
            System.err.println(e.toString() + a.c + Arrays.toString(e.getStackTrace()).replace("[", "   at ").replace(",", "\n   at").replace("]", ""));
        }
    }
    ...
    public static void log(String str) {
        ...
        String str2 = ".(" + stackTraceElement.getFileName() + ServerSentEventKt.COLON + stackTraceElement.getLineNumber() + ")" + "    ".substring(Integer.toString(stackTraceElement.getLineNumber()).length()) + strSubstring;
        System.out.println(str2 + ServerSentEventKt.SPACE + str);
        DebugHandle debugHandle = sOurHandle;
        if (debugHandle != null) {
            debugHandle.message(str2 + ServerSentEventKt.SPACE + str);
        }
    }
}
