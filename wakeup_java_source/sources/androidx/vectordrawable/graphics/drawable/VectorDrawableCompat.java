...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    @Nullable
    public static VectorDrawableCompat create(@NonNull Resources resources, @DrawableRes int i, @Nullable Resources.Theme theme) throws XmlPullParserException, Resources.NotFoundException, IOException {
        int next;
    ...
    private static abstract class VPath extends VObject {
        ...
        public String nodesToString(PathParser.PathDataNode[] pathDataNodeArr) {
            ...
            for (int i = 0; i < pathDataNodeArr.length; i++) {
                str = str + pathDataNodeArr[i].mType + ServerSentEventKt.COLON;
