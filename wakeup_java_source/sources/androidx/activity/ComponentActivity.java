...
public class ComponentActivity extends androidx.core.app.ComponentActivity implements ContextAware, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, OnBackPressedDispatcherOwner, ActivityResultRegistryOwner, ActivityResultCaller, OnConfigurationChangedProvider, OnTrimMemoryProvider, OnNewIntentProvider, OnMultiWindowModeChangedProvider, OnPictureInPictureModeChangedProvider, MenuHost, FullyDrawnReporterOwner {
            ...
            if (!this.mOnDrawScheduled) {
                decorView.postOnAnimation(new Runnable() { // from class: androidx.activity.OooO
                    ...
                    public final void run() {
                        this.f1117OooO0o0.lambda$execute$0();
                    }
                });
    ...
    public ComponentActivity() {
        ...
        this.mMenuHostHelper = new MenuHostHelper(new Runnable() { // from class: androidx.activity.OooO00o
            @Override // java.lang.Runnable
            public final void run() {
                this.f1118OooO0o0.invalidateMenu();
            }
        });
        ...
        this.mFullyDrawnReporter = new FullyDrawnReporter(reportFullyDrawnExecutorCreateFullyDrawnExecutor, new Function0() { // from class: androidx.activity.OooO0O0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return this.f1119OooO0o0.lambda$new$0();
            }
        });
        ...
        getSavedStateRegistry().registerSavedStateProvider(ACTIVITY_RESULT_TAG, new SavedStateRegistry.SavedStateProvider() { // from class: androidx.activity.OooO0OO
            @Override // androidx.savedstate.SavedStateRegistry.SavedStateProvider
            public final Bundle saveState() {
                return this.f1120OooO00o.lambda$new$1();
            }
        });
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: androidx.activity.OooO0o
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void onContextAvailable(Context context) {
                this.f1121OooO00o.lambda$new$2(context);
            }
        });
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ o0OOO0o lambda$new$0() {
        reportFullyDrawn();
        return null;
    }
