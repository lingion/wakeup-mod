...
public class SolverVariableValues implements ArrayRow.ArrayRowVariables {
    ...
    private void displayHash() {
        for (int i = 0; i < this.mHashSize; i++) {
            if (this.mKeys[i] != -1) {
                ...
                boolean z = false;
                while (!z) {
                    str = str + ServerSentEventKt.SPACE + this.mVariables[i2];
    ...
    public void display() {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            SolverVariable variable = getVariable(i2);
            if (variable != null) {
                System.out.print(variable + " = " + getVariableValue(i2) + ServerSentEventKt.SPACE);
            }
        }
        System.out.println(" }");
    }
    ...
    public String toString() {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            SolverVariable variable = getVariable(i2);
            if (variable != null) {
                String str2 = str + variable + " = " + getVariableValue(i2) + ServerSentEventKt.SPACE;
