...
public class ConstraintWidget {
    ...
    /* JADX WARN: Removed duplicated region for block: B:234:0x03ba A[ADDED_TO_REGION] */
    ...
    /* JADX WARN: Removed duplicated region for block: B:314:0x04bf A[ADDED_TO_REGION] */
    /* JADX WARN: Removed duplicated region for block: B:322:0x04da  */
    ...
    */
    ...
    private void serializeSize(StringBuilder sb, String str, int i, int i2, int i3, int i4, int i5, int i6, float f, float f2) {
        sb.append(str);
        sb.append(" :  {\n");
        serializeAttribute(sb, ContentDisposition.Parameters.Size, i, Integer.MIN_VALUE);
    ...
    /* JADX WARN: Removed duplicated region for block: B:321:0x05ed  */
    ...
    */
    ...
    public void getSceneString(StringBuilder sb) {
        ...
        sb.append(a.c);
        getSceneString(sb, j.d, this.mLeft);
        getSceneString(sb, j.f, this.mTop);
        getSceneString(sb, j.e, this.mRight);
        getSceneString(sb, j.g, this.mBottom);
    ...
    public StringBuilder serialize(StringBuilder sb) {
        sb.append("{\n");
        serializeAnchor(sb, j.d, this.mLeft);
        serializeAnchor(sb, j.f, this.mTop);
        serializeAnchor(sb, j.e, this.mRight);
        serializeAnchor(sb, j.g, this.mBottom);
    ...
    */
    ...
    public String toString() {
        ...
        String str2 = "";
        if (this.mType != null) {
            str = "type: " + this.mType + ServerSentEventKt.SPACE;
        } else {
            str = "";
        }
        sb.append(str);
        if (this.mDebugName != null) {
            str2 = "id: " + this.mDebugName + ServerSentEventKt.SPACE;
        }
        sb.append(str2);
        sb.append("(");
        sb.append(this.mX);
